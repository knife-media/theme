    ...
    <div class="caption">
        <div class="caption__description">
            <?php
                printf(
                    '<img src="%s" alt="">',
                    get_template_directory_uri() . '/core/special/docmed/images/logo.png',
                );

                printf(
                    '<h1>%s</h1>',
                    _x('Специальный проект клиники доказательной медицины DocMed и журнала «Нож»', 'special: docmed', 'knife-theme')
                );
            ?>
        </div>
    </div>
