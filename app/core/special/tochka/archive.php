    ...
    <div class="caption">
        <div class="caption__description">
            <?php
                printf(
                    '<img src="%s" alt="">',
                    get_template_directory_uri() . '/core/special/tochka/images/logo.svg',
                );

                printf(
                    '<h1>%s</h1>',
                    _x('Специальный проект образовательного комплекса «Точка будущего» и журнала «Нож»', 'special: tochka', 'knife-theme')
                );
            ?>
        </div>
    </div>
