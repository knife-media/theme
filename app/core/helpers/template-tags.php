...
if ( ! function_exists( 'the_share' ) ) :
     ...
     * @since 1.3
     */
    function the_share( $before = '', $after = '', $display = true, $output = '' ) {
...
if ( ! function_exists( 'the_info' ) ) :
     ...
     * @since 1.3
     */
    function the_info( $before = '', $after = '', $options = array(), $display = true, $output = '' ) {
        // Append post meta
...
if ( ! function_exists( 'the_lead' ) ) :
     ...
     * @since 1.3
     */
    function the_lead( $before = '', $after = '', $display = true, $output = '' ) {
...
if ( ! function_exists( 'the_tagline' ) ) :
     ...
     * @since 1.10
     */
    function the_tagline( $before = '', $after = '', $display = true, $output = '' ) {
