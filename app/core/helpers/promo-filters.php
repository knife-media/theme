...
add_filter('the_content', function($content) {
    ...
    if(get_post_field('post_name') !== 'parents') {
        return $content;
    }
    ...
    $link = sprintf(
        '<a class="outbound outbound--skyeng" href="%2$s"><p class="outbound__promo">%1$s</p><img class="outbound__image" src="%3$s" alt="Skyeng"></a>',
