        ...
        <div class="caption">
            <div class="caption__description">
                <?php
                    printf(
                        '<img src="%s" alt="">',
                        get_template_directory_uri() . '/core/custom/lighthouse/images/logo.png',
                    );

                    printf(
                        '<a href="%s">%s</a>',
                        get_term_link('lighthouse', 'special'),
                        _x('Дом с маяком', 'custom: lighthouse', 'knife-theme')
                    );
                ?>
            </div>
        </div>
                ...
                <?php
                    ...
                    the_info(
                        sprintf(
                            ...
                            _x('Подготовила специальный<br> корреспондент журнала «Нож»', 'custom: lighthouse', 'knife-theme')
                        ),
                        '</div>', ['author']
                    );
                ?>
...
<?php get_template_part('core/custom/lighthouse/footer');
