...
"use strict";!function(){var f,d;function s(e,t){var n=document.createElement("p");e.appendChild(n);var r=document.createElement("a");r.href=t.link,r.innerHTML=t.title,n.appendChild(r)}"undefined"!=typeof knife_similar_posts&&(f=function(e){for(var t,n=0;n<e.length;n++){t=Math.floor(Math.random()*n);var r=e[n];e[n]=e[t],e[t]=r}return e}(knife_similar_posts.similar||[]),d=0,function(){var e=document.querySelector(".entry-footer");if(!(null===e||f.length<d+4)){var t=document.createElement("div");t.classList.add("entry-footer__similar");for(var n=d;n<d+4;n++)f[n].link&&f[n].title&&s(t,f[n]);d+=4,e.appendChild(t)}}(),function(){var e=document.querySelectorAll(".entry-content");if(1===e.length&&1!=knife_similar_posts.hidden){var t=e[0].children;if(!(t.length<15||f.length<d+3)){for(var n=["p","blockquote"],r=null,i=Math.floor(t.length/1.5);i<t.length-5;i++)if(!(n.indexOf(t[i].tagName.toLowerCase())<0||void 0===t[i-1]||n.indexOf(t[i-1].tagName.toLowerCase())<0)){r=t[i-1];break}if(null!==r){var l=document.createElement("figure");l.classList.add("figure","figure--similar");var a=document.createElement("h4");a.innerHTML=knife_similar_posts.title||"",l.appendChild(a);for(var o=d;o<d+3;o++)f[o].link&&f[o].title&&s(l,f[o]);d+=3,r.parentNode.insertBefore(l,r.nextSibling)}}}}(),console.log("2"))}();
