!function(){var a=document.querySelectorAll(".widget-adfox");if(a.length<1)return;function e(a,o){var t=a.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(2<t.length){o.ownerId=t[1],o.params={};for(var n=t[2].split("&"),e=0;e<n.length;e++){var d=n[e].split("=");1!=d.length&&"pr"!==d[0]&&(o.params[d[0]]=decodeURIComponent(d[1].replace(/\+/g," ")))}}return o}function d(a,o){return a.onStub=function(){o.classList.remove("widget-adfox--loaded")},a.onError=function(){o.classList.remove("widget-adfox--loaded")},a.onLoad=function(){o.classList.add("widget-adfox--loaded")},a}function o(a,o,t){if(a.common)return function(a,o,t){var n={};n.containerId="adfox_"+o,n=e(a,n=d(n,t)),window.adfoxAsyncParams=window.adfoxAsyncParams||[],window.adfoxAsyncParams.push(n)}(a.common,o,t);a.mobile&&function(a,o,t){var n={};n.containerId="adfox_"+o,n=e(a,n=d(n,t)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([n,["tablet","phone"],{tabletWidth:1023,isAutoReloads:!0}])}(a.mobile,o,t),a.desktop&&function(a,o,t){var n={};n.containerId="adfox_"+o,n=e(a,n=d(n,t)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([n,["desktop"],{tabletWidth:1023,isAutoReloads:!0}])}(a.desktop,o,t)}for(var t=0;t<a.length;t++){var n=a[t].querySelector("div");if(null!==n&&0!==n.dataset.length){var r=Date.now().toString(10)+Math.random().toString(10).substr(2,5),i=document.createElement("div");i.id="adfox_"+r,a[t].replaceChild(i,n),o(n.dataset,r,a[t])}}var s=document.createElement("script");s.type="text/javascript",s.async=!0,s.crossorigin="anonymous",s.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(s)}();
...
!function(){var e=document.querySelector(".entry-content");if(null===e)return;var r=document.querySelector(".entry-widgets");if(null===r||null===r.firstElementChild)return;var t=Math.floor(e.children.length/3);if(8<e.children.length)for(var n=["p","blockquote"],i=t;i<e.children.length;i++){var d=e.children[i];if(!(n.indexOf(d.tagName.toLowerCase())<0)&&void 0!==e.children[i-1]){var l=e.children[i-1];if(!(n.indexOf(l.tagName.toLowerCase())<0)){var a=document.createElement("aside");a.classList.add("aside","aside--widget"),a.appendChild(r.firstElementChild),e.insertBefore(a,d);break}}}0<r.children.length?r.classList.add("entry-widgets--expand"):r.parentNode.removeChild(r)}();
...
!function(){var s=document.getElementById("story");if(null===s||"undefined"==typeof Glide)return;if(s.querySelectorAll(".entry-story__slide").length<1)return;var n=new Glide(".entry-story",{gap:0,rewind:!1,touchAngle:60,swipeThreshold:60,dragThreshold:!1,classes:{slider:"entry-story--slider",swipeable:"entry-story--swipeable",direction:{ltr:"entry-story--ltr",rtl:"entry-story--rtl"}},breakpoints:{767:{dragThreshold:!0}}}),o={};n.on("mount.before",function(){if("undefined"==typeof knife_story_stories||knife_story_stories.length<1)return!1;for(var t,e=0;t=knife_story_stories[e];e++){var r=document.createElement("div");r.classList.add("entry-story__slide-wrap");var n=document.createElement("div");n.classList.add("entry-story__slide-content"),function(){if(void 0===t.kicker)return;var e=document.createElement("div");e.classList.add("entry-story__slide-kicker"),e.innerHTML=t.kicker,r.appendChild(e)}(),function(){if(void 0===t.image||void 0===t.ratio)return;var e=document.createElement("div");e.classList.add("entry-story__slide-image"),e.style.setProperty("background-image","url("+t.image+")"),e.style.setProperty("--image-ratio",t.ratio),n.appendChild(e)}(),function(){if(void 0===t.entry)return;var e=document.createElement("div");e.classList.add("entry-story__slide-entry"),e.innerHTML=t.entry,n.appendChild(e)}();var o=document.createElement("div");o.classList.add("entry-story__slide"),o.appendChild(r),r.appendChild(n),s.querySelector(".entry-story__slides").appendChild(o)}}),n.on("mount.before",function(){var e=s.querySelectorAll(".entry-story__slide");if(e.length<1)return!1;var t=e[0].querySelector(".share");if(null===t)return!1;var r=t.cloneNode(!0);e[e.length-1].querySelector(".entry-story__slide-content").appendChild(r),"function"==typeof window.shareButtons&&window.shareButtons()}),n.on("mount.before",function(){var e=document.createElement("div");e.classList.add("entry-story__bullets");for(var t=0;t<s.querySelectorAll(".entry-story__slide").length;t++){var r=document.createElement("span");r.classList.add("entry-story__bullets-item"),e.appendChild(r)}return s.appendChild(e)}),n.on("mount.before",function(e){var t=document.querySelector('link[rel="prev"]');if(null===t||!t.hasAttribute("href"))return!1;o.href=t.href;var r=document.createElement("div");return r.classList.add("entry-story__slide","entry-story__slide--empty"),s.querySelector(".entry-story__slides").appendChild(r)}),n.on("mount.before",function(){["prev","next"].forEach(function(e,t){var r=document.createElement("div");r.classList.add("entry-story__control","entry-story__control--"+e),r.classList.add();var n=document.createElement("span");n.classList.add("icon","icon--"+e),r.appendChild(n),s.appendChild(r)}),s.querySelector(".entry-story__control--next").addEventListener("click",function(e){e.preventDefault(),n.go(">")}),s.querySelector(".entry-story__control--prev").addEventListener("click",function(e){e.preventDefault(),n.go("<")})}),n.on("mount.before",function(){var e=s.getBoundingClientRect();s.style.height=window.innerHeight-e.top-window.pageYOffset+"px"}),n.on(["mount.after","run"],function(){for(var e,t=s.querySelectorAll(".entry-story__bullets-item"),r=0;e=t[r];r++)e.classList.remove("entry-story__bullets-item--active"),n.index===r&&e.classList.add("entry-story__bullets-item--active")}),n.on("mount.after",function(){var e=s.querySelectorAll(".entry-story__slide");o.count=e.length-1}),n.on(["mount.after","run"],function(e){var t=s.querySelector(".entry-story__control--prev");t.classList.remove("entry-story__control--disabled"),0===n.index&&t.classList.add("entry-story__control--disabled")}),n.on("run",function(e){var t=s.querySelector(".entry-story__control--next");t.classList.remove("entry-story__control--disabled"),n.index===o.count&&t.classList.add("entry-story__control--disabled")}),n.on("run",function(e){n.index===o.count&&o.href&&s.classList.remove("entry-story--active")}),n.on("run.after",function(e){n.index===o.count&&o.href&&(document.location.href=o.href)}),n.on("build.after",function(){var r=0;s.addEventListener("touchstart",function(e){var t=e.changedTouches[0];r=t.pageY},!0),s.addEventListener("touchmove",function(e){var t=e.changedTouches[0];r<t.pageY&&0===window.pageYOffset&&e.preventDefault(),s.classList.contains("entry-story--dragging")&&e.preventDefault()},!0)}),n.on("build.after",function(){if(void 0===knife_story_options.background||knife_story_options.background.length<1)return s.classList.add("entry-story--active");var e=new Image;e.addEventListener("load",function(){return s.classList.add("entry-story--active")}),e.src=knife_story_options.background;var r=document.createElement("div");return r.classList.add("entry-story__backdrop"),r.style.backgroundImage="url("+knife_story_options.background+")",function(){if(void 0===knife_story_options.blur)return;var e=parseInt(knife_story_options.blur);if(e<=0)return;r.style.margin="-"+e+"px",r.style.filter="blur("+e+"px)"}(),function(){if(void 0===knife_story_options.shadow)return;var e=parseInt(knife_story_options.shadow)/100;if(e<=0||1<e)return;var t=document.createElement("div");t.classList.add("entry-story__shadow"),t.style.backgroundColor="rgba(0, 0, 0, "+e+")",r.appendChild(t)}(),s.appendChild(r)}),window.addEventListener("pageshow",function(e){e.persisted&&window.location.reload(!1)}),n.mount()}();
