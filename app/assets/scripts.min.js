...
"use strict";!function(){var e,a,r,i,o;function n(e){r=function(){for(var e=0,t=0;e<a.length;e++)for(var n=document.querySelectorAll(a[e]),i=0;i<n.length;i++,t++)n[i].setAttribute("data-satanization",t),r[t]=n[i].innerHTML;return r}();var n=new XMLHttpRequest;n.open("POST","/satanization/",!0),n.setRequestHeader("Content-Type","application/json"),n.onload=function(){if(o.innerHTML=knife_satanize.button,200!==n.status)return console.error("Error while /satanization/ loading");var e=JSON.parse(n.responseText);if(!e.results)return alert("excludes");for(var t=0;t<e.results.length;t++)document.querySelector('[data-satanization="'+t+'"]').innerHTML=e.results[t];o.innerHTML=knife_satanize.getback||"",i.setAttribute("data-image",i.style.backgroundImage),i.style.backgroundImage="linear-gradient(to bottom,#3b2307,#931111,#e62020)"},o.classList.add("promo--freeze"),o.innerHTML=knife_satanize.process||"",n.send(JSON.stringify({headings:r,path:e}))}"undefined"!=typeof knife_satanize&&(e=knife_satanize.button.split(" "),knife_satanize.button=e[0]+"<strong>"+e[1]+"</strong>",a=[".widget-single .widget-single__content-title",".widget-cents .widget-cents__link",".widget-story .widget-story__title-link",".widget-blunt .widget-blunt__link",".widget-transparent .widget-transparent__content-link",".widget-club .widget-club__content-link",".widget-recent .widget-recent__content-link",".widget-news .widget-news__content-link",".unit .unit__content-link",".entry-header .entry-header__lead",".entry-header .entry-header__title",".entry-header .entry-header__link p",".entry-content p",".entry-content h1",".entry-content h2",".entry-content h3",".entry-content h4",".entry-content h5"],r=[],null===(i=document.querySelector("backdrop"))&&((i=document.createElement("div")).classList.add("backdrop"),document.body.appendChild(i)),(o=document.createElement("button")).classList.add("promo","promo--satanization"),o.innerHTML=knife_satanize.button,document.body.appendChild(o),o.addEventListener("click",function(e){if(e.preventDefault(),0===r.length)return n(document.location.pathname);for(var t=0;t<r.length;t++)document.querySelector('[data-satanization="'+t+'"]').innerHTML=r[t];r=[],o.classList.remove("promo--freeze"),o.innerHTML=knife_satanize.button||"",i.style.backgroundImage=i.getAttribute("data-image")}))}();
