...
!function(){var n=document.getElementById("load-comments");if(null===n||"undefined"==typeof knife_comments_id)return;(function(){_hcwp=window._hcwp||[];_hcwp.push({widget:"Bloggerstream",widget_id:knife_comments_id,selector:"#load-comments",label:n.textContent+"<strong>{%COUNT%}</strong>"});var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t.nextSibling)})()}();
