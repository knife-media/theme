...
!function(){var e=document.querySelector(".glide");if(null===e||"undefined"==typeof Glide)return!1;var t=e.querySelectorAll(".glide__slide").length;if(0===t)return!1;var n=new Glide(".glide",{gap:0,rewind:!1,dragThreshold:!1});return n.on("mount.before",function(){if("undefined"==typeof knife_story_options.background)return!1;var t=document.createElement("div");if(t.classList.add("glide__backdrop"),t.style.backgroundImage="url("+knife_story_options.background+")","undefined"!=typeof knife_story_options.blur&&parseInt(knife_story_options.blur)>0&&(t.style.filter="blur("+knife_story_options.blur+"px)"),e.appendChild(t),"undefined"==typeof knife_story_options.shadow)return!1;var n=parseInt(knife_story_options.shadow)/100;if(n<=0||n>1)return!1;var o=document.createElement("div");o.classList.add("glide__shadow"),o.style.backgroundColor="rgba(0, 0, 0, "+n+")",t.appendChild(o)}),n.on("mount.before",function(){var n=document.createElement("div");n.classList.add("glide__bullets");for(var o=0;o<t;o++){var r=document.createElement("span");r.classList.add("glide__bullets-item"),n.appendChild(r)}return e.appendChild(n)}),n.on(["mount.after","run"],function(){for(var t,o=e.querySelectorAll(".glide__bullets-item"),r=0;t=o[r];r++)t.classList.remove("glide__bullets-item--active"),n.index===r&&t.classList.add("glide__bullets-item--active")}),n.on("mount.before",function(){["prev","next"].forEach(function(t,n){var o=document.createElement("div");o.classList.add("glide__control","glide__control--"+t),o.classList.add();var r=document.createElement("span");r.classList.add("icon","icon--"+t),o.appendChild(r),e.appendChild(o)}),e.querySelector(".glide__control--next").addEventListener("click",function(e){e.preventDefault(),n.go(">")}),e.querySelector(".glide__control--prev").addEventListener("click",function(e){e.preventDefault(),n.go("<")})}),n.on(["mount.after","run"],function(t){var o=e.querySelector(".glide__control--prev");o.classList.remove("glide__control--disabled"),0===n.index&&o.classList.add("glide__control--disabled")}),n.on(["mount.after","run"],function(o){var r=e.querySelector(".glide__control--next");r.classList.remove("glide__control--disabled"),n.index+1===t&&r.classList.add("glide__control--disabled")}),n.mount()}();
