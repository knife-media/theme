...
"use strict";!function(){function a(e){var t,n,a=document.createElement("script");return a.type="text/javascript",a.src=(t=e,n=(n=document.querySelector('link[rel="canonical"]'))&&n.href?encodeURIComponent(n.href):encodeURIComponent(window.location.href.replace(window.location.hash,"")),"vkontakte"===t?"https://vk.com/share.php?act=count&index=0&url="+n:"facebook"===t?"https://knife.support/facebook/?fields=engagement&callback=knifeFacebookCount&id="+n:void 0),a.id="share-"+e,document.getElementsByTagName("head")[0].appendChild(a),!0}var o={facebook:!1,vkontakte:!1};window.shareButtons=function(){var e=document.querySelectorAll(".share .share__link");if(null===e)return!1;for(var t=0;t<e.length;t++){var n=e[t].dataset.label;e[t].addEventListener("click",function(e){var t,n,a;e.preventDefault(),t=this.href,n={width:600,height:400,id:this.dataset.label},a=Math.round(screen.width/2-n.width/2),e=0,screen.height>n.height&&(e=Math.round(screen.height/3-n.height/2)),window.open(t,n.id,"left="+a+",top="+e+",width="+n.width+",height="+n.height+",personalbar=0,toolbar=0,scrollbars=1,resizable=1")}),n in o&&!1===o[n]&&(o[n]=a(n))}},window.VK=window.VK||{},window.VK.Share={count:function(e,t){if(void 0!==t&&t)for(var n=document.querySelectorAll(".share .share__link--vkontakte"),a=0;a<n.length;a++){var o=document.createElement("span");o.className="share__count",o.innerHTML=t,n[a].appendChild(o)}}},window.knifeFacebookCount=function(e){var t,n=0,a=e.engagement||{};for(t in a){var o=a[t];"K"===o.charAt(o.length-1)&&(o=1e3*parseFloat(o.substring(0,o.length-1))),n+=parseInt(o)}if(0!==n)for(var r=document.querySelectorAll(".share .share__link--facebook"),i=0;i<r.length;i++){var c=document.createElement("span");c.className="share__count",c.innerHTML=n,r[i].appendChild(c)}},window.shareButtons()}();
