...
!function(){var e=document.querySelector(".entry-content");if(null===e)return;var r=document.querySelector(".entry-inpost");if(null===r||null===r.firstElementChild)return;var n=Math.floor(e.children.length/3);if(8<e.children.length)for(var t=["p","blockquote"],i=n;i<e.children.length;i++){var l=e.children[i];if(!(t.indexOf(l.tagName.toLowerCase())<0)&&void 0!==e.children[i-1]){var d=e.children[i-1];if(!(t.indexOf(d.tagName.toLowerCase())<0)){var a=document.createElement("aside");a.classList.add("aside","aside--widget"),a.appendChild(r.firstElementChild),e.insertBefore(a,l);break}}}r.parentNode.removeChild(r)}();
