...
"use strict";null!==document.getElementById("comments")&&function(n,e,t){console.log(e);var o=new XMLHttpRequest;o.open(e,n,!0),o.setRequestHeader("Content-Type","application/json"),o.onload=function(){if(200===o.status)return t(JSON.parse(o.responseText));console.error("Error while ".concat(n," loading"))},o.send()}("/id/comments?post=91039","GET",function(n){var t=[];(n.fields||[]).forEach(function(e){null!==e.parent&&t.find(function(n){return n.id===e.parent}).id,t.push(e)})});
