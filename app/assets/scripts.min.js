...
!function(){var e=document.getElementById("load-comments");if(null===e||"undefined"==typeof knife_comments_id)return;_hcwp=window._hcwp||[],_hcwp.push({widget:"Bloggerstream",widget_id:knife_comments_id,selector:"#load-comments",label:e.textContent+"<strong>{%COUNT%}</strong>"}),_hcwp.push({widget:"Stream",widget_id:knife_comments_id});var n=document.createElement("div");n.classList.add("entry-footer__comments","comments"),n.id="hypercomments_widget";var t=document.querySelector(".entry-footer__inner");t.insertBefore(n,t.firstChild);var i=document.createElement("script");i.type="text/javascript",i.async=!0,i.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js";var o=document.getElementsByTagName("script")[0];o.parentNode.insertBefore(i,o.nextSibling),e.addEventListener("click",function(e){e.preventDefault();var t=0;return document.body.classList.contains("is-comments")||(t=n.scrollHeight),document.body.classList.toggle("is-comments"),n.style.height=t+"px"})}();
