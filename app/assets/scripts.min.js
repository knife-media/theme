...
"use strict";!function(){function o(e){var n,t,o=document.createElement("script");return o.type="text/javascript",o.src=(n=e,t=(t=document.querySelector('link[rel="canonical"]'))&&t.href?encodeURIComponent(t.href):encodeURIComponent(window.location.href.replace(window.location.hash,"")),"vkontakte"===n?"https://vk.com/share.php?act=count&index=0&url="+t:"facebook"===n?"https://knife.support/facebook/?fields=engagement&callback=knifeFacebookCount&id="+t:void 0),o.id="share-"+e,document.getElementsByTagName("head")[0].appendChild(o),!0}var a={facebook:!1,vkontakte:!1};window.shareButtons=function(){var e=document.querySelectorAll(".share .share__link");if(null===e)return!1;for(var n=0;n<e.length;n++){var t=e[n].dataset.label;e[n].addEventListener("click",function(e){return e.preventDefault(),n=this.href,t={width:600,height:400,id:this.dataset.label},o=Math.round(screen.width/2-t.width/2),a=0,screen.height>t.height&&(a=Math.round(screen.height/3-t.height/2)),void window.open(n,t.id,"left="+o+",top="+a+",width="+t.width+",height="+t.height+",personalbar=0,toolbar=0,scrollbars=1,resizable=1");var n,t,o,a}),t in a&&!1===a[t]&&(a[t]=o(t))}},window.VK=window.VK||{},window.VK.Share={count:function(e,n){if(void 0!==n&&n)for(var t=document.querySelectorAll(".share .share__link--vkontakte"),o=0;o<t.length;o++){var a=document.createElement("span");a.className="share__count",a.innerHTML=n,t[o].appendChild(a)}}},window.knifeFacebookCount=function(e){var n=0,t=e.engagement||{};for(var o in t)n+=t[o];if(0!==n)for(var a=document.querySelectorAll(".share .share__link--facebook"),r=0;r<a.length;r++){var i=document.createElement("span");i.className="share__count",i.innerHTML=n,a[r].appendChild(i)}},window.shareButtons()}();
"use strict";!function(){var d,s;function c(e,n){var t=document.createElement("p");e.appendChild(t);var r=document.createElement("a");r.href=n.link,r.innerHTML=n.title,t.appendChild(r)}"undefined"!=typeof knife_similar_posts&&(d=function(e){for(var n,t=0;t<e.length;t++){n=Math.floor(Math.random()*t);var r=e[t];e[t]=e[n],e[n]=r}return e}(knife_similar_posts.similar||[]),s=0,function(){var e=document.querySelector(".entry-footer");if(!(null===e||d.length<s+4)){var n=document.createElement("div");n.classList.add("entry-footer__similar");for(var t=s;t<s+4;t++)d[t].link&&d[t].title&&c(n,d[t]);s+=4,e.appendChild(n)}}(),function(){var e=document.querySelectorAll(".entry-content");if(1===e.length&&1!=knife_similar_posts.hidden){var n=e[0].children;if(console.log(n.length),!(n.length<15||d.length<s+3)){var t=["p","blockquote"],r=Math.floor(n.length/1.5);console.log(r);for(var i=null,l=r;l<n.length-5;l++)if(!(t.indexOf(n[l].tagName.toLowerCase())<0||void 0===n[l-1]||t.indexOf(n[l-1].tagName.toLowerCase())<0)){i=n[l-1];break}if(null!==i){var o=document.createElement("figure");o.classList.add("figure","figure--similar");var a=document.createElement("h4");a.innerHTML=knife_similar_posts.title||"",o.appendChild(a);for(var f=s;f<s+3;f++)d[f].link&&d[f].title&&c(o,d[f]);s+=3,i.parentNode.insertBefore(o,i.nextSibling)}}}}(),console.log("2"))}();
