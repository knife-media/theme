...
!function(){if("undefined"==typeof knife_backdrop)return;var o=document.createElement("div");if(o.classList.add("backdrop"),void 0!==knife_backdrop.color&&(document.body.style.backgroundColor="#"+knife_backdrop.color),void 0!==knife_backdrop.color&&(document.querySelector(".block-bottom").style.backgroundColor="#"+knife_backdrop.color),void 0===knife_backdrop.image)return document.body.appendChild(o);o.style.backgroundImage="url("+knife_backdrop.image+")",void 0!==knife_backdrop.size&&(o.style.backgroundSize=knife_backdrop.size);var e=new Image;e.addEventListener("load",function(){document.body.appendChild(o)}),e.src=knife_backdrop.image}();
