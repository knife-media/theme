...
"use strict";!function(){var t,a,r,o;function n(t,n){r=function(){for(var t=0,e=0;t<a.length;t++)for(var n=document.querySelectorAll(a[t]),i=0;i<n.length;i++,e++)n[i].setAttribute("data-satanization",e),r[e]=n[i].innerHTML;return r}();var i=new XMLHttpRequest;i.open("POST","/satanization/",!0),i.setRequestHeader("Content-Type","application/json"),document.body.classList.add("is-satanized"),i.onload=function(){if(o.innerHTML=knife_satanize.button,200!==i.status)return console.error("Error while /satanization/ loading");var t=JSON.parse(i.responseText);if(!t.results)return alert("excludes");for(var e=0;e<t.results.length;e++)document.querySelector('[data-satanization="'+e+'"]').innerHTML=t.results[e];o.innerHTML=knife_satanize.getback||"",n.style.backgroundImage="linear-gradient(to bottom,#3b2307,#931111,#e62020)"},o.innerHTML=knife_satanize.process||"",i.send(JSON.stringify({headings:r,path:t}))}"undefined"!=typeof knife_satanize&&(t=knife_satanize.button.split(" "),knife_satanize.button=t[0]+"<strong>"+t[1]+"</strong>",a=[".widget-single .widget-single__content-title",".widget-cents .widget-cents__link",".widget-story .widget-story__title-link",".widget-blunt .widget-blunt__link",".widget-transparent .widget-transparent__content-link",".widget-club .widget-club__content-link",".widget-recent .widget-recent__content-link",".widget-news .widget-news__content-link",".unit .unit__content-link",".entry-header .entry-header__lead",".entry-header .entry-header__title",".entry-header .entry-header__link p",".entry-content p",".entry-content h1",".entry-content h2",".entry-content h3",".entry-content h4",".entry-content h5"],r=[],(o=document.createElement("button")).classList.add("promo","promo--satanization"),o.innerHTML=knife_satanize.button,document.body.appendChild(o),window.addEventListener("scroll",function(){return 100<window.scrollY?o.classList.add("promo--freeze"):o.classList.remove("promo--freeze")}),o.addEventListener("click",function(t){t.preventDefault();t=document.querySelector(".backdrop");if(null===t&&((t=document.createElement("div")).classList.add("backdrop"),document.body.appendChild(t)),!1===t.hasAttribute("data-image")&&t.setAttribute("data-image",t.style.backgroundImage),!document.body.classList.contains("is-satanized"))return n(document.location.pathname,t);document.body.classList.remove("is-satanized");for(var e=0;e<r.length;e++)document.querySelector('[data-satanization="'+e+'"]').innerHTML=r[e];r=[],o.innerHTML=knife_satanize.button||"",t.style.backgroundImage=t.getAttribute("data-image")}))}();
