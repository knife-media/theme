...
!function(){if("undefined"==typeof knife_mistype_reporter)return;function p(e,t){return knife_mistype_reporter.hasOwnProperty(e)?knife_mistype_reporter[e]:t||""}function c(){var e=document.querySelector(".mistype");e.parentNode&&e.parentNode.removeChild(e)}function s(e){if(27===e.keyCode){document.removeEventListener("keydown",s);var t=document.querySelector(".mistype");t.parentNode&&t.parentNode.removeChild(t)}}function n(t){var n=document.querySelector(".mistype");null!==n&&n.parentNode.removeChild(n),(n=document.createElement("div")).classList.add("mistype"),document.body.appendChild(n);var e=document.createElement("div");e.classList.add("mistype__popup"),n.appendChild(e);var d=document.createElement("h3");d.classList.add("mistype__popup-heading"),d.textContent=p("heading"),e.appendChild(d);var o=document.createElement("p");o.classList.add("mistype__popup-marked"),o.textContent=t,e.appendChild(o);var r=document.createElement("textarea");r.classList.add("mistype__popup-comment"),r.setAttribute("placeholder",p("textarea")),r.setAttribute("maxlength",300),e.appendChild(r);var a=document.createElement("button");a.classList.add("mistype__popup-submit","button"),a.textContent=p("button","Send"),e.appendChild(a),a.addEventListener("click",function(e){e.preventDefault(),function(e,t){var n={comment:t,marked:e,location:document.location.href},d="action="+p("action")+"&nonce="+p("nonce");for(key in n)d+="&"+key+"="+n[key];var o=new XMLHttpRequest;o.open("POST",p("ajaxurl")),o.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8"),o.send(d)}(t,r.value),n.parentNode.removeChild(n)});var i=document.createElement("button");i.classList.add("mistype__popup-close"),i.addEventListener("click",c),e.appendChild(i),document.addEventListener("keydown",s,!0)}document.addEventListener("keydown",function(e){if(e.ctrlKey&&13==e.keyCode){var t=window.getSelection().toString();0<t.length&&n(t.substring(0,300))}})}();
