!function(){var a=document.querySelectorAll(".widget-adfox");if(a.length<1)return;function t(a){var t={},e=a.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(2<e.length){t={ownerId:e[1],params:{}};for(var n=e[2].split("&"),o=0;o<n.length;o++){var d=n[o].split("=");1!=d.length&&"pr"!==d[0]&&(t.params[d[0]]=decodeURIComponent(d[1].replace(/\+/g," ")))}}return t}function e(a,t,e){if(t.onStub=function(){a.parentNode.removeChild(a)},t.onError=function(){a.parentNode.removeChild(a)},t.onLoad=function(){a.classList.add("widget-adfox--loaded")},"1"==e)return function(a){window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([a,["desktop","phone"],{phoneWidth:1023,isAutoReloads:!0}])}(t);window.adfoxAsyncParams=window.adfoxAsyncParams||[],window.adfoxAsyncParams.push(t)}for(var n=0;n<a.length;n++){var o=a[n].querySelector("[data-link]");if(o.dataset.link){var d=t(o.dataset.link),r=Date.now().toString(10)+Math.random().toString(10).substr(2,5);d.containerId="adfox_"+r;var i=document.createElement("div");i.id="adfox_"+r,a[n].replaceChild(i,o),e(a[n],d,o.dataset.adaptive)}}var s=document.createElement("script");s.type="text/javascript",s.async=!0,s.crossorigin="anonymous",s.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(s)}();
