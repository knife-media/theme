...
!function(){var e=document.querySelectorAll(".embed");if(e.length<1)return;function t(e){var t=document.createElement("iframe"),r=function(e){var t=document.createElement("div");t.classList.add("embed__loader"),e.appendChild(t);var r=document.createElement("span");return r.classList.add("embed__loader-bounce"),t.appendChild(r),t}(e);return t.setAttribute("frameborder","0"),t.setAttribute("src",e.dataset.embed),t.addEventListener("load",function(){r.parentNode.removeChild(r)}),t}for(var r=0;r<e.length;r++)e[r].addEventListener("click",function(e){if(this.hasAttribute("data-embed")){for(e.preventDefault();this.firstChild;)this.removeChild(this.firstChild);this.appendChild(t(this))}})}();
