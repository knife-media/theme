...
"use strict";!function(){var e,o;"undefined"==typeof knife_preview_links||null!==(e=document.querySelector(".post"))&&(o=document.body,e.addEventListener("click",function(e){var n,t,i=e.target;function r(){var e=document.getElementById("preview");null!==e&&e.parentNode.removeChild(e),o.classList.remove("is-preview"),window.removeEventListener("resize",a)}function d(e){e.target===n&&r()}function a(){t!==window.innerWidth&&r()}i.hasAttribute("data-preview")&&(e.preventDefault(),r(),n=function(e){var t=document.createElement("div");t.classList.add("preview"),t.setAttribute("id","preview"),o.appendChild(t);var n=document.createElement("div");n.classList.add("preview__content","preview__content--preload"),t.appendChild(n);var i=new Image;return i.setAttribute("src",e),i.setAttribute("alt",knife_preview_links.alt||""),i.addEventListener("load",function(){n.classList.remove("preview__content--preload")}),i.addEventListener("error",function(){n.classList.remove("preview__content--preload"),n.classList.add("preview__content--warning");var e=document.createElement("strong");e.textContent=knife_preview_links.warning||"",n.appendChild(e)}),n.appendChild(i),(i=document.createElement("a")).textContent=knife_preview_links.external||"",i.innerHTML=i.innerHTML+'<span class="icon icon--external"></span>',i.setAttribute("href",e),i.setAttribute("target","_blank"),i.setAttribute("rel","noopener"),n.appendChild(i),t}(i.getAttribute("href")),t=window.innerWidth,function(){var e=i.getBoundingClientRect(),t=n.querySelector(".preview__content").getBoundingClientRect();if(n.classList.remove("preview--fullwidth"),n.style.top=e.bottom+document.documentElement.scrollTop+"px",n.style.left="auto",t.width+e.left+100<window.innerWidth)return n.style.left=e.left+"px";n.classList.add("preview--fullwidth")}(),o.classList.add("is-preview"),window.addEventListener("resize",a),n.addEventListener("click",d),n.addEventListener("touchend",d))}))}();
