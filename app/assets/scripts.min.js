...
!function(){var e=document.querySelector(".entry-content");if(null===e)return;var r=document.querySelector(".entry-widgets");if(null===r||null===r.firstElementChild)return;var t=Math.floor(e.children.length/2);if(8<e.children.length)for(var n=["p","blockquote"],i=t;i<e.children.length;i++){var l=e.children[i];if(!(n.indexOf(l.tagName.toLowerCase())<0)&&void 0!==e.children[i-1]){var d=e.children[i-1];if(!(n.indexOf(d.tagName.toLowerCase())<0)){var a=document.createElement("figure");a.classList.add("figure","figure--widget"),a.appendChild(r.firstElementChild),e.insertBefore(a,l);break}}}0<r.children.length?r.classList.add("entry-widgets--expand"):r.parentNode.removeChild(r)}();
