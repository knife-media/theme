...
!function(){var e=document.querySelector(".entry-content");if(null===e)return;e.addEventListener("click",function(e){var n=e.target||e.srcElement;if(n.hasAttribute("data-body")){var r=document.getElementById("reference");null!==r&&r.parentNode.removeChild(r),function(e,t){var n=t.getBoundingClientRect().top+window.pageYOffset||document.documentElement.scrollTop;e.style.top=n+"px"}(r=function(e){var t=document.createElement("div");t.classList.add("reference"),t.setAttribute("id","reference");var n=document.createElement("div");n.classList.add("reference__content"),n.innerHTML=e,t.appendChild(n);var r=document.createElement("button");return r.classList.add("reference__close"),t.appendChild(r),document.body.appendChild(t),t}(n.getAttribute("data-body")),n),n.setAttribute("data-active",!0),r.addEventListener("click",function(e){var t=e.target||e.srcElement;t!==r&&!t.classList.contains("reference__close")||r.parentNode.removeChild(r),n.removeAttribute("data-active")})}})}();
...
!function(){var a=document.querySelector(".entry-content");if("undefined"==typeof knife_similar_contents||null===a)return;var l=function(e){for(var t,n=0;n<e.length;n++){t=Math.floor(Math.random()*n);var r=e[n];e[n]=e[t],e[t]=r}return e}(knife_similar_contents.similar||[]);function o(e){var t=document.createElement("figure");t.classList.add("figure","figure--similar");var n=document.createElement("h4");n.innerHTML=knife_similar_contents.title||"",t.appendChild(n);for(var r=0;r<l.length&&r<3;r++)if(l[r].link&&l[r].title){var i=document.createElement("p");t.appendChild(i);var a=document.createElement("a");a.href=l[r].link,a.innerHTML=l[r].title,i.appendChild(a)}e.parentNode.insertBefore(t,e.nextSibling)}!function(){if(a.children.length<10||l.length<1)return;var e=Math.floor(a.children.length/1.5);if(null!==a.querySelector(".figure--similar"))return;for(var t=["p","blockquote"],n=e;n<a.children.length-5;n++){var r=a.children[n];if(!(t.indexOf(r.tagName.toLowerCase())<0)&&void 0!==a.children[n-1]){var i=a.children[n-1];if(!(t.indexOf(i.tagName.toLowerCase())<0)){o(i);break}}}}(),function(){if(void 0===knife_similar_contents.action)return;for(var e=a.querySelectorAll(".figure--similar")||[],t=0;t<e.length;t++)for(var n=e[t].querySelectorAll("a"),r=0;r<n.length;r++)n[r].setAttribute("data-action",knife_similar_contents.action),n[r].href&&n[r].setAttribute("data-label",n[r].href)}()}();
