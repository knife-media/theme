...
!function(){var a=document.querySelector(".entry-content");if("undefined"==typeof knife_similar_posts||"undefuned"===knife_similar_posts.similar)return;var l=function(e){for(var r,i=0;i<e.length;i++){r=Math.floor(Math.random()*i);var t=e[i];e[i]=e[r],e[r]=t}return e}(knife_similar_posts.similar);function o(e){var r=document.createElement("figure");r.classList.add("figure","figure--similar");var i=document.createElement("h4");i.innerHTML=knife_similar_posts.title||"",r.appendChild(i);for(var t=0;t<l.length&&t<3;t++)if(l[t].link&&l[t].title){var n=document.createElement("p");r.appendChild(n);var a=document.createElement("a");a.href=l[t].link,a.innerHTML=l[t].title,n.appendChild(a)}e.parentNode.insertBefore(r,e.nextSibling)}!function(){if(null===a||a.children.length<10)return;var e=Math.floor(a.children.length/1.5);if(null!==a.querySelector(".figure--similar"))return;for(var r=["p","blockquote"],i=e;i<a.children.length-5;i++){var t=a.children[i];if(!(r.indexOf(t.tagName.toLowerCase())<0)&&void 0!==a.children[i-1]){var n=a.children[i-1];if(!(r.indexOf(n.tagName.toLowerCase())<0)){o(n);break}}}}(),function(){if(void 0===knife_similar_posts.action)return;for(var e=a.querySelectorAll(".figure--similar")||[],r=0;r<e.length;r++)for(var i=e[r].querySelectorAll("a"),t=0;t<i.length;t++)i[t].setAttribute("data-action",knife_similar_posts.action),i[t].href&&i[t].setAttribute("data-label",i[t].href)}()}();
