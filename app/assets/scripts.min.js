!function(){if("undefined"==typeof knife_backdrop)return;var e=document.createElement("div");if(e.classList.add("backdrop"),void 0!==knife_backdrop.color&&(document.querySelector(".block-bottom").style.backgroundColor="#"+knife_backdrop.color),void 0===knife_backdrop.image)return document.body.appendChild(e);e.style.backgroundImage="url("+knife_backdrop.image+")",void 0!==knife_backdrop.size&&(e.style.backgroundSize=knife_backdrop.size);var o=new Image;o.addEventListener("load",function(){document.body.appendChild(e)}),o.src=knife_backdrop.image}();
