...
"use strict";!function(){var e,s;"undefined"==typeof knife_preview_links||null!==(e=document.querySelector(".post"))&&(s=document.body,e.addEventListener("click",function(e){var t,n,i,r,d,o=e.target;o.hasAttribute("data-preview")&&(e.preventDefault(),t=window.scrollY,(n=document.createElement("div")).classList.add("preview"),n.setAttribute("id","preview"),s.appendChild(n),(i=document.createElement("div")).classList.add("preview__content","preview__content--preload"),n.appendChild(i),(r=new Image).setAttribute("src",o.getAttribute("href")),r.setAttribute("alt",knife_preview_links.alt||""),r.addEventListener("load",function(){i.classList.remove("preview__content--preload")}),r.addEventListener("error",function(){i.classList.remove("preview__content--preload"),i.classList.add("preview__content--warning");var e=document.createElement("strong");e.textContent=knife_preview_links.warning||"",i.appendChild(e),i.removeChild(r)}),i.appendChild(r),(e=document.createElement("a")).textContent=knife_preview_links.external||"",e.innerHTML=e.innerHTML+'<span class="icon icon--external"></span>',e.setAttribute("href",o.getAttribute("href")),e.setAttribute("target","_blank"),e.setAttribute("rel","noopener"),i.appendChild(e),(o=document.createElement("button")).classList.add("preview__close"),i.appendChild(o),s.classList.add("is-preview"),s.style.top=-t+"px",d=function(){preview.parentNode===s&&s.removeChild(preview),s.classList.remove("is-preview"),s.style.top="",window.scrollTo(0,t),n.parentNode.removeChild(n)},e=function e(t){27===t.keyCode&&d(),document.removeEventListener("keydown",e)},o.addEventListener("click",function(){d()}),document.addEventListener("keydown",e))}))}();
