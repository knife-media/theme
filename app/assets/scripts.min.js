...
!function(){var e=document.getElementById("load-comments");if(null===e||"undefined"==typeof knife_comments_id)return;_hcwp=window._hcwp||[],_hcwp.push({widget:"Bloggerstream",widget_id:knife_comments_id,selector:"#load-comments",label:e.textContent+"<strong>{%COUNT%}</strong>"}),_hcwp.push({widget:"Stream",widget_id:knife_comments_id});var t=document.createElement("div");t.classList.add("entry-footer__comments","comments"),t.id="hypercomments_widget";var n=document.querySelector(".entry-footer__inner");n.insertBefore(t,n.firstChild);var i=document.createElement("script");i.type="text/javascript",i.async=!0,i.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js";var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(i,c.nextSibling),e.addEventListener("click",function(e){e.preventDefault(),t.classList.toggle("comments--expand"),t.style.height=t.scrollHeight+"px"})}();
