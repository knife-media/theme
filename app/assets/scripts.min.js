...
"use strict";"undefined"!=typeof knife_horror_popup&&function(){var r=document.createElement("div");r.classList.add("horror"),document.body.appendChild(r),function(e){var r=document.createElement("div");r.classList.add("horror__stars","horror__stars--small"),e.appendChild(r);r=document.createElement("div");r.classList.add("horror__stars","horror__stars--medium"),e.appendChild(r);r=document.createElement("div");r.classList.add("horror__stars","horror__stars--large"),e.appendChild(r)}(r);var e=document.createElement("div");e.classList.add("horror__inner"),r.appendChild(e);var t=knife_horror_popup.labels||[],o=document.createElement("p");o.textContent=t[Math.floor(Math.random()*t.length)],e.appendChild(o);o=document.createElement("button");o.textContent=knife_horror_popup.button||"",e.appendChild(o),document.body.classList.add("is-horror"),o.addEventListener("click",function(e){e.preventDefault(),setTimeout(function(){document.body.removeChild(r)},500),r.classList.add("horror--hide"),document.body.classList.remove("is-horror")})}();
