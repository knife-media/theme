...
!function(){var e=document.getElementById("toggle-menu"),t=document.getElementById("toggle-search");return null!==e&&null!==t&&(e.addEventListener("click",function(e){return e.preventDefault(),document.querySelector(".search").classList.contains("search--expand")&&t.click(),document.querySelector(".topline__nav").classList.toggle("topline__nav--expand"),this.classList.toggle("toggle--expand")}),t.addEventListener("click",function(t){t.preventDefault();var n=document.getElementById("search-input");if(document.querySelector(".topline__nav").classList.contains("topline__nav--expand")&&e.click(),n.blur(),!document.querySelector(".search").classList.contains("search--expand")){var c=document.querySelector(".header").offsetTop-window.pageYOffset;c>0&&(document.querySelector(".search").style.paddingTop=c+"px"),n.focus()}return document.querySelector(".search").classList.toggle("search--expand"),document.body.classList.toggle("body--search"),this.classList.toggle("toggle--expand")}),void window.addEventListener("keydown",function(n){return n=n||window.event,27===n.keyCode&&(document.querySelector(".search").classList.contains("search--expand")&&t.click(),void(document.querySelector(".topline__nav").classList.contains("topline__nav--expand")&&e.click()))},!0))}();
!function(){if("undefined"==typeof knife_push)return!1;OneSignal=window.OneSignal||[];var e=function(){var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="https://cdn.onesignal.com/sdks/OneSignalSDK.js";var n=document.getElementsByTagName("script")[0];n.parentNode.insertBefore(e,n)},n=function(){var e=localStorage.getItem("knife-push");return"undefined"!=typeof Notification&&"default"===Notification.permission&&("string"==typeof e&&Number(e)<Date.now()||(null===e&&localStorage.setItem("knife-push",Date.now()),!1))},t=function(){var e=document.createElement("div");return e.classList.add("push","push--hide"),document.body.appendChild(e),function(){var n=document.createElement("button");n.classList.add("push__close"),n.setAttribute("data-action","Push Notifications — Decline"),e.appendChild(n)}(),function(){var n=document.createElement("div");n.classList.add("push__promo"),"undefined"!=typeof knife_push.promo&&(n.innerHTML=knife_push.promo),e.appendChild(n)}(),function(){var n=document.createElement("button");n.classList.add("push__button"),e.appendChild(n),"undefined"!=typeof knife_push.button&&(n.innerHTML=knife_push.button);var t=document.createElement("span");t.classList.add("icon","icon--notify"),n.appendChild(t)}(),e};document.addEventListener("DOMContentLoaded",function(){if(n()===!1||"undefined"==typeof knife_push.appid)return!1;var i=t();return OneSignal.push(["init",{appId:knife_push.appid,autoRegister:!1,welcomeNotification:{disable:!0}}]),OneSignal.push(function(){if(i.querySelector(".push__close").addEventListener("click",function(){var e=12096e5;return localStorage.setItem("knife-push",Date.now()+e),i.classList.add("push--hide")}),i.querySelector(".push__button").addEventListener("click",function(){return OneSignal.registerForPushNotifications()}),OneSignal.on("notificationPermissionChange",function(e){return i.classList.add("push--hide")}),OneSignal.isPushNotificationsSupported())return i.classList.remove("push--hide")}),e()},!1)}();
