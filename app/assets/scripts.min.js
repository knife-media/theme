!function(){var a=document.querySelectorAll(".widget-adfox");if(a.length<1)return;function e(a,o){var n=a.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(2<n.length){o.ownerId=n[1],o.params={};for(var t=n[2].split("&"),e=0;e<t.length;e++){var d=t[e].split("=");1!=d.length&&"pr"!==d[0]&&(o.params[d[0]]=decodeURIComponent(d[1].replace(/\+/g," ")))}}return console.log(o),o}function d(a,o){return a.onStub=function(){o.parentNode.removeChild(o)},a.onError=function(){o.parentNode.removeChild(o)},a.onLoad=function(){o.classList.add("widget-adfox--loaded")},a}function o(a,o,n){if(a.common)return function(a,o,n){var t={};t.containerId="adfox_"+o,t=e(a,t=d(t,n)),window.adfoxAsyncParams=window.adfoxAsyncParams||[],window.adfoxAsyncParams.push(t)}(a.common,o,n);a.mobile&&function(a,o,n){var t={};t.containerId="adfox_"+o,t=e(a,t=d(t,n)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([t,["tablet","phone"],{tabletWidth:1023,isAutoReloads:!0}])}(a.mobile,o,n),a.desktop&&function(a,o,n){var t={};t.containerId="adfox_"+o,t=e(a,t=d(t,n)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([t,["desktop"],{tabletWidth:1023,isAutoReloads:!0}])}(a.desktop,o,n)}for(var n=0;n<a.length;n++){var t=a[n].querySelector("div");if(null!==t&&0!==t.dataset.length){var r=Date.now().toString(10)+Math.random().toString(10).substr(2,5),i=document.createElement("div");i.id="adfox_"+r,a[n].replaceChild(i,t),o(t.dataset,r,a[n])}}var s=document.createElement("script");s.type="text/javascript",s.async=!0,s.crossorigin="anonymous",s.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(s)}();
