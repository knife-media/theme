!function(){var e=document.querySelector(".search");if(null===e||"undefined"==typeof knife_search_id)return!1;var t="search-gcse",n="gsc-results",r=null,a=function(){if("complete"!==document.readyState)return google.setOnLoadCallback(a,!0);google.search.cse.element.render({gname:t,div:t,tag:"searchresults-only",attributes:{enableHistory:!1,gaQueryParameter:"s",queryParameterName:"s"}}),document.getElementById("search-input").oninput=function(){var e=google.search.cse.element.getElement(t);e.execute(this.value)};var e=window.MutationObserver||window.WebKitMutationObserver;r=new e(function(e){for(var t=0;t<e.length;++t)if(e[t].target.classList.contains(n))return s()}),r.observe(document.getElementById(t),{subtree:!0,attributes:!1,childList:!0,characterData:!1})},c=function(n){var r=document.createElement("div");r.id=t,r.style.display="none",e.appendChild(r),window.__gcse={parsetags:"explicit",callback:a};var c=document.createElement("script");c.type="text/javascript",c.async=!0,c.src="https://cse.google.com/cse.js?cx="+n;var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(c,s)},s=function(){var e=document.getElementById("search-results"),n=document.getElementById(t).querySelectorAll(".gs-result");if(document.getElementById("search-input").value.length>0){for(;e.firstChild;)e.removeChild(e.firstChild);for(var r=function(t){var n={link:t.querySelector("a.gs-title").href,head:t.querySelector("a.gs-title").textContent,text:t.querySelector(".gs-snippet").textContent},r=document.createElement("p");r.className="search__results-head",r.appendChild(document.createTextNode(n.head));var a=document.createElement("p");a.className="search__results-text",a.appendChild(document.createTextNode(n.text));var c=document.createElement("a");return c.className="search__results-link",c.href=n.link,c.appendChild(r),c.appendChild(a),e.appendChild(c)},a=0;a<n.length;a++){if(!n[a].querySelector("a.gs-title")||!n[a].querySelector(".gs-snippet"))return!1;r(n[a])}}};document.querySelector(".topline .toggle--search").addEventListener("click",function(e){return e.preventDefault(),document.getElementById("search-input").focus(),!this.classList.contains("toggle--expand")&&("undefined"==typeof window.__gcse?c(knife_search_id):void 0)})}();
