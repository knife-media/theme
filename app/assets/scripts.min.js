...
!function(){var r=document.getElementById("generator");if(null===r||"undefined"==typeof knife_generator_options)return;if("undefined"==typeof knife_generator_items||knife_generator_items.length<1)return;var a=knife_generator_items,t=null;!function(){var e=document.createElement("div");e.classList.add("entry-generator__loader"),r.insertBefore(e,r.firstChild);var t=document.createElement("span");t.classList.add("entry-generator__loader-bounce"),e.appendChild(t)}(),void 0!==knife_generator_options.page_background&&(r.style.backgroundColor=knife_generator_options.page_background),void 0!==knife_generator_options.page_color&&(r.style.color=knife_generator_options.page_color),function(){if(void 0===knife_generator_options.button_text)return;var e=document.createElement("div");e.classList.add("entry-generator__button"),r.appendChild(e),(t=document.createElement("button")).classList.add("button"),t.setAttribute("type","button"),t.textContent=knife_generator_options.button_text,e.appendChild(t),void 0!==knife_generator_options.button_background&&(t.style.backgroundColor=knife_generator_options.button_background),void 0!==knife_generator_options.button_color&&(t.style.color=knife_generator_options.button_color)}(),t.addEventListener("click",function(e){e.preventDefault();var t,n=Math.floor(Math.random()*a.length),o=a[n];(t=new Image).setAttribute("src",o.poster),t.addEventListener("load",function(){t.classList.add("entry-generator__poster")}),r.classList.add("entry-generator--loader")})}();
