...
"use strict";!function(){var e,r,a,i;function n(e){a=function(){for(var e=0,t=0;e<r.length;e++)for(var n=document.querySelectorAll(r[e]),i=0;i<n.length;i++,t++)n[i].setAttribute("data-satanization",t),a[t]=n[i].innerHTML;return a}();var n=new XMLHttpRequest;n.open("POST","/satanization/",!0),n.setRequestHeader("Content-Type","application/json"),n.onload=function(){if(i.innerHTML=knife_satanize.button,200!==n.status)return console.error("Error while /satanization/ loading");var e=JSON.parse(n.responseText);if(!e.results)return alert("excludes");for(var t=0;t<e.results.length;t++)document.querySelector('[data-satanization="'+t+'"]').innerHTML=e.results[t];i.innerHTML=knife_satanize.getback||""},i.classList.add("promo--freeze"),i.innerHTML=knife_satanize.process||"",n.send(JSON.stringify({headings:a,path:e}))}"undefined"!=typeof knife_satanize&&(e=knife_satanize.button.split(" "),knife_satanize.button=e[0]+"<strong>"+e[1]+"</strong>",r=[".widget-single .widget-single__content-title",".widget-cents .widget-cents__link",".widget-story .widget-story__title-link",".widget-blunt .widget-blunt__link",".widget-transparent .widget-transparent__content-link",".widget-club .widget-club__content-link",".widget-recent .widget-recent__content-link",".widget-news .widget-news__content-link",".unit .unit__content-link",".entry-header .entry-header__lead",".entry-header .entry-header__title",".entry-header .entry-header__link p",".entry-content p",".entry-content h1",".entry-content h2",".entry-content h3",".entry-content h4",".entry-content h5"],a=[],(i=document.createElement("button")).classList.add("promo","promo--satanization"),i.innerHTML=knife_satanize.button,document.body.appendChild(i),i.addEventListener("click",function(e){if(e.preventDefault(),0===a.length)return n(document.location.pathname);for(var t=0;t<a.length;t++)document.querySelector('[data-satanization="'+t+'"]').innerHTML=a[t];a=[],i.classList.remove("promo--freeze"),i.innerHTML=knife_satanize.button||""}))}();
