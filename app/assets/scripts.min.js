...
!function(){var a=document.querySelector(".search"),e=document.getElementById("toggle-search");if(null===e)return;if(null===a||"undefined"==typeof knife_search_id)return e.classList.add("toggle--hidden");var c="search-gcse",s=function(){if("complete"!==document.readyState)return google.setOnLoadCallback(s,!0);google.search.cse.element.render({gname:c,div:c,tag:"searchresults-only",attributes:{enableHistory:!1,gaQueryParameter:"s",queryParameterName:"s"}}),document.getElementById("search-input").oninput=function(){google.search.cse.element.getElement(c).execute(this.value)};var e=window.MutationObserver||window.WebKitMutationObserver;new e(function(e){for(var t=0;t<e.length;++t)if(e[t].target.classList.contains("gsc-results"))return n()}).observe(document.getElementById(c),{subtree:!0,attributes:!1,childList:!0,characterData:!1})},n=function(){for(var s=document.getElementById("search-results"),e=document.getElementById(c).querySelectorAll(".gs-result");s.firstChild;)s.removeChild(s.firstChild);if(0<document.getElementById("search-input").value.length){var t=function(e){var t={link:e.querySelector("a.gs-title").href,head:e.querySelector("a.gs-title").textContent,text:e.querySelector(".gs-snippet").textContent},n=document.createElement("p");n.className="search__results-head",n.appendChild(document.createTextNode(t.head));var r=document.createElement("p");r.className="search__results-text",r.appendChild(document.createTextNode(t.text));var a=document.createElement("a");return a.className="search__results-link",a.href=t.link,a.appendChild(n),a.appendChild(r),s.appendChild(a)};if(1==e.length&&e[0].classList.contains("gs-no-results-result")){var n=document.createElement("p");n.className="search__results-head",n.appendChild(document.createTextNode(e[0].textContent)),s.appendChild(n)}for(var r=0;r<e.length;r++){if(!e[r].querySelector("a.gs-title")||!e[r].querySelector(".gs-snippet"))return!1;t(e[r])}}};e.addEventListener("click",function(e){return e.preventDefault(),!this.classList.contains("toggle--expand")&&(void 0===window.__gcse?function(e){var t=document.createElement("div");t.id=c,t.style.display="none",a.appendChild(t),window.__gcse={parsetags:"explicit",callback:s};var n=document.createElement("script");n.type="text/javascript",n.async=!0,n.src="https://cse.google.com/cse.js?cx="+e;var r=document.getElementsByTagName("script")[0];r.parentNode.insertBefore(n,r)}(knife_search_id):void 0)})}();
!function(){var c=document.getElementById("toggle-menu"),t=document.getElementById("toggle-search");if(null===c||null===t)return;c.addEventListener("click",function(e){return e.preventDefault(),document.querySelector(".search").classList.contains("search--expand")&&t.click(),document.querySelector(".topline__nav").classList.toggle("topline__nav--expand"),this.classList.toggle("toggle--expand")}),t.addEventListener("click",function(e){e.preventDefault();var t=document.getElementById("search-input");if(document.querySelector(".topline__nav").classList.contains("topline__nav--expand")&&c.click(),t.blur(),!document.querySelector(".search").classList.contains("search--expand")){var n=document.querySelector(".header").offsetTop-window.pageYOffset;0<n&&(document.querySelector(".search").style.paddingTop=n+"px"),t.focus()}return document.querySelector(".search").classList.toggle("search--expand"),document.body.classList.toggle("body--search"),this.classList.toggle("toggle--expand")}),window.addEventListener("keydown",function(e){if(27!==(e=e||window.event).keyCode)return!1;document.querySelector(".search").classList.contains("search--expand")&&t.click(),document.querySelector(".topline__nav").classList.contains("topline__nav--expand")&&c.click()},!0)}();
