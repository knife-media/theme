...
!function(){var _=document.getElementById("quiz");if(null===_||"undefined"==typeof knife_quiz_options)return;var n=null,i=0,u=0;function r(o,r,s){var a=null;knife_quiz_options.hasOwnProperty("message")&&knife_quiz_options.message&&(a=document.createElement("div")).classList.add("entry-quiz__vote-message"),r.addEventListener("click",function(t){var e=t.target||t.srcElement;if(e.hasAttribute("data-answer")&&!r.classList.contains("entry-quiz__vote--complete")){var n=o[e.dataset.answer];if(r.classList.add("entry-quiz__vote--complete"),a&&n.hasOwnProperty("message")&&n.message&&(a.innerHTML=n.message,r.appendChild(a)),knife_quiz_options.hasOwnProperty("points")&&knife_quiz_options.points)return n.hasOwnProperty("points")&&n.points&&(u+=parseInt(n.points)),e.classList.add(s+"--selected");if(n.hasOwnProperty("binary")&&n.binary)return u+=1,e.classList.add(s+"--correct");for(var i=0;i<o.length;i++)o[i].hasOwnProperty("binary")&&o[i].binary&&r.children[i].classList.add(s+"--missed");return e.classList.add(s+"--wrong")}})}function s(t,e){var n=document.createElement("div");return n.classList.add("entry-quiz__vote"),_.insertBefore(n,e),knife_quiz_options.hasOwnProperty("shuffle")&&knife_quiz_options.shuffle&&t.sort(function(){return.5-Math.random()}),knife_quiz_options.hasOwnProperty("attachment")&&knife_quiz_options.attachment?function(t,e){for(var n=0;n<t.length;n++){var i=document.createElement("div");if(void 0!==t[n].attachment){var o=document.createElement("img");o.setAttribute("src",t[n].attachment),i.appendChild(o),i.classList.add("entry-quiz__vote-attachment"),i.setAttribute("data-answer",n),e.appendChild(i)}}r(t,e,"entry-quiz__vote-attachment"),e.classList.add("entry-quiz__vote--attachment")}(t,n):function(t,e){for(var n=0;n<t.length;n++){var i=document.createElement("div");void 0!==t[n].choice&&(i.classList.add("entry-quiz__vote-choice"),i.setAttribute("data-answer",n),i.innerHTML=t[n].choice,e.appendChild(i))}r(t,e,"entry-quiz__vote-choice"),e.classList.add("entry-quiz__vote--choice")}(t,n)}function o(t,e){if(_.parentNode.scrollIntoView({block:"start",behavior:"smooth"}),t.hasOwnProperty("poster")){var n=document.createElement("img");n.classList.add("entry-quiz__poster"),n.setAttribute("src",t.poster),_.insertBefore(n,_.firstChild)}var i=_.querySelector(".entry-quiz__share");document.body.contains(i)&&function(t,e){if(void 0===knife_quiz_options.share_links)return;if(void 0===knife_quiz_options.permalink)return;if(knife_quiz_options.hasOwnProperty("noshare")&&knife_quiz_options.noshare)return;for(var n,i=_.querySelector(".entry-quiz__title").textContent,o=[knife_quiz_options.permalink.replace(/\/?$/,"/")+e+"/",t.heading||i],r=_.querySelectorAll(".share > .share__link"),s=0;n=r[s];s++){var a=n.getAttribute("data-label");if(void 0!==knife_quiz_options.share_links[a]){var u=knife_quiz_options.share_links[a];n.href=u.link.replace(/%([\d])\$s/g,function(t,e){return encodeURIComponent(o[e-1])})}}"function"===window.shareButtons&&window.shareButtons()}(t,e);var o=_.querySelector(".entry-quiz__vote");document.body.contains(o)&&o.parentNode.removeChild(o);var r=_.querySelector(".entry-quiz__content");return t.hasOwnProperty("details")?r.innerHTML=t.details:r.parentNode.removeChild(r)}(n=document.createElement("button")).classList.add("entry-quiz__button","button"),n.setAttribute("type","button"),knife_quiz_options.hasOwnProperty("button_start")&&(n.textContent=knife_quiz_options.button_start),_.appendChild(n),"object"!=typeof knife_quiz_items&&(knife_quiz_items=[]),knife_quiz_options.hasOwnProperty("random")&&knife_quiz_options.random&&knife_quiz_items.sort(function(){return.5-Math.random()}),"object"!=typeof knife_quiz_results&&(knife_quiz_results={}),n.addEventListener("click",function(){var t=knife_quiz_items.length;if(0<t&&i<t){var e=knife_quiz_items[i];return i+=1,!1===_.classList.contains("entry-quiz--item")&&(_.classList.add("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_next")&&(n.textContent=knife_quiz_options.button_next)),i===t&&knife_quiz_options.hasOwnProperty("button_last")&&(n.textContent=knife_quiz_options.button_last),function(t,e,n){_.parentNode.scrollIntoView({block:"start",behavior:"smooth"});var i=_.querySelector(".entry-quiz__content");t.hasOwnProperty("question")&&(i.innerHTML=t.question),_.querySelector(".entry-quiz__info").textContent=e+" / "+n;var o=_.querySelector(".entry-quiz__vote");document.body.contains(o)&&o.parentNode.removeChild(o),"object"==typeof t.answers&&0<t.answers.length&&s(t.answers,i.nextSibling)}(e,i,t)}return _.classList.remove("entry-quiz--item"),!1===_.classList.contains("entry-quiz--results")&&"object"==typeof knife_quiz_results[u]?(_.classList.add("entry-quiz--results"),knife_quiz_options.hasOwnProperty("button_repeat")&&(n.textContent=knife_quiz_options.button_repeat),knife_quiz_options.hasOwnProperty("norepeat")&&knife_quiz_options.norepeat&&n.parentNode.removeChild(n),o(knife_quiz_results[u],u)):document.location.reload()})}();
!function(){if("undefined"==typeof knife_push)return;OneSignal=window.OneSignal||[];document.addEventListener("DOMContentLoaded",function(){if(!1==(e=localStorage.getItem("knife-push"),"undefined"!=typeof Notification&&"default"===Notification.permission&&("string"==typeof e&&Number(e)<Date.now()||(null===e&&localStorage.setItem("knife-push",Date.now()),!1)))||void 0===knife_push.appid)return!1;var e,n,t,i,o=((i=document.createElement("div")).classList.add("push","push--hide"),document.body.appendChild(i),(n=document.createElement("button")).classList.add("push__close"),n.setAttribute("data-action","Push Notifications — Decline"),i.appendChild(n),(t=document.createElement("div")).classList.add("push__promo"),void 0!==knife_push.promo&&(t.innerHTML=knife_push.promo),i.appendChild(t),function(){var e=document.createElement("button");e.classList.add("push__button"),i.appendChild(e),void 0!==knife_push.button&&(e.innerHTML=knife_push.button);var n=document.createElement("span");n.classList.add("icon","icon--notify"),e.appendChild(n)}(),i);return OneSignal.push(["init",{appId:knife_push.appid,autoRegister:!1,welcomeNotification:{disable:!0}}]),OneSignal.push(function(){if(o.querySelector(".push__close").addEventListener("click",function(){return localStorage.setItem("knife-push",Date.now()+12096e5),o.classList.add("push--hide")}),o.querySelector(".push__button").addEventListener("click",function(){return OneSignal.registerForPushNotifications()}),OneSignal.on("notificationPermissionChange",function(e){return o.classList.add("push--hide")}),OneSignal.isPushNotificationsSupported())return o.classList.remove("push--hide")}),function(){var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="https://cdn.onesignal.com/sdks/OneSignalSDK.js";var n=document.getElementsByTagName("script")[0];n.parentNode.insertBefore(e,n)}()},!1)}();
