...
!function(){var _=document.getElementById("quiz");if(null===_||"undefined"==typeof knife_quiz_options)return;var n=null,i=0,c=0;function s(o,s,a){var u=null;knife_quiz_options.hasOwnProperty("message")&&knife_quiz_options.message&&(u=document.createElement("div")).classList.add("entry-quiz__vote-message"),s.addEventListener("click",function(e){var t=e.target||e.srcElement;if(t.hasAttribute("data-answer")&&!s.classList.contains("entry-quiz__vote--complete")){var n=o[t.dataset.answer];if(s.classList.add("entry-quiz__vote--complete"),u&&n.hasOwnProperty("message")&&n.message&&(u.innerHTML=n.message,s.appendChild(u)),knife_quiz_options.hasOwnProperty("points")&&knife_quiz_options.points)return n.hasOwnProperty("points")&&n.points&&(c+=parseInt(n.points)),t.classList.add(a+"--selected");if(n.hasOwnProperty("binary")&&n.binary)return c+=1,t.classList.add(a+"--correct");for(var i=0;i<o.length;i++){var r=t.parentNode.children[i];o[i].hasOwnProperty("binary")&&o[i].binary&&r.classList.add(a+"--missed")}return t.classList.add(a+"--wrong")}})}function o(e,t){var n=document.createElement("div");return n.classList.add("entry-quiz__vote"),_.insertBefore(n,t),knife_quiz_options.hasOwnProperty("shuffle")&&knife_quiz_options.shuffle&&e.sort(function(){return.5-Math.random()}),knife_quiz_options.hasOwnProperty("attachment")&&knife_quiz_options.attachment?function(e,t){var n=document.createElement("div");n.classList.add("entry-quiz__vote-grid"),t.appendChild(n);for(var i=0;i<e.length;i++){var r=document.createElement("figure");if(void 0!==e[i].attachment){var o=document.createElement("img");o.setAttribute("src",e[i].attachment),r.appendChild(o),r.classList.add("entry-quiz__vote-attachment"),r.setAttribute("data-answer",i),n.appendChild(r)}}s(e,t,"entry-quiz__vote-attachment"),t.classList.add("entry-quiz__vote--attachment")}(e,n):function(e,t){for(var n=0;n<e.length;n++){var i=document.createElement("div");void 0!==e[n].choice&&(i.classList.add("entry-quiz__vote-choice"),i.setAttribute("data-answer",n),i.innerHTML=e[n].choice,t.appendChild(i))}s(e,t,"entry-quiz__vote-choice"),t.classList.add("entry-quiz__vote--choice")}(e,n)}function r(e,t){if(_.parentNode.scrollIntoView({block:"start",behavior:"smooth"}),e.hasOwnProperty("poster")){var n=document.createElement("img");n.classList.add("entry-quiz__poster"),n.setAttribute("src",e.poster),_.insertBefore(n,_.firstChild)}var i=_.querySelector(".entry-quiz__share");document.body.contains(i)&&function(e,t){if(void 0===knife_quiz_options.share_links)return;if(void 0===knife_quiz_options.permalink)return;if(knife_quiz_options.hasOwnProperty("noshare")&&knife_quiz_options.noshare)return;for(var n,i=_.querySelector(".entry-quiz__title").textContent,r=[knife_quiz_options.permalink.replace(/\/?$/,"/")+t+"/",e.heading||i],o=_.querySelectorAll(".share > .share__link"),s=0;n=o[s];s++){var a=n.getAttribute("data-label");if(void 0!==knife_quiz_options.share_links[a]){var u=knife_quiz_options.share_links[a];n.href=u.link.replace(/%([\d])\$s/g,function(e,t){return encodeURIComponent(r[t-1])})}}"function"===window.shareButtons&&window.shareButtons()}(e,t);var r=_.querySelector(".entry-quiz__vote");document.body.contains(r)&&r.parentNode.removeChild(r);var o=_.querySelector(".entry-quiz__content");return e.hasOwnProperty("details")?o.innerHTML=e.details:o.parentNode.removeChild(o)}knife_quiz_options.hasOwnProperty("button_start")&&((n=document.createElement("button")).classList.add("entry-quiz__button","button"),n.setAttribute("type","button"),n.textContent=knife_quiz_options.button_start),_.appendChild(n),"object"!=typeof knife_quiz_items&&(knife_quiz_items=[]),knife_quiz_options.hasOwnProperty("random")&&knife_quiz_options.random&&knife_quiz_items.sort(function(){return.5-Math.random()}),"object"!=typeof knife_quiz_results&&(knife_quiz_results={}),knife_quiz_options.hasOwnProperty("center")&&knife_quiz_options.center&&_.classList.add("entry-quiz--center"),n.addEventListener("click",function(){var e=knife_quiz_items.length;if(0<e&&i<e){var t=knife_quiz_items[i];return i+=1,!1===_.classList.contains("entry-quiz--item")&&(_.classList.add("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_next")&&(n.textContent=knife_quiz_options.button_next)),i===e&&knife_quiz_options.hasOwnProperty("button_last")&&(n.textContent=knife_quiz_options.button_last),function(e,t,n){_.parentNode.scrollIntoView({block:"start",behavior:"smooth"});var i=_.querySelector(".entry-quiz__content");e.hasOwnProperty("question")&&(i.innerHTML=e.question),_.querySelector(".entry-quiz__info").textContent=t+" / "+n;var r=_.querySelector(".entry-quiz__vote");document.body.contains(r)&&r.parentNode.removeChild(r),"object"==typeof e.answers&&0<e.answers.length&&o(e.answers,i.nextSibling)}(t,i,e)}return!1===_.classList.contains("entry-quiz--results")&&"object"==typeof knife_quiz_results[c]?(_.classList.remove("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_repeat")&&(n.textContent=knife_quiz_options.button_repeat),knife_quiz_options.hasOwnProperty("norepeat")&&knife_quiz_options.norepeat&&n.parentNode.removeChild(n),_.classList.add("entry-quiz--results"),r(knife_quiz_results[c],c)):document.location.reload()})}();
