...
!function(){if("undefined"==typeof knife_user_form)return!1;var e=null,t=function(e,t,n){if("undefined"==typeof t.element)return null;var r=document.createElement(t.element);return r.classList.add("form__field","form__field--"+t.element),r.setAttribute("name",e),"undefined"!=typeof t.placeholder&&r.setAttribute("placeholder",t.placeholder),"undefined"!=typeof t.type&&r.setAttribute("type",t.type),"undefined"!=typeof t.value&&(r.innerHTML=t.value),n.appendChild(r)},n=function(t){t.preventDefault();var n=new FormData(e),r="action="+knife_user_form.action;n.forEach(function(e,t){r+="&"+t+"="+e}),console.log(r);var o=new XMLHttpRequest;o.open("POST",ajaxurl),o.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8"),o.send(r)},r=function(e){var n=knife_user_form.fields;for(var r in n)n.hasOwnProperty(r)&&t(r,n[r],e)},o=document.querySelector(".post"),e=document.createElement("form");return e.classList.add("post__form","form"),e.addEventListener("submit",n),o.appendChild(e),r(e)}();