...
!function(){var e=document.querySelector(".entry-content");if(null===e||e.children.length<8)return;var r=document.querySelector(".entry-widgets");if(null===r||null===r.firstElementChild)return;for(var t=Math.floor(e.children.length/2);t<e.children.length;t++){var n=e.children[t];if("p"===n.tagName.toLowerCase()){var l=document.createElement("figure");l.classList.add("figure","figure--widget"),l.appendChild(r.firstElementChild),e.insertBefore(l,n);break}}0<r.children.length?r.classList.add("entry-widgets--expand"):r.parentNode.removeChild(r)}();
