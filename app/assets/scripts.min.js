...
"use strict";!function(){var t;function n(e){for(var r=t.parentElement.firstChild;r&&r!==t;)1==r.nodeType&&(r.style.display=e),r=r.nextSibling}"undefined"!=typeof knife_horror_popup&&(t=document.querySelector(".header"),function(){var r=document.createElement("div");r.classList.add("horror"),document.body.appendChild(r),function(e){var r=document.createElement("div");r.classList.add("horror__stars","horror__stars--small"),e.appendChild(r);r=document.createElement("div");r.classList.add("horror__stars","horror__stars--medium"),e.appendChild(r);r=document.createElement("div");r.classList.add("horror__stars","horror__stars--large"),e.appendChild(r)}(r);var e=document.createElement("div");e.classList.add("horror__inner"),r.appendChild(e);var t=knife_horror_popup.labels||[],o=document.createElement("p");o.textContent=t[Math.floor(Math.random()*t.length)],e.appendChild(o);o=document.createElement("button");o.textContent=knife_horror_popup.button||"",e.appendChild(o),document.body.classList.add("is-horror"),n("none"),o.addEventListener("click",function(e){e.preventDefault(),setTimeout(function(){document.body.removeChild(r)},500),r.classList.add("horror--hide"),document.body.classList.remove("is-horror"),n("")})}())}();
...
"use strict";!function(){var d,e=document.querySelector(".post");null!==e&&(d=document.body,e.addEventListener("click",function(e){var t,n,c,r=e.target||e.srcElement;r.hasAttribute("data-body")&&(t=function(e){e=e.target||e.srcElement;e!==n&&!e.classList.contains("reference__content-close")||(n.parentNode.removeChild(n),r.removeAttribute("data-active"),d.classList.remove("is-reference"))},null!==(n=document.getElementById("reference"))&&n.parentNode.removeChild(n),n=function(e){var t=document.createElement("div");t.classList.add("reference"),t.setAttribute("id","reference");var n=document.createElement("div");return n.classList.add("reference__content"),n.innerHTML=e,t.appendChild(n),(e=document.createElement("button")).classList.add("reference__content-close"),n.appendChild(e),d.appendChild(t),t}(r.getAttribute("data-body")),c=n,e=r,e=r.getBoundingClientRect().top+document.documentElement.scrollTop,c.style.top=e+"px",r.setAttribute("data-active",!0),d.classList.add("is-reference"),n.addEventListener("click",t),n.addEventListener("touchend",t))}))}();
"use strict";!function(){var e,r,l,o,n;"undefined"==typeof knife_preview_links||null!==(e=document.querySelector(".post"))&&(r=document.getElementById("wpadminbar"),l=document.body,o=0,n=function(e,t){e.preventDefault();var n=function(e){var t=document.getElementById("preview");null!==t&&t.parentNode.removeChild(t),(t=document.createElement("div")).classList.add("preview"),t.setAttribute("id","preview"),l.appendChild(t);var n=document.createElement("div");n.classList.add("preview__content","preview__content--preload"),t.appendChild(n);var i=new Image;i.setAttribute("src",e),i.setAttribute("alt",knife_preview_links.alt||""),i.addEventListener("load",function(){n.classList.remove("preview__content--preload")}),i.addEventListener("error",function(){n.classList.remove("preview__content--preload"),n.classList.add("preview__content--warning");var e=document.createElement("strong");e.textContent=knife_preview_links.warning||"",n.appendChild(e),n.removeChild(i)}),n.appendChild(i);var r=document.createElement("a");return r.textContent=knife_preview_links.external||"",r.innerHTML=r.innerHTML+'<span class="icon icon--external"></span>',r.setAttribute("href",e),r.setAttribute("target","_blank"),r.setAttribute("rel","noopener"),n.appendChild(r),t}(t.getAttribute("href"));r&&window.scrollY<r.clientHeight&&(header.style.marginTop=r.clientHeight-window.scrollY+"px"),o=window.scrollY,l.classList.add("is-preview"),window.screen.width<1024&&(l.style.top=-o+"px");var i=document.createElement("button");i.classList.add("preview__close"),n.appendChild(i),e=n,i=t,i=(t=t.getBoundingClientRect()).bottom+document.documentElement.scrollTop,e.style.top=i+"px",e.style.left=t.left+"px";n.addEventListener("click",function(e){e.target!==n&&!e.target.classList.contains("preview__close")||(null!==(e=document.getElementById("preview"))&&e.parentNode.removeChild(e),l.classList.remove("is-preview"),l.style.top="",window.screen.width<1024&&window.scrollTo(0,o))})},e.querySelectorAll("a[data-preview]").forEach(function(t){t.addEventListener("click",function(e){n(e,t)})}))}();
...
"use strict";!function(){var i,a,r,l;"undefined"!=typeof knife_similar_posts&&(i=function(e){for(var t=0;t<e.length;t++){var n=Math.floor(Math.random()*t),r=e[t];e[t]=e[n],e[n]=r}return e}(knife_similar_posts.similar||[]),a=0,r=function(e){return e=(e=e.replace("http://ads.adfox.ru","https://ads.adfox.ru")).replace("[RANDOM]",Date.now())},l=function(e,t){var n=document.createElement("p");e.appendChild(n);e=document.createElement("a");e.href=r(t.link),e.innerHTML=t.title,n.appendChild(e),t.erid&&((n=document.createElement("span")).textContent=t.erid,e.appendChild(n)),t.pixel&&((new Image).src=r(t.pixel))},function(){var e=document.querySelector(".entry-footer");if(!(null===e||i.length<a+4)){var t=document.createElement("div");t.classList.add("entry-footer__similar");for(var n=a;n<a+4;n++)i[n].link&&i[n].title&&l(t,i[n]);a+=4,(knife_similar_posts.promo||[]).forEach(function(e){e.link&&e.title&&l(t,e)}),e.appendChild(t)}}(),function(){var e=document.querySelectorAll(".entry-content");if(1===e.length&&1!=knife_similar_posts.hidden){var t=e[0].children;if(!(t.length<20))for(var n=20,r=0;n<t.length-5;n++)if("p"===t[n].tagName.toLowerCase()&&void 0!==t[n-1]&&"p"===t[n-1].tagName.toLowerCase()){if(!function(e){if(i.length<a+2)return!1;if(null===e)return!1;var t=document.createElement("figure");t.classList.add("figure","figure--similar");var n=document.createElement("h4");n.innerHTML=knife_similar_posts.title||"",t.appendChild(n);for(var r=a;r<a+2;r++)i[r].link&&i[r].title&&l(t,i[r]);return a+=2,e.parentNode.insertBefore(t,e.nextSibling),!0}(t[n-1])||(r+=1),3<r)break;n=20+n}}}())}();
