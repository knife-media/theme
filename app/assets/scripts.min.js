...
!function(){var s=document.getElementById("quiz");if(null===s||"undefined"==typeof knife_quiz_options)return;var a=null,e=0,u=0;function _(t,e){var n=document.createElement("div");for(n.classList.add("entry-quiz__vote"),s.insertBefore(n,e);n.firstChild;)n.removeChild(n.firstChild);if(knife_quiz_options.hasOwnProperty("shuffle")&&knife_quiz_options.shuffle&&t.sort(function(){return.5-Math.random()}),!knife_quiz_options.hasOwnProperty("attachment")||!knife_quiz_options.attachment)return function(o,r){var s=null;knife_quiz_options.hasOwnProperty("message")&&knife_quiz_options.message&&(s=document.createElement("div")).classList.add("entry-quiz__vote-message"),r.addEventListener("click",function(t){var e=t.target||t.srcElement;if(e.hasAttribute("data-answer")&&!r.classList.contains("entry-quiz__vote--complete")){var n=o[e.dataset.answer];if(r.classList.add("entry-quiz__vote--complete"),s&&n.hasOwnProperty("message")&&n.message&&(s.innerHTML=n.message,r.appendChild(s)),knife_quiz_options.hasOwnProperty("points")&&knife_quiz_options.points)return n.hasOwnProperty("points")&&n.points&&(u+=parseInt(n.points)),e.classList.add("entry-quiz__vote-choice--selected");if(n.hasOwnProperty("binary")&&n.binary)return u+=1,e.classList.add("entry-quiz__vote-choice--correct");for(var i=0;i<o.length;i++)o[i].hasOwnProperty("binary")&&o[i].binary&&r.children[i].classList.add("entry-quiz__vote-choice--missed");return e.classList.add("entry-quiz__vote-choice--wrong")}});for(var t=0;t<o.length;t++){var e=document.createElement("div");e.classList.add("entry-quiz__vote-choice"),e.setAttribute("data-answer",t),e.innerHTML=o[t].choice,r.appendChild(e)}}(t,n)}(a=document.createElement("button")).classList.add("entry-quiz__button","button"),a.setAttribute("type","button"),knife_quiz_options.hasOwnProperty("button_start")&&(a.textContent=knife_quiz_options.button_start),s.appendChild(a),"object"!=typeof knife_quiz_items&&(knife_quiz_items=[]),knife_quiz_options.hasOwnProperty("random")&&knife_quiz_options.random&&knife_quiz_items.sort(function(){return.5-Math.random()}),"object"!=typeof knife_quiz_results&&(knife_quiz_results=[]),a.addEventListener("click",function(){s.parentNode.scrollIntoView({block:"start",behavior:"smooth"});var t=knife_quiz_items.length;if(0<t&&e<t)return function(t,e,n){var i=s.querySelector(".entry-quiz__content");i&&t.hasOwnProperty("question")&&(i.innerHTML=t.question);var o=s.querySelector(".entry-quiz__info");o&&0<e&&(o.textContent=e+" / "+n);var r=s.querySelector(".entry-quiz__vote");r&&r.parentNode&&r.parentNode.removeChild(r),"object"==typeof t.answers&&0<t.answers.length&&_(t.answers,i.nextSibling),!1===s.classList.contains("entry-quiz--item")&&(s.classList.add("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_next")&&(a.textContent=knife_quiz_options.button_next))}(knife_quiz_items[e],++e,t);console.log(u)})}();
...
!function(){var _=document.getElementById("generator");if(null===_||"undefined"==typeof knife_generator_options)return;if("undefined"==typeof knife_generator_items||knife_generator_items.length<1)return;var i=null;!function(){var e=document.createElement("div");e.classList.add("entry-generator__loader"),_.insertBefore(e,_.firstChild);var t=document.createElement("span");t.classList.add("entry-generator__loader-bounce"),e.appendChild(t)}(),void 0!==knife_generator_options.page_background&&(_.style.backgroundColor=knife_generator_options.page_background),void 0!==knife_generator_options.page_color&&(_.style.color=knife_generator_options.page_color),function(){if(void 0===knife_generator_options.button_text)return;var e=document.createElement("div");e.classList.add("entry-generator__button"),_.appendChild(e),(i=document.createElement("button")).classList.add("button"),i.setAttribute("type","button"),i.textContent=knife_generator_options.button_text,e.appendChild(i),void 0!==knife_generator_options.button_background&&(i.style.backgroundColor=knife_generator_options.button_background),void 0!==knife_generator_options.button_color&&(i.style.color=knife_generator_options.button_color)}(),i.addEventListener("click",function(e){e.preventDefault();var t,n=Math.floor(Math.random()*knife_generator_items.length),r=knife_generator_items[n];if(void 0===r.poster)return!1;if(void 0===r.caption)return!1;(void 0!==knife_generator_options.button_repeat&&(i.textContent=knife_generator_options.button_repeat),_.querySelector(".entry-generator__share")&&function(e,t){if(void 0===knife_generator_options.share_links)return;if(void 0===knife_generator_options.permalink)return;for(var n,r=_.querySelectorAll(".share > .share__link"),o=[knife_generator_options.permalink.replace(/\/?$/,"/")+t+"/",e],i=0;n=r[i];i++){var a=n.getAttribute("data-label");if(void 0!==knife_generator_options.share_links[a]){var s=knife_generator_options.share_links[a];n.href=s.link.replace(/%([\d])\$s/g,function(e,t){return encodeURIComponent(o[t-1])})}}"function"===window.shareButtons&&window.shareButtons()}(r.caption,n+1),null===(t=_.querySelector(".entry-generator__content")))&&((t=document.createElement("div")).classList.add("entry-generator__content"),_.insertBefore(t,_.lastChild));t.innerHTML=void 0===r.description?"":r.description;var o=_.querySelector(".entry-generator__poster");null!==o&&o.parentNode.removeChild(o),(o=new Image).classList.add("entry-generator__poster"),_.insertBefore(o,_.firstChild),o.addEventListener("load",function(){setTimeout(function(){_.classList.remove("entry-generator--loader")},600)}),o.setAttribute("alt",r.caption),o.setAttribute("src",r.poster),_.classList.add("entry-generator--loader","entry-generator--results")})}();
