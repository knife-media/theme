...
!function(){var e=document.querySelector(".entry-content");if(null===e)return;var t=document.querySelector(".entry-widgets");if(null===t||null===t.firstElementChild)return;for(var r=Math.floor(e.children.length/3),n=0;n<t.children.length;n++){var i=t.children[n];if(i.classList.contains("widget-banner")){var l=i.querySelector(".widget-banner__link");if(l.getAttribute("data-title")){var a=document.createElement("h4");a.classList.add("widget-banner__title"),a.textContent=l.getAttribute("data-title"),i.insertBefore(a,i.firstChild)}}}if(8<e.children.length){var d=["p","blockquote"];for(n=r;n<e.children.length;n++){var c=e.children[n];if(!(d.indexOf(c.tagName.toLowerCase())<0)&&void 0!==e.children[n-1]){var o=e.children[n-1];if(!(d.indexOf(o.tagName.toLowerCase())<0)){var s=document.createElement("figure");s.classList.add("figure","figure--widget"),s.appendChild(t.firstElementChild),e.insertBefore(s,c);break}}}}0<t.children.length?t.classList.add("entry-widgets--expand"):t.parentNode.removeChild(t)}();
