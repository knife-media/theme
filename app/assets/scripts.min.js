...
!function(){var e=document.querySelector(".slider");if("undefined"==typeof Swiper)return!1;if(null===e||"undefined"==typeof knife_story_options)return!1;var t=function(e){if("undefined"==typeof knife_story_options.background)return!1;var t=document.createElement("div");if(t.classList.add("slider__background"),t.style.backgroundImage="url("+knife_story_options.background+")",t.setAttribute("data-swiper-parallax","-5%"),t.setAttribute("data-swiper-parallax-duration","1000"),t.style.width="110%",e.appendChild(t),"undefined"==typeof knife_story_options.shadow)return!1;var n=parseInt(knife_story_options.shadow)/100;if(n<=0||n>1)return!1;var i=document.createElement("div");i.classList.add("slider__shadow"),i.style.backgroundColor="rgba(0, 0, 0, "+n+")",t.appendChild(i)},n=function(){var t=document.createElement("div");t.classList.add("swiper-button-next"),e.appendChild(t);var n=document.createElement("div");return n.classList.add("swiper-button-prev"),e.appendChild(n),{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}},i=function(){var t=document.createElement("div");return t.classList.add("swiper-pagination"),e.appendChild(t),{el:".swiper-pagination",type:"bullets"}};e.style.opacity=1,t(e);for(var r=new Swiper(".swiper-container",{effect:"slide",speed:600,parallax:!0,hashNavigation:{watchState:!0},pagination:i(),navigation:n(),keyboard:!0,on:{init:function(){console.log("swiper initialized")},touchStart:function(){document.querySelector(".swiper-button-next").style.opacity=0},touchEnd:function(){document.querySelector(".swiper-button-next").style.opacity=1}}}),a=0;a<knife_story_stories.length;a++){console.log(1);var o=document.createElement("div");o.classList.add("swiper-slide"),o.innerHTML='<div class="slider__item block">'+knife_story_stories[a]+"</div>",o.setAttribute("data-hash","slider-"+a),r.appendSlide(o)}}();