!function(){if("undefined"==typeof knife_backdrop)return;var e=document.createElement("div");if(e.classList.add("backdrop"),void 0!==knife_backdrop.color&&(document.querySelector(".block-bottom").style.backgroundColor="#"+knife_backdrop.color),void 0===knife_backdrop.image)return document.body.appendChild(e);e.style.backgroundImage="url("+knife_backdrop.image+")",void 0!==knife_backdrop.size&&(e.style.backgroundSize=knife_backdrop.size);var o=new Image;o.onload=function(){document.body.appendChild(e)},o.src=knife_backdrop.image}();
...
!function(){var _=document.getElementById("generator");if(null===_||"undefined"==typeof knife_generator_options)return;if("undefined"==typeof knife_generator_items||knife_generator_items.length<1)return;var s=knife_generator_items,l=null,c=!1;void 0!==knife_generator_options.page_background&&(_.style.backgroundColor=knife_generator_options.page_background),void 0!==knife_generator_options.page_color&&(_.style.color=knife_generator_options.page_color),function(){if(void 0===knife_generator_options.button_text)return;var e=document.createElement("div");e.classList.add("entry-generator__button"),_.appendChild(e),(l=document.createElement("button")).classList.add("button"),l.setAttribute("type","button"),l.textContent=knife_generator_options.button_text,e.appendChild(l),void 0!==knife_generator_options.button_background&&(l.style.backgroundColor=knife_generator_options.button_background),void 0!==knife_generator_options.button_color&&(l.style.color=knife_generator_options.button_color)}(),l.addEventListener("click",function(e){e.preventDefault();var t=Math.floor(Math.random()*s.length),o=s[t];if(!1===c){_.querySelector(".entry-generator__share").style.display="flex";var r=_.querySelector(".entry-generator__title");r.parentNode.removeChild(r),void 0!==knife_generator_options.button_repeat&&(l.textContent=knife_generator_options.button_repeat),c=!0}if(void 0!==o.description&&(_.querySelector(".entry-generator__content").innerHTML=o.description),void 0!==o.poster){var n=_.querySelector(".entry-generator__poster");null===n&&((n=new Image).classList.add("entry-generator__poster"),_.insertBefore(n,_.firstChild)),n.setAttribute("src",o.poster),void 0!==o.caption&&n.setAttribute("alt",o.caption)}t+=1;var a=knife_generator_options.url+t+"/",i={vkontakte:"https://vk.com/share.php?url="+encodeURIComponent(a)+"&text="+encodeURIComponent(o.caption),facebook:"https://www.facebook.com/sharer/sharer.php?u="+encodeURIComponent(a),telegram:"https://t.me/share/url?url="+encodeURIComponent(a)+"&text="+encodeURIComponent(o.caption),twitter:"https://twitter.com/intent/tweet?text="+encodeURIComponent(o.caption)+"&url="+encodeURIComponent(a)};_.querySelector(".entry-generator__share .share__link--vkontakte").setAttribute("href",i.vkontakte),_.querySelector(".entry-generator__share .share__link--facebook").setAttribute("href",i.facebook),_.querySelector(".entry-generator__share .share__link--telegram").setAttribute("href",i.telegram),_.querySelector(".entry-generator__share .share__link--twitter").setAttribute("href",i.twitter)})}();
