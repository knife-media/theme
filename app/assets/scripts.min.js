...
!function(){var e=document.querySelector(".post");if(null===e)return;function r(e){var t=document.createElement("iframe"),n=function(e){var t=document.createElement("div");t.classList.add("embed__loader"),e.appendChild(t);var n=document.createElement("span");return n.classList.add("embed__loader-bounce"),t.appendChild(n),t}(e);return t.setAttribute("allow","autoplay"),t.setAttribute("frameborder","0"),t.setAttribute("src",e.dataset.embed),t.addEventListener("load",function(){n.parentNode.removeChild(n)}),t}e.addEventListener("click",function(e){var t=e.target||e.srcElement;if(null!==t.parentElement){var n=t.parentElement;if(element.classList.contains("embed")&&n.hasAttribute("data-embed")){for(e.preventDefault();n.firstChild;)n.removeChild(n.firstChild);n.appendChild(r(n))}}})}();
