"use strict";!function(){var e=document.querySelectorAll(".widget-adfox");if(!(e.length<1)){for(var t=0;t<e.length;t++){var a,o,n=e[t].querySelector("div");null!==n&&0!==n.dataset.length&&(a=Date.now().toString(10)+Math.random().toString(10).substr(2,5),(o=document.createElement("div")).id="adfox_"+a,e[t].replaceChild(o,n),o.addEventListener("click",i),o.addEventListener("click",s),d(n.dataset,a,e[t]))}var r=document.createElement("script");r.type="text/javascript",r.async=!0,r.crossorigin="anonymous",r.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(r)}function f(e,t){var a=e.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(a.length<=2)return t;var o=a[2].split("&");t.ownerId=a[1],t.params={};for(var n=0;n<o.length;n++){var r=o[n].split("=");1!=r.length&&"pr"!==r[0]&&(t.params[r[0]]=decodeURIComponent(r[1].replace(/\+/g," ")))}return t.params=function(e){if("undefined"==typeof knife_meta_parameters)return e;for(var t=["template","postid","special","category","tags","adult","promo","format"],a=0,o=1;a<t.length;a++,o++){var n=t[a];e["puid"+o]=knife_meta_parameters[n]||""}return e}(t.params),t}function u(e,t){return e.onStub=function(){t.classList.remove("widget-adfox--loaded")},e.onError=function(e){t.classList.remove("widget-adfox--loaded"),console.error(e)},e.onLoad=function(e){e.bundleParams;t.classList.remove("widget-adfox--loaded"),t.classList.add("widget-adfox--loaded")},e}function d(e,t,a){if(e.common)return o=e.common,n=a,(r={}).containerId="adfox_"+t,r=f(o,r=u(r,n)),window.adfoxAsyncParams=window.adfoxAsyncParams||[],window.adfoxAsyncParams.push(r),0;var o,n,r,d,s,i,c,l,m;e.mobile&&(d=e.mobile,s=a,(i={}).containerId="adfox_"+t,i=f(d,i=u(i,s)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([i,["tablet","phone"],{tabletWidth:1023,isAutoReloads:!0}])),e.desktop&&(c=e.desktop,l=a,(m={}).containerId="adfox_"+t,m=f(c,m=u(m,l)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([m,["desktop"],{tabletWidth:1023,isAutoReloads:!0}]))}function s(e){var t=e.target||e.srcElement;if(t.hasAttribute("data-close")){e.preventDefault();var a={},o=localStorage.getItem("adfox-close");for(null!==o&&(a=JSON.parse(o)),a[t.dataset.close]=(new Date).getTime()+288e5,localStorage.setItem("adfox-close",JSON.stringify(a));this.firstChild;)this.removeChild(this.lastChild)}}function i(e){var t=e.target||e.srcElement;t.hasAttribute("data-event")&&(document.createElement("img").src=t.dataset.event)}}();
