...
!function(){var e=document.querySelector(".slider");if("undefined"==typeof Swiper)return!1;if(null===e||"undefined"==typeof knife_story_options)return!1;var i=function(e){if("undefined"==typeof knife_story_options.background)return!1;var i=document.createElement("div");if(i.classList.add("slider__background"),i.style.backgroundImage="url("+knife_story_options.background+")",i.setAttribute("data-swiper-parallax","-20%"),i.style.width="140%",e.appendChild(i),"undefined"==typeof knife_story_options.shadow)return!1;var t=parseInt(knife_story_options.shadow)/100;if(t<=0||t>1)return!1;var n=document.createElement("div");n.classList.add("slider__shadow"),n.style.backgroundColor="rgba(0, 0, 0, "+t+")",i.appendChild(n)},t=document.createElement("div");t.classList.add("swiper-pagination"),e.appendChild(t),e.style.opacity=1,i(e);for(var n=new Swiper(".swiper-container",{effect:"slide",parallax:!0,hashNavigation:{watchState:!0},pagination:{el:".swiper-pagination",type:"bullets"},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},on:{init:function(){console.log("swiper initialized")}}}),r=0;r<knife_story_stories.length;r++){console.log(1);var o=document.createElement("div");o.classList.add("swiper-slide"),o.innerHTML='<div class="slider__item block">'+knife_story_stories[r]+"</div>",n.appendSlide(o)}}();