...
!function(){var n=document.querySelector(".entry-content");if("undefined"==typeof knife_similar_posts||knife_similar_posts.length<1)return;if(null===n||n.children.length<5)return;var e=function(n){for(var e,r=0;r<n.length;r++){e=Math.floor(Math.random()*r);var t=n[r];n[r]=n[e],n[e]=t}return n}(knife_similar_posts);console.log(e)}();
