...
!function(){var e=document.querySelector(".glide");if(null===e||"undefined"==typeof Glide)return!1;var n=e.querySelectorAll(".glide__slide").length;if(0===n)return!1;var t=new Glide(".glide",{gap:0,rewind:!1,dragThreshold:!1});return t.on("mount.before",function(){if("undefined"==typeof knife_story_options.background)return!1;var n=function(e){if("undefined"==typeof knife_story_options.shadow)return!1;var n=parseInt(knife_story_options.shadow)/100;if(n<=0||n>1)return!1;var t=document.createElement("div");t.classList.add("glide__shadow"),t.style.backgroundColor="rgba(0, 0, 0, "+n+")",e.appendChild(t)},t=function(e){if("undefined"==typeof knife_story_options.blur)return!1;var n=parseInt(knife_story_options.blur);return!(n<=0)&&void(e.style.filter="blur("+n+"px)")},r=new Image;return r.onload=function(){var r=document.createElement("div");return r.classList.add("glide__backdrop"),r.style.backgroundImage="url("+this.src+")",n(r),t(r),e.appendChild(r)},r.src=knife_story_options.background}),t.on("mount.before",function(){var t=document.createElement("div");t.classList.add("glide__bullets");for(var r=0;r<n;r++){var o=document.createElement("span");o.classList.add("glide__bullets-item"),t.appendChild(o)}return e.appendChild(t)}),t.on(["mount.after","run"],function(){for(var n,r=e.querySelectorAll(".glide__bullets-item"),o=0;n=r[o];o++)n.classList.remove("glide__bullets-item--active"),t.index===o&&n.classList.add("glide__bullets-item--active")}),t.on("mount.before",function(){["prev","next"].forEach(function(n,t){var r=document.createElement("div");r.classList.add("glide__control","glide__control--"+n),r.classList.add();var o=document.createElement("span");o.classList.add("icon","icon--"+n),r.appendChild(o),e.appendChild(r)}),e.querySelector(".glide__control--next").addEventListener("click",function(e){e.preventDefault(),t.go(">")}),e.querySelector(".glide__control--prev").addEventListener("click",function(e){e.preventDefault(),t.go("<")})}),t.on(["mount.after","run"],function(n){var r=e.querySelector(".glide__control--prev");r.classList.remove("glide__control--disabled"),0===t.index&&r.classList.add("glide__control--disabled")}),t.on(["mount.after","run"],function(r){var o=e.querySelector(".glide__control--next");o.classList.remove("glide__control--disabled"),t.index+1===n&&o.classList.add("glide__control--disabled")}),t.mount()}();
