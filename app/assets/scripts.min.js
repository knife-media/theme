...
"use strict";!function(){var e,d;"undefined"==typeof knife_preview_links||null!==(e=document.querySelector(".post"))&&(d=document.body,e.addEventListener("click",function(e){var n,i=e.target;function t(){var e=document.getElementById("preview");null!==e&&e.parentNode.removeChild(e),window.removeEventListener("resize",t)}function r(e){e.target===n&&t()}i.hasAttribute("data-preview")&&(e.preventDefault(),t(),n=function(e){var t=document.createElement("div");t.classList.add("preview"),t.setAttribute("id","preview"),d.appendChild(t);var n=document.createElement("div");n.classList.add("preview__content","preview__content--preload"),t.appendChild(n);var i=new Image;return i.setAttribute("src",e),i.setAttribute("alt",knife_preview_links.alt||""),i.addEventListener("load",function(){n.classList.remove("preview__content--preload")}),i.addEventListener("error",function(){n.classList.remove("preview__content--preload"),n.classList.add("preview__content--warning");var e=document.createElement("strong");e.textContent=knife_preview_links.warning||"",n.appendChild(e)}),n.appendChild(i),(i=document.createElement("a")).textContent=knife_preview_links.external||"",i.innerHTML=i.innerHTML+'<span class="icon icon--external"></span>',i.setAttribute("href",e),i.setAttribute("target","_blank"),i.setAttribute("rel","noopener"),n.appendChild(i),t}(i.getAttribute("href")),function(){var e=i.getBoundingClientRect(),t=n.getBoundingClientRect();if(n.classList.remove("preview--fullwidth"),n.style.top=e.bottom+document.documentElement.scrollTop+"px",n.style.left="auto",t.width+e.left+100<window.innerWidth)return n.style.left=e.left+"px";n.classList.add("preview--fullwidth")}(),window.addEventListener("resize",t),n.addEventListener("click",r),n.addEventListener("touchend",r))}))}();
