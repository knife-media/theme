...
"use strict";!function(){var e,t=document.getElementById("hypercomments_widget");null!==t&&"undefined"!=typeof knife_comments_id&&(window._hcwp=window._hcwp||[],window._hcwp.push({widget:"Stream",widget_id:knife_comments_id,callback:function(){t.classList.add("comments--expand")}}),(e=document.createElement("script")).type="text/javascript",e.async=!0,e.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js",document.head.appendChild(e))}();
