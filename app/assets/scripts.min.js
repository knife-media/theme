...
!function(){var e=document.getElementById("load-comments");if(null===e||"undefined"==typeof knife_comments_id)return;_hcwp=window._hcwp||[],_hcwp.push({widget:"Stream",widget_id:knife_comments_id});var t=document.createElement("div");t.classList.add("entry-footer__comments","comments"),t.id="hypercomments_widget";var n=document.querySelector(".entry-footer__inner");n.insertBefore(t,n.firstChild);var c=document.createElement("script");c.type="text/javascript",c.async=!0,c.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js";var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(c,i.nextSibling),e.addEventListener("click",function(e){e.preventDefault(),t.classList.toggle("comments--expand")})}();
