...
!function(){var e=document.querySelector(".entry-content");if("undefined"==typeof knife_similar_posts)return;if(null===e||e.children.length<10)return;for(var i=function(e){for(var i,n=0;n<e.length;n++){i=Math.floor(Math.random()*n);var r=e[n];e[n]=e[i],e[i]=r}return e}(knife_similar_posts),n=function(e,i){if(void 0===i.link||void 0===i.title)return!1;var n=document.createElement("figure");n.classList.add("similar");var r=document.createElement("div");r.classList.add("similar__item"),n.appendChild(r),function(){if(void 0===i.emoji)return;var e=document.createElement("div");e.classList.add("similar__emoji"),e.innerHTML=i.emoji,n.appendChild(e)}(),function(){if(void 0===i.head)return;var e=document.createElement("div");e.classList.add("similar__item-head"),e.innerHTML=i.head,r.appendChild(e)}();var t=document.createElement("a");t.classList.add("similar__item-link"),t.href=i.link,t.innerHTML=i.title,r.appendChild(t),e.parentNode.insertBefore(n,e.nextSibling)},r=Math.floor(e.children.length/3),t=0;t<2;t++)if(void 0!==i[t]){for(var a=r;a<e.children.length-5;a++){var d=e.children[a];if("p"===d.tagName.toLowerCase()){n(d,i[t]);break}}r=Math.floor(e.children.length/3)+a}}();
