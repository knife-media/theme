...
!function(){var c=document.getElementById("toggle-menu"),t=document.getElementById("toggle-search");if(null===c||null===t)return;c.addEventListener("click",function(e){return e.preventDefault(),document.querySelector(".search").classList.contains("search--expand")&&t.click(),document.querySelector(".header__nav").classList.toggle("header__nav--expand"),this.classList.toggle("toggle--expand")}),t.addEventListener("click",function(e){e.preventDefault();var t=document.getElementById("search-input");if(document.querySelector(".header__nav").classList.contains("header__nav--expand")&&c.click(),t.blur(),!document.querySelector(".search").classList.contains("search--expand")){var n=document.querySelector(".header").offsetTop-window.pageYOffset;0<n&&(document.querySelector(".search").style.paddingTop=n+"px"),t.focus()}return document.querySelector(".search").classList.toggle("search--expand"),document.body.classList.toggle("is-search"),this.classList.toggle("toggle--expand")}),window.addEventListener("keydown",function(e){if(27!==(e=e||window.event).keyCode)return!1;document.querySelector(".search").classList.contains("search--expand")&&t.click(),document.querySelector(".header__nav").classList.contains("header__nav--expand")&&c.click()},!0)}();
