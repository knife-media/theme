...
!function(){var l=document.getElementById("generator");if(null===l||"undefined"==typeof knife_generator_options)return;if(void 0!==knife_generator_options.page_background&&(l.style.backgroundColor=knife_generator_options.page_background),void 0!==knife_generator_options.page_color&&(l.style.color=knife_generator_options.page_color),"undefined"==typeof knife_generator_items||knife_generator_items.length<1)return;var d=null;!function(){var e=document.createElement("div");e.classList.add("entry-generator__loader"),l.insertBefore(e,l.firstChild);var t=document.createElement("span");t.classList.add("entry-generator__loader-bounce"),e.appendChild(t)}(),function(){if(void 0===knife_generator_options.button_text)return;var e=document.createElement("div");e.classList.add("entry-generator__button"),l.appendChild(e),(d=document.createElement("button")).classList.add("button"),d.setAttribute("type","button"),d.textContent=knife_generator_options.button_text,e.appendChild(d),void 0!==knife_generator_options.button_background&&(d.style.backgroundColor=knife_generator_options.button_background),void 0!==knife_generator_options.button_color&&(d.style.color=knife_generator_options.button_color)}(),d.addEventListener("click",function(e){e.preventDefault();var t,n=Math.floor(Math.random()*knife_generator_items.length),r=knife_generator_items[n];if(void 0!==knife_generator_options.button_repeat&&(d.textContent=knife_generator_options.button_repeat),l.querySelector(".entry-generator__share")){var o=r.heading||"";if("undefined"!==knife_generator_options.fulltext&&knife_generator_options.fulltext){var i=document.createElement("span");i.innerHTML=" "+r.description||"",o+=i.textContent}!function(e,t){if(void 0===knife_generator_options.share_links)return;if(void 0===knife_generator_options.permalink)return;for(var n,r=l.querySelectorAll(".share > .share__link"),o=0;n=r[o];o++){var i=n.getAttribute("data-label");"twitter"===i&&200<e.length&&(e=e.substring(0,200)+"…");var a=[knife_generator_options.permalink.replace(/\/?$/,"/")+t+"/",e];if(void 0!==knife_generator_options.share_links[i]){var s=knife_generator_options.share_links[i];n.href=s.link.replace(/%([\d])\$s/g,function(e,t){return encodeURIComponent(a[t-1])})}}"function"===window.shareButtons&&window.shareButtons()}(o,n+1)}null===(t=l.querySelector(".entry-generator__content"))&&((t=document.createElement("div")).classList.add("entry-generator__content"),l.insertBefore(t,l.lastChild));if(t.innerHTML=r.description||"",l.classList.add("entry-generator--loader"),"undefined"===knife_generator_options.blank||!knife_generator_options.blank){var a=l.querySelector(".entry-generator__poster");if(null!==a&&a.parentNode.removeChild(a),void 0!==r.poster)return(a=new Image).classList.add("entry-generator__poster"),l.insertBefore(a,l.firstChild),a.addEventListener("load",function(){setTimeout(function(){l.classList.remove("entry-generator--loader")},600)}),a.setAttribute("alt",r.heading||""),a.setAttribute("src",r.poster),l.classList.add("entry-generator--poster")}var s=l.querySelector(".entry-generator__title");return null===s&&((s=document.createElement("div")).classList.add("entry-generator__title"),l.insertBefore(s,l.firstChild)),s.innerHTML=r.heading||"",setTimeout(function(){l.classList.remove("entry-generator--loader")},600),l.classList.add("entry-generator--blank")})}();
...
!function(){var a={facebook:!1,vkontakte:!1},o=function(e,t){var n=Math.round(screen.width/2-t.width/2),a=0;screen.height>t.height&&(a=Math.round(screen.height/3-t.height/2));window.open(e,t.id,"left="+n+",top="+a+",width="+t.width+",height="+t.height+",personalbar=0,toolbar=0,scrollbars=1,resizable=1")},r=function(e){var t,n,a=document.createElement("script");return a.type="text/javascript",a.src=(t=e,n=(n=document.querySelector('link[rel="canonical"]'))&&n.href?encodeURIComponent(n.href):encodeURIComponent(window.location.href.replace(window.location.hash,"")),"vkontakte"===t?"https://vk.com/share.php?act=count&index=0&url="+n:"facebook"===t?"https://knife.support/facebook?fields=engagement&callback=FB.Share&id="+n:void 0),a.id="share-"+e,document.getElementsByTagName("head")[0].appendChild(a),!0};window.shareButtons=function(){var e=document.querySelectorAll(".share .share__link");if(null===e)return!1;for(var t=0;t<e.length;t++){var n=e[t].dataset.label;e[t].addEventListener("click",function(e){return e.preventDefault(),o(this.href,{width:600,height:400,id:this.dataset.label})}),n in a&&!1===a[n]&&(a[n]=r(n))}},window.VK={Share:{count:function(e,t){if(document.getElementById("share-vkontakte").outerHTML="",void 0!==t&&t)for(var n=document.querySelectorAll(".share .share__link--vkontakte"),a=0;a<n.length;a++){var o=document.createElement("span");o.className="share__count",o.innerHTML=t,n[a].appendChild(o)}}}},window.FB={Share:function(e){if(document.getElementById("share-facebook").outerHTML="",void 0!==e.engagement&&e.engagement.share_count)for(var t=document.querySelectorAll(".share .share__link--facebook"),n=0;n<t.length;n++){var a=document.createElement("span");a.className="share__count",a.innerHTML=e.engagement.share_count,t[n].appendChild(a)}}},window.shareButtons()}();
