...
"use strict";!function(){var e,r,o,d,l,n;"undefined"==typeof knife_preview_links||null!==(e=document.querySelector(".post"))&&(r=document.getElementById("wpadminbar"),o=document.body,d=0,l=function e(){var t=document.getElementById("preview");null!==t&&t.parentNode.removeChild(t),o.classList.remove("is-preview"),window.screen.width<1024&&window.scrollTo(0,d),window.removeEventListener("resize",e)},n=function(e){var t=function(e){var t=document.getElementById("preview");null!==t&&t.parentNode.removeChild(t),(t=document.createElement("div")).classList.add("preview"),t.setAttribute("id","preview"),o.appendChild(t);var n=document.createElement("div");n.classList.add("preview__content","preview__content--preload"),t.appendChild(n);var i=new Image;i.setAttribute("src",e),i.setAttribute("alt",knife_preview_links.alt||""),i.addEventListener("load",function(){n.classList.remove("preview__content--preload")}),i.addEventListener("error",function(){n.classList.remove("preview__content--preload"),n.classList.add("preview__content--warning");var e=document.createElement("strong");e.textContent=knife_preview_links.warning||"",n.appendChild(e),n.removeChild(i)}),n.appendChild(i);var r=document.createElement("a");return r.textContent=knife_preview_links.external||"",r.innerHTML=r.innerHTML+'<span class="icon icon--external"></span>',r.setAttribute("href",e),r.setAttribute("target","_blank"),r.setAttribute("rel","noopener"),n.appendChild(r),t}(e.getAttribute("href"));r&&window.scrollY<r.clientHeight&&(header.style.marginTop=r.clientHeight-window.scrollY+"px"),d=window.scrollY,o.classList.add("is-preview"),window.screen.width<1024&&(o.style.top=-d+"px");var n,i=document.createElement("button");i.classList.add("preview__close"),t.appendChild(i),n=t,i=e,i=(e=e.getBoundingClientRect()).bottom+document.documentElement.scrollTop,n.style.top=i+"px",n.style.left=e.left+"px";t.addEventListener("click",function(e){e.target!==t&&!e.target.classList.contains("preview__close")||l()}),window.addEventListener("resize",l)},e.querySelectorAll("a[data-preview]").forEach(function(t){t.addEventListener("click",function(e){e.preventDefault(),n(t)})}))}();
