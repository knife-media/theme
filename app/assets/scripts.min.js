...
!function(){var r=document.getElementById("load-comments");if(null===r||"undefined"==typeof knife_comments_id)return;r.addEventListener("click",function(e){e.preventDefault();var t=r.textContent;return r.innerHTML='<span class="icon icon--loop"></span>',function(n){_hcwp=window._hcwp||[];var c=document.createElement("div");c.classList.add("entry-footer__comments"),c.id="hypercomments_widget";var e=document.querySelector(".entry-footer__inner");e.insertBefore(c,e.firstChild),_hcwp.push({widget:"Stream",widget_id:knife_comments_id,callback:function(e,t){r.innerHTML=n,c.classList.add("comments")}});var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js";var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(t,i.nextSibling)}(t)})}();
