...
!function(){var r=document.getElementById("quiz");if(null===r||"undefined"==typeof knife_quiz_options)return;var a=null,e=0;function u(t,e){var n=document.createElement("div");for(n.classList.add("entry-quiz__vote"),r.insertBefore(n,e);n.firstChild;)n.removeChild(n.firstChild);if(knife_quiz_options.hasOwnProperty("shuffle")&&knife_quiz_options.shuffle&&t.sort(function(){return.5-Math.random()}),!knife_quiz_options.hasOwnProperty("attachment")||!knife_quiz_options.attachment)return function(o,s){var r=null;knife_quiz_options.hasOwnProperty("message")&&knife_quiz_options.message&&(r=document.createElement("div")).classList.add("entry-quiz__vote-message"),s.addEventListener("click",function(t){var e=t.target||t.srcElement;if(e.hasAttribute("data-answer")&&!s.classList.contains("entry-quiz__vote--complete")){var n=o[e.dataset.answer];if(s.classList.add("entry-quiz__vote--complete"),r&&n.hasOwnProperty("message")&&n.message&&(r.innerHTML=n.message,s.appendChild(r)),knife_quiz_options.hasOwnProperty("points")&&knife_quiz_options.points)return n.hasOwnProperty("points")&&n.points&&parseInt(n.points),e.classList.add("entry-quiz__vote-choice--selected");if(n.hasOwnProperty("binary")&&n.binary)return 1,e.classList.add("entry-quiz__vote-choice--correct");for(var i=0;i<o.length;i++)o[i].hasOwnProperty("binary")&&o[i].binary&&s.children[i].classList.add("entry-quiz__vote-choice--missed");return e.classList.add("entry-quiz__vote-choice--wrong")}});for(var t=0;t<o.length;t++){var e=document.createElement("div");e.classList.add("entry-quiz__vote-choice"),e.setAttribute("data-answer",t),e.innerHTML=o[t].choice,s.appendChild(e)}}(t,n)}(a=document.createElement("button")).classList.add("entry-quiz__button","button"),a.setAttribute("type","button"),knife_quiz_options.hasOwnProperty("button_start")&&(a.textContent=knife_quiz_options.button_start),r.appendChild(a),"object"!=typeof knife_quiz_items&&(knife_quiz_items=[]),knife_quiz_options.hasOwnProperty("random")&&knife_quiz_options.random&&knife_quiz_items.sort(function(){return.5-Math.random()}),a.addEventListener("click",function(){r.parentNode.scrollIntoView({block:"start",behavior:"smooth"});var t=knife_quiz_items.length;return 0<t&&e<t?function(t,e,n){var i=r.querySelector(".entry-quiz__content");i&&t.hasOwnProperty("question")&&(i.innerHTML=t.question);var o=r.querySelector(".entry-quiz__info");o&&0<e&&(o.textContent=e+" / "+n);var s=r.querySelector(".entry-quiz__vote");s&&s.parentNode&&s.parentNode.removeChild(s),"object"==typeof t.answers&&0<t.answers.length&&u(t.answers,i.nextSibling),!1===r.classList.contains("entry-quiz--item")&&(r.classList.add("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_next")&&(a.textContent=knife_quiz_options.button_next)),e===n&&knife_quiz_options.hasOwnProperty("button_last")&&(a.textContent=knife_quiz_options.button_last)}(knife_quiz_items[e],++e,t):showResults()})}();
...
!function(){var s=document.getElementById("generator");if(null===s||"undefined"==typeof knife_generator_options)return;if("undefined"==typeof knife_generator_items||knife_generator_items.length<1)return;var i=knife_generator_items.slice(0),a=null;!function(){var e=document.createElement("div");e.classList.add("entry-generator__loader"),s.insertBefore(e,s.firstChild);var t=document.createElement("span");t.classList.add("entry-generator__loader-bounce"),e.appendChild(t)}(),void 0!==knife_generator_options.page_background&&(s.style.backgroundColor=knife_generator_options.page_background),void 0!==knife_generator_options.page_color&&(s.style.color=knife_generator_options.page_color),function(){if(void 0===knife_generator_options.button_text)return;var e=document.createElement("div");e.classList.add("entry-generator__button"),s.appendChild(e),(a=document.createElement("button")).classList.add("button"),a.setAttribute("type","button"),a.textContent=knife_generator_options.button_text,e.appendChild(a),void 0!==knife_generator_options.button_background&&(a.style.backgroundColor=knife_generator_options.button_background),void 0!==knife_generator_options.button_color&&(a.style.color=knife_generator_options.button_color)}(),a.addEventListener("click",function(e){e.preventDefault();var t,n=Math.floor(Math.random()*i.length),r=i[n];if(i.splice(n,1),i.length<1&&(i=knife_generator_items.slice(0)),void 0===r.poster)return!1;if(void 0===r.caption)return!1;(void 0!==knife_generator_options.button_repeat&&(a.textContent=knife_generator_options.button_repeat),s.querySelector(".entry-generator__share")&&function(e,t){if(void 0===knife_generator_options.share_links)return;if(void 0===knife_generator_options.permalink)return;for(var n=s.querySelectorAll(".share > .share__link"),r=[knife_generator_options.permalink.replace(/\/?$/,"/")+t+"/",e],o=0;button=n[o];o++){var i=button.getAttribute("data-label");if(void 0!==knife_generator_options.share_links[i]){var a=knife_generator_options.share_links[i];button.href=a.link.replace(/%([\d])\$s/g,function(e,t){return encodeURIComponent(r[t-1])})}}"function"===window.shareButtons&&window.shareButtons()}(r.caption,n),null===(t=s.querySelector(".entry-generator__content")))&&((t=document.createElement("div")).classList.add("entry-generator__content"),s.insertBefore(t,s.lastChild));t.innerHTML=void 0===r.description?"":r.description;var o=s.querySelector(".entry-generator__poster");null!==o&&o.parentNode.removeChild(o),(o=new Image).classList.add("entry-generator__poster"),s.insertBefore(o,s.firstChild),o.addEventListener("load",function(){setTimeout(function(){s.classList.remove("entry-generator--loader")},600)}),o.setAttribute("alt",r.caption),o.setAttribute("src",r.poster),s.classList.add("entry-generator--loader","entry-generator--results")})}();
