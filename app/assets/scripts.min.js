...
!function(){var n=document.getElementById("toggle-menu"),o=document.querySelector(".header");if(null===n)return;var c=0;function r(e){for(var t=o.parentElement.firstChild;t&&t!==o;)1==t.nodeType&&(t.style.display=e),t=t.nextSibling}function s(e){if((e.target||e.srcElement)===document.body)return e.stopPropagation(),document.body.removeEventListener("click",s),n.click()}n.addEventListener("click",function(e){e.preventDefault();var t=document.body;return t.classList.contains("is-search")&&document.getElementById("toggle-search").click(),n.classList.toggle("toggle--expand"),o.querySelector(".navbar").classList.toggle("navbar--expand"),t.classList.contains("is-navbar")?(t.classList.remove("is-navbar"),t.style.top="",t.removeAttribute("onclick",""),window.scrollTo(0,c),r("")):(c=window.scrollY,t.classList.add("is-navbar"),t.style.top=-c+"px",t.setAttribute("onclick",""),t.addEventListener("click",s),r("none"))})}();
