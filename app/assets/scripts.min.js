...
!function(){var r=document.querySelector(".search"),t=document.getElementById("toggle-search");if(null===t)return;if(null===r||"undefined"==typeof knife_search_id)return t.classList.add("toggle--hidden");var c="search-gcse",s=function(){if("complete"!==document.readyState)return google.setOnLoadCallback(s,!0);google.search.cse.element.render({gname:c,div:c,tag:"searchresults-only",attributes:{enableHistory:!1,gaQueryParameter:"s",queryParameterName:"s"}}),document.getElementById("search-input").oninput=function(){google.search.cse.element.getElement(c).execute(this.value)};var e=window.MutationObserver||window.WebKitMutationObserver;new e(function(e){for(var t=0;t<e.length;++t)if(e[t].target.classList.contains("gsc-results"))return n()}).observe(document.getElementById(c),{subtree:!0,attributes:!1,childList:!0,characterData:!1})},n=function(){for(var s=document.getElementById("search-results"),e=document.getElementById(c).querySelectorAll(".gs-result");s.firstChild;)s.removeChild(s.firstChild);if(0<document.getElementById("search-input").value.length){var t=function(e){var t={link:e.querySelector("a.gs-title").href,head:e.querySelector("a.gs-title").textContent,text:e.querySelector(".gs-snippet").textContent},n=document.createElement("p");n.className="search__results-head",n.appendChild(document.createTextNode(t.head));var a=document.createElement("p");a.className="search__results-text",a.appendChild(document.createTextNode(t.text));var r=document.createElement("a");return r.className="search__results-link",r.href=t.link,r.appendChild(n),r.appendChild(a),s.appendChild(r)};if(1==e.length&&e[0].classList.contains("gs-no-results-result")){var n=document.createElement("p");n.className="search__results-head",n.appendChild(document.createTextNode(e[0].textContent)),s.appendChild(n)}for(var a=0;a<e.length;a++){if(!e[a].querySelector("a.gs-title")||!e[a].querySelector(".gs-snippet"))return!1;t(e[a])}}};t.addEventListener("click",function(e){e.preventDefault();var t=document.getElementById("search-input");if(t.blur(),document.body.classList.contains("is-navbar")&&document.getElementById("toggle-menu").click(),r.classList.toggle("search--expand"),document.body.classList.toggle("is-search"),r.classList.contains("search--expand")){var n=document.querySelector(".header").offsetTop-window.pageYOffset;void 0===window.__gcse&&function(e){var t=document.createElement("div");t.id=c,t.style.display="none",r.appendChild(t),window.__gcse={parsetags:"explicit",callback:s};var n=document.createElement("script");n.type="text/javascript",n.async=!0,n.src="https://cse.google.com/cse.js?cx="+e;var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(n,a)}(knife_search_id),0<n&&(document.querySelector(".search").style.paddingTop=n+"px"),t.focus()}return this.classList.toggle("toggle--expand")}),window.addEventListener("keydown",function(e){if(27===(e=e||window.event).keyCode&&r.classList.contains("search--expand"))return t.click()},!0)}();
!function(){var n=document.getElementById("toggle-menu"),t=document.querySelector(".navbar");if(null===n)return;n.addEventListener("click",function(e){return e.preventDefault(),document.body.classList.contains("is-search")&&document.getElementById("toggle-search").click(),t.classList.toggle("navbar--expand"),document.body.classList.toggle("is-navbar"),this.classList.toggle("toggle--expand")}),window.addEventListener("keydown",function(e){if(27===(e=e||window.event).keyCode&&t.classList.contains("navbar--expand"))return n.click()},!0)}();
...
!function(){if("undefined"==typeof knife_relap_options)return;var e=knife_relap_options;if(1<e.token.length){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://relap.io/api/v6/head.js?token="+e.token,document.head.appendChild(t)}1<e.block.length&&(widget=document.createElement("div"),widget.classList.add("entry-footer__relap"),widget.innerHTML='<script id="'+e.block+'"><\/script>',document.querySelector(".entry-footer").appendChild(widget))}();
...
!function(){var e=document.querySelector(".entry-content");if("undefined"==typeof knife_similar_posts||knife_similar_posts.length<1)return;if(null===e||e.children.length<10)return;for(var i=function(e){for(var i,n=0;n<e.length;n++){i=Math.floor(Math.random()*n);var t=e[n];e[n]=e[i],e[i]=t}return e}(knife_similar_posts),n=function(e,i){if(void 0===i.link||void 0===i.title)return!1;var n=document.createElement("figure");n.classList.add("similar");var t=document.createElement("div");t.classList.add("similar__item"),n.appendChild(t),function(){if(void 0===i.emoji)return;var e=document.createElement("div");e.classList.add("similar__emoji"),e.innerHTML=i.emoji,n.appendChild(e)}(),function(){if(void 0===i.head)return;var e=document.createElement("div");e.classList.add("similar__item-head"),e.innerHTML=i.head,t.appendChild(e)}();var r=document.createElement("a");r.classList.add("similar__item-link"),r.href=i.link,r.innerHTML=i.title,t.appendChild(r),e.parentNode.insertBefore(n,e.nextSibling)},t=Math.floor(e.children.length/3),r=0;r<2;r++){for(var a=t;a<e.children.length-5;a++){var l=e.children[a];if("p"===l.tagName.toLowerCase()){n(l,i[r]);break}}t=Math.floor(e.children.length/3)+a}}();
