...
!function(){if("undefined"==typeof knife_mistype_reporter)return;function o(e,t){return knife_mistype_reporter.hasOwnProperty(e)?knife_mistype_reporter[e]:t||""}document.addEventListener("keydown",function(e){if(event.ctrlKey&&13==event.keyCode){var t=window.getSelection().toString();0<t.length&&function(e){var t=document.createElement("div");t.classList.add("mistype");var n=document.createElement("div");n.classList.add("mistype__popup"),t.appendChild(n);var d=document.createElement("h3");d.classList.add("mistype__popup-heading"),d.textContent=o("heading"),n.appendChild(d);var p=document.createElement("p");p.classList.add("mistype__popup-marked"),p.textContent=e,n.appendChild(p);var a=document.createElement("textarea");a.classList.add("mistype__popup-comment"),a.setAttribute("placeholder",o("textarea")),n.appendChild(a);var i=document.createElement("button");i.classList.add("mistype__popup-submit","button"),i.textContent=o("button","Send"),n.appendChild(i),document.body.appendChild(t)}(t)}})}();
