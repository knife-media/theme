...
"use strict";!function(){document.getElementById("toggle-search").addEventListener("click",function(e){e.preventDefault();var t=document.getElementById("explorer");null!==t&&t.parentNode.removeChild(t),t=function(){var e=document.createElement("div");e.classList.add("explorer"),e.setAttribute("id","explorer");var t=document.createElement("button");t.classList.add("explorer__close"),e.appendChild(t);var n=window.scrollY;document.body.classList.add("is-login"),document.body.style.top=-n+"px";function o(){document.body.removeChild(e),document.removeEventListener("keydown",r),document.body.classList.remove("is-login"),document.body.style.top="",window.scrollTo(0,n)}var r=function(e){27===e.keyCode&&o()};t.addEventListener("click",o),document.addEventListener("keydown",r);var c=document.createElement("form");c.classList.add("explorer__form"),e.appendChild(c);var d=document.createElement("input");d.classList.add("explorer__form-input"),d.setAttribute("placeholder",knife_search_options.placeholder||""),c.appendChild(d),setTimeout(function(){d.focus()},100);var i=document.createElement("button");return i.classList.add("explorer__form-submit","icon","icon--right"),i.setAttribute("type","submit"),c.appendChild(i),c.addEventListener("submit",function(e){e.preventDefault(),document.location.href="/search/#gsc.q="+d.value}),document.body.appendChild(e),e}()});(function(){var e=document.querySelector(".search .gcse-search");if(null==knife_search_options||null===e)return;var t=e.getAttribute("data-placeholder");window.__gcse={callback:function(){document.querySelector("input.gsc-input").placeholder=t}};var n=document.createElement("script");n.type="text/javascript",n.async=!0,n.src="https://cse.google.com/cse.js?cx="+knife_search_options.id;var o=document.getElementsByTagName("script")[0];o.parentNode.insertBefore(n,o)})()}();
