...
!function(){var e=document.querySelector(".slider");if("undefined"==typeof Swiper)return!1;if(null===e||"undefined"==typeof knife_story_options)return!1;var t=function(e){if("undefined"==typeof knife_story_options.background)return!1;var t=document.createElement("div");if(t.classList.add("slider__background"),t.style.backgroundImage="url("+knife_story_options.background+")","undefined"!=typeof knife_story_options.blur&&parseInt(knife_story_options.blur)>0&&(t.style.filter="blur("+knife_story_options.blur+"px)"),e.appendChild(t),"undefined"==typeof knife_story_options.shadow)return t;var n=parseInt(knife_story_options.shadow)/100;if(n<=0||n>1)return t;var i=document.createElement("div");return i.classList.add("slider__shadow"),i.style.backgroundColor="rgba(0, 0, 0, "+n+")",t.appendChild(i),t},n=function(){var t=document.createElement("div");t.classList.add("swiper-button-next"),e.appendChild(t);var n=document.createElement("div");return n.classList.add("swiper-button-prev"),e.appendChild(n),{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}},i=function(){var t=document.createElement("div");return t.classList.add("swiper-pagination"),e.appendChild(t),{el:".swiper-pagination",type:"bullets"}},r=function(e,t){if("undefined"!=typeof e.entry){var n=document.createElement("div");n.classList.add("slider__item-entry","custom"),n.innerHTML=e.entry,t.appendChild(n)}},d=function(e,t){if("undefined"!=typeof e.image){var n=document.createElement("figure");n.classList.add("slider__item-media"),t.appendChild(n);var i=document.createElement("img");if(i.classList.add("slider__item-image"),i.src=e.image,n.appendChild(i),"undefined"!=typeof e.caption){var r=document.createElement("div");r.classList.add("slider__item-notice","custom"),n.appendChild(r);var d=document.createElement("figcaption");d.classList.add("slider__item-caption"),d.innerHTML=e.caption,r.appendChild(d)}}},a=function(){if("undefined"==typeof knife_story_stories||knife_story_stories.length<1)return!1;for(var e=0;e<knife_story_stories.length;e++){var t=document.createElement("div");t.classList.add("swiper-slide");var n=document.createElement("div");n.classList.add("slider__item","block"),t.appendChild(n),r(knife_story_stories[e],n),d(knife_story_stories[e],n),l.appendSlide(t)}},s=function(n){var i=t(e);if("undefined"==typeof knife_story_options.effect||!i)return n;switch(knife_story_options.effect){case"parallax":i.style.width="calc(100% + 210px)",i.setAttribute("data-swiper-parallax-x",-200),i.setAttribute("data-swiper-parallax-duration",700)}return n},o=function(){var e={};return e.keyboard=!0,e.speed=400,e.pagination=i(),e.navigation=n(),e.resistanceRatio=999,e.simulateTouch=window.innerWidth<768,s(e)},l=new Swiper(".slider",o());return a()}();
!function(){if("undefined"==typeof knife_user_form)return!1;var e,n,t,r,o=function(e,n,t){if("undefined"==typeof n.element)return null;var r=document.createElement(n.element);r.classList.add("form__field-"+n.element),r.setAttribute("name",e);var o=document.createElement("div");o.classList.add("form__field"),o.appendChild(r),delete n.element;for(var a in n)r.setAttribute(a,n[a]);return r.addEventListener("input",function(e){console.log(this.value)}),t.appendChild(o)},a=function(e){var o=document.createElement("div");return o.classList.add("form__control"),r=document.createElement("button"),r.classList.add("form__control-button","button"),r.innerHTML=u("button","Send"),o.appendChild(r),t=document.createElement("span"),t.classList.add("form__control-loader","icon"),o.appendChild(t),n=document.createElement("span"),n.classList.add("form__control-notice"),o.appendChild(n),e.appendChild(o)},i=function(e){return t.classList.remove("icon--loop"),"undefined"==typeof e||e===!0?r.removeAttribute("disabled",""):(t.classList.remove("icon--alert","icon--done"),t.classList.add("icon--loop"),n.innerHTML="",r.setAttribute("disabled",""))},d=function(e){var e=e||u("warning","Request error");t.classList.add("icon--alert"),n.innerHTML=e},s=function(r){var r=r||"All done";t.classList.add("icon--done"),n.innerHTML=r,e.reset()},c=function(n){n.preventDefault();var t=new FormData(e),r="action="+u("action")+"&nonce="+u("nonce");t.forEach(function(e,n){r+="&"+n+"="+e});var o=new XMLHttpRequest;return o.open("POST",u("ajaxurl")),o.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8"),o.onload=function(){if(i(!0),200!==o.status)return d();var e=JSON.parse(o.responseText);return e.success?s(e.data):d(e.data)},o.send(r),i(!1)},u=function(e,n){return knife_user_form.hasOwnProperty(e)?knife_user_form[e]:n||""},l=function(e){var n=knife_user_form.fields;for(var t in n)n.hasOwnProperty(t)&&o(t,n[t],e);return a(e)},f=document.querySelector(".post"),e=document.createElement("form");return e.classList.add("post__form","form"),e.addEventListener("submit",c),f.appendChild(e),l(e)}();