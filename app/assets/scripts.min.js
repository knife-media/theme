...
"use strict";function _slicedToArray(e,t){return _arrayWithHoles(e)||_iterableToArrayLimit(e,t)||_unsupportedIterableToArray(e,t)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);return"Object"===n&&e.constructor&&(n=e.constructor.name),"Map"===n||"Set"===n?Array.from(e):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,o=new Array(t);n<t;n++)o[n]=e[n];return o}function _iterableToArrayLimit(e,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e)){var n=[],o=!0,r=!1,a=void 0;try{for(var i,s=e[Symbol.iterator]();!(o=(i=s.next()).done)&&(n.push(i.value),!t||n.length!==t);o=!0);}catch(e){r=!0,a=e}finally{try{o||null==s.return||s.return()}finally{if(r)throw a}}return n}}function _arrayWithHoles(e){if(Array.isArray(e))return e}!function(){var v=document.getElementById("comments");if(null!==v&&void 0!==knife_id_handler){var f=function(e,t){var n=e.split(".");if(1<n.length){var o=_slicedToArray(n,2),r=o[0],a=o[1];if(void 0!==knife_id_handler[r][a])return knife_id_handler[r][a]}return void 0!==knife_id_handler[e]?knife_id_handler[e]:t||""},t=["vkontakte","google","facebook","yandex"],a=f("post",null);if(null!==a){var _=!1,h=function(e,t){var n=document.createElement(e);if(t.hasOwnProperty("class")&&n.classList.add(t.class),t.hasOwnProperty("classes")&&t.classes.forEach(function(e){n.classList.add(e)}),t.hasOwnProperty("text")&&(n.textContent=t.text),t.hasOwnProperty("html")&&(n.innerHTML=t.html),t.hasOwnProperty("attributes"))for(var o in t.attributes)n.setAttribute(o,t.attributes[o]);return t.hasOwnProperty("parent")&&t.parent.appendChild(n),n},i=function(e){var t,n=e+window.pageYOffset-24,o=document.querySelector(".header");if(null!==o&&(t=window.getComputedStyle(o),n-=parseInt(t.getPropertyValue("height"))),"scrollBehavior"in document.documentElement.style)return window.scrollTo({top:n,behavior:"smooth"});window.scrollTo(0,n)},y=function(e,t){var n=JSON.parse(localStorage.getItem("knife_id_unsent"))||{};n[a]={text:e,reply:t},localStorage.setItem("knife_id_unsent",JSON.stringify(n))},b=function(e){var t=(JSON.parse(localStorage.getItem("knife_id_unsent"))||{})[a]||{};return t.reply===e&&t.text||""},g=function(e,t){var n=new Image;e.appendChild(n);var o=f("comments.noavatar");n.onerror=function(){n.setAttribute("src",o)},n.onload=function(){n.removeAttribute("loading")},n.setAttribute("loading",!0),n.setAttribute("src",t.avatar),n.setAttribute("alt",t.name)},L=function(t,e){var n,o,r,a=h("a",{class:"comments__item-time",text:(n=e.created,o=new Date(n),r={hour:"numeric",minute:"numeric",month:"numeric",day:"numeric"},o.getFullYear()<(new Date).getFullYear()&&(r.year="numeric"),o.toLocaleString("ru",r)),attributes:{href:"#comment-".concat(e.id)},parent:t});a.addEventListener("click",function(e){e.preventDefault(),history.pushState({},"",a.href),v.classList.remove("comments--folded"),i(t.getBoundingClientRect().top)})},S=function(e,t){var n=h("div",{class:"comments__item-warning",parent:e});return"removed"===t&&(n.textContent=f("comments.removed")),e},s=function(e,t){if(e.setAttribute("data-id",t.id),"visible"!==t.status)return S(e,t.status);t.name=t.name||f("comments.anonymous"),t.content=t.content.replace(/(\n)+/g,"<br>"),e.setAttribute("data-name",t.name);var n=h("div",{class:"comments__item-avatar",parent:e});g(n,t);var o=h("div",{class:"comments__item-header",parent:e});L(e,t),h("span",{class:"comments__item-name",text:t.name,parent:o}),h("span",{class:"comments__item-content",html:t.content,parent:e});var r,a,i,s,c,l,m,d,u,p=h("div",{class:"comments__item-footer",parent:e});return r=p,a=t,i=e,h("button",{class:"comments__item-button",text:f("comments.reply"),parent:r}).addEventListener("click",function(e){if(e.preventDefault(),!_)return k();v.classList.remove("comments--folded"),v.querySelectorAll(".comments__item-form").forEach(function(e){e.parentNode.removeChild(e)});var t=C();t.classList.add("comments__item-form"),t.setAttribute("data-reply",a.id),i.insertBefore(t,r.nextSibling),h("button",{class:"comments__item-cancel",text:f("form.cancel"),parent:t.querySelector(".comments__form-footer")}).addEventListener("click",function(e){return e.preventDefault(),t.parentNode.removeChild(t)});var n=t.querySelector(".comments__form-text");n.setAttribute("placeholder",f("form.reply")),n.value=b(a.id),n.focus(),n.addEventListener("input",function(){y(n.value,a.id)})}),function t(n,o){var e=parseInt(o.plus)-parseInt(o.minus);n.className="comments__item-vote",o.self&&n.classList.add("comments__item-vote--voted"),0<e&&n.classList.add("comments__item-vote--plus"),e<0&&n.classList.add("comments__item-vote--minus");var r=h("button",{classes:["icon","icon--vote"],parent:n});"plus"===o.vote&&(r.classList.remove("icon--vote"),r.classList.add("icon--voted"),n.classList.add("comments__item-vote--voted")),h("span",{text:e,attributes:{title:"+".concat(o.plus," / -").concat(o.minus)},parent:n});var a=h("button",{classes:["icon","icon--vote"],parent:n});"minus"===o.vote&&(a.classList.remove("icon--vote"),a.classList.add("icon--voted"),n.classList.add("comments__item-vote--voted")),r.addEventListener("click",function(e){if(e.preventDefault(),!_)return k();for(r.classList.contains("icon--voted")&&(o.plus=parseInt(o.plus)-1,delete o.vote,E("/id/ratings?comment=".concat(o.id,"&vote=plus"),"DELETE")),r.classList.contains("icon--vote")&&(o.plus=parseInt(o.plus)+1,o.vote="plus",E("/id/ratings?comment=".concat(o.id,"&vote=plus"),"POST"));n.lastChild;)n.removeChild(n.lastChild);t(n,o)}),a.addEventListener("click",function(e){if(e.preventDefault(),!_)return k();for(a.classList.contains("icon--voted")&&(o.minus=parseInt(o.minus)-1,delete o.vote,E("/id/ratings?comment=".concat(o.id,"&vote=minus"),"DELETE")),a.classList.contains("icon--vote")&&(o.minus=parseInt(o.minus)+1,o.vote="minus",E("/id/ratings?comment=".concat(o.id,"&vote=minus"),"POST"));n.lastChild;)n.removeChild(n.lastChild);t(n,o)})}(h("div",{class:"comments__item-vote",parent:p}),t),f("action")?(s=p,c=t,l=e,h("button",{class:"comments__item-button",text:f("comments.remove"),parent:s}).addEventListener("click",function(e){e.preventDefault(),x({remove:c.id},function(){for(var e=l.querySelector(".comments__item-children");l.lastChild;)l.removeChild(l.lastChild);S(l,"removed"),null!==e&&l.appendChild(e)})}),h("button",{class:"comments__item-button",text:f("comments.block"),parent:s}).addEventListener("click",function(e){e.preventDefault()}),l):(t.self&&(m=p,d=t,u=e,h("button",{class:"comments__item-button",text:f("comments.remove"),parent:m}).addEventListener("click",function(e){e.preventDefault();var t="/id/comments/".concat(d.id);E(t,"DELETE",{},function(){for(var e=u.querySelector(".comments__item-children");u.lastChild;)u.removeChild(u.lastChild);S(u,"removed"),null!==e&&u.appendChild(e)})})),e)},c=function(e){var t=h("div",{class:"comments__item"}),t=s(t,e);if(null===e.parent)return v.appendChild(t);var n=v.querySelector('[data-id="'.concat(e.parent,'"]'));if(null===n)return v.appendChild(t);var o=n.querySelector(".comments__item-children");null===o&&(o=h("div",{class:"comments__item-children",parent:n})),"visible"===e.status&&(t=function(t,e,n){if(!t.hasAttribute("data-name"))return n;var o=h("a",{class:"comments__item-replied",html:'<span class="icon icon--reply"></span>',attributes:{href:"#comment-".concat(e.parent)},parent:n.querySelector(".comments__item-header")});return h("span",{text:t.getAttribute("data-name"),parent:o}),o.addEventListener("click",function(e){e.preventDefault(),history.pushState({},"",o.href),v.classList.remove("comments--folded"),i(t.getBoundingClientRect().top)}),n}(n,e,t));var r=n.getAttribute("data-level")||0,r=parseInt(r)+1;return t.setAttribute("data-level",r),2<r&&o.classList.add("comments__item-children--deepest"),o.appendChild(t)},l=function(o){var e="/id/comments?post=".concat(a),r=o.getAttribute("data-reply");r&&(e+="&parent=".concat(r));var t=o.querySelector("textarea");E(e,"POST",{content:t.value},function(e){var t,n;return 0<e.comments.length&&(o.reset(),r&&o.parentNode.removeChild(o),t=c(e.comments[0]),v.classList.remove("comments--folded"),i(t.getBoundingClientRect().top)),delete(n=JSON.parse(localStorage.getItem("knife_id_unsent"))||{})[a],void localStorage.setItem("knife_id_unsent",JSON.stringify(n))})},C=function(){var t=h("form",{class:"comments__form"}),e=h("textarea",{class:"comments__form-text",attributes:{placeholder:f("form.placeholder")},parent:t}),n=f("form.authorize");_&&(n=f("form.submit"),e.setAttribute("required","required"));var o=h("div",{class:"comments__form-footer",parent:t}),r=h("button",{classes:["comments__form-submit","button"],attributes:{type:"submit"},text:n,parent:o});t.addEventListener("submit",function(e){return e.preventDefault(),_?void l(t):k()});function a(){window.setTimeout(function(){e.style.height="auto",e.style.height="".concat(e.scrollHeight+2,"px")},0)}return e.addEventListener("keydown",function(e){13==e.keyCode&&(e.metaKey||e.ctrlKey)&&r.click(),a()}),e.addEventListener("paste",a),t},x=function(e){var t=new FormData;t.append("action",f("action")),t.append("nonce",f("nonce")),t.append("fields",e);var n=new XMLHttpRequest;n.open("POST",f("ajaxurl")),n.send(t),n.onload=function(){var e=v.querySelector(".comments__error");null!==e&&v.removeChild(e);var t=JSON.parse(n.responseText);console.log(t)}},E=function(e,t,n,o){var r=new XMLHttpRequest;r.open(t,e,!0),r.setRequestHeader("Content-Type","application/json"),r.onload=function(){var e=v.querySelector(".comments__error");null!==e&&v.removeChild(e);var t=JSON.parse(r.responseText);return 200!==r.status?function(e){if(e=e||f("error"),!v.classList.contains("comments--expand"))return console.error(e);var t=v.querySelector(".comments__form");if(null===t)return console.error(e);var n=v.querySelector(".comments__error");null===n&&(n=h("p",{class:"comments__error"})),n.textContent=e,t.parentNode.insertBefore(n,t.nextSibling),i(t.getBoundingClientRect().top)}(t.message):"function"==typeof o?o(t.result||{}):void 0},void 0===n&&(n={}),r.send(JSON.stringify(n))},k=function(){var n=h("div",{class:"login"}),o=h("div",{class:"login__popup",parent:n});h("h3",{class:"login__popup-heading",text:f("login.heading"),parent:o}),h("p",{class:"login__popup-helper",text:f("login.helper"),parent:o}),t.forEach(function(e){var t=h("a",{classes:["login__popup-button","login__popup-button--".concat(e)],text:f("login.".concat(e)),attributes:{href:"/id/profiles/".concat(e),target:"_blank"},parent:o});h("span",{classes:["icon","icon--".concat(e)],parent:t})}),h("p",{class:"login__popup-policy",html:f("login.policy"),parent:o}),h("button",{class:"login__popup-close",parent:o}).addEventListener("click",function(){document.body.removeChild(n),document.removeEventListener("keydown",e)});var e=function e(t){27===t.keyCode&&(document.removeEventListener("keydown",e),document.body.removeChild(n))};document.addEventListener("keydown",e);window.addEventListener("message",function e(t){if("reload"===t.data)return window.removeEventListener("message",e),document.body.removeChild(n),m()}),document.body.appendChild(n)},m=function(){for(;v.lastChild;)v.removeChild(v.lastChild);_=!1,E("/id/comments?post=".concat(a),"GET",{},function(e){var t=e.comments||[];e.identity&&(_=!0);var n=C();v.appendChild(n);var o=n.querySelector(".comments__form-text");o.textContent=b(0),o.addEventListener("input",function(){y(o.value,0)}),function(e,t){if(void 0===t)return;var n=h("div",{class:"comments__form-badge",parent:e.querySelector(".comments__form-footer")});g(n,t),h("span",{text:t.name,parent:n}),h("button",{classes:["comments__form-exit","icon","icon--exit"],attributes:{type:"button",title:f("form.exit")},parent:e}).addEventListener("click",function(e){e.preventDefault(),v.classList.remove("comments--expand"),E("/id/logout","POST",{},function(){setTimeout(m,300)})})}(n,e.identity),10<t.length&&function(){v.classList.add("comments--folded");var e=h("div",{class:"comments__expand",parent:v});h("button",{class:"comments__expand-button",text:f("comments.expand"),attrubutes:{type:"button"},parent:e}).addEventListener("click",function(e){e.preventDefault(),v.classList.remove("comments--folded")})}(),t.forEach(function(e){void 0!==e.id&&c(e)}),v.classList.add("comments--expand");var r,a=document.location.hash.match(/^#comment-(\d+)/)||[];1<a.length&&(null!==(r=v.querySelector('[data-id="'.concat(a[1],'"]')))&&(v.classList.remove("comments--folded"),i(r.getBoundingClientRect().top)))})};m()}}}();
"use strict";!function(){function r(e,t){return knife_mistype_reporter.hasOwnProperty(e)?knife_mistype_reporter[e]:t||""}function n(t){var n=document.querySelector(".mistype");null!==n&&n.parentNode.removeChild(n),(n=document.createElement("div")).classList.add("mistype"),document.body.appendChild(n);var e=document.createElement("div");e.classList.add("mistype__popup"),n.appendChild(e);var d=document.createElement("h3");d.classList.add("mistype__popup-heading"),d.textContent=r("heading"),e.appendChild(d);var a=document.createElement("p");a.classList.add("mistype__popup-marked"),a.textContent=t,e.appendChild(a);var o=document.createElement("textarea");o.classList.add("mistype__popup-comment"),o.setAttribute("placeholder",r("textarea")),o.setAttribute("maxlength",300),e.appendChild(o);var p=document.createElement("button");p.classList.add("mistype__popup-submit","button"),p.textContent=r("button","Send"),e.appendChild(p),p.addEventListener("click",function(e){e.preventDefault(),function(e,t){var n=new FormData;n.append("action",r("action")),n.append("nonce",r("nonce")),n.append("comment",t),n.append("marked",e),n.append("location",document.location.href);var d=new XMLHttpRequest;d.open("POST",r("ajaxurl")),d.send(n)}(t,o.value),n.parentNode.removeChild(n)});var i=document.createElement("button");i.classList.add("mistype__popup-close"),i.addEventListener("click",function(){n.parentNode.removeChild(n)}),e.appendChild(i);document.addEventListener("keydown",function e(t){27===t.keyCode&&n.parentNode.removeChild(n),document.removeEventListener("keydown",e)})}"undefined"!=typeof knife_mistype_reporter&&document.addEventListener("keydown",function(e){var t;!e.ctrlKey||13!=e.keyCode||0<(t=window.getSelection().toString()).length&&n(t.substring(0,300))})}();
