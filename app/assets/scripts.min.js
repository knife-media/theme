...
!function(){var i=document.getElementById("load-comments");if(null===i||"undefined"==typeof knife_comments_id)return;var c=null;i.addEventListener("click",function(e){if(e.preventDefault(),null!==c)return c.classList.toggle("comments");var t=i.textContent;return i.innerHTML='<span class="icon icon--loop"></span>',function(e){_hcwp=window._hcwp||[],_hcwp.push({widget:"Stream",widget_id:knife_comments_id,callback:e}),(c=document.createElement("div")).classList.add("entry-footer__comments"),c.id="hypercomments_widget";var t=i.nextElementSibling;null!==t&&t.insertBefore(c,t.firstChild);var n=document.createElement("script");n.type="text/javascript",n.async=!0,n.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js",document.head.appendChild(n)}(function(){i.innerHTML=t,c.classList.add("comments")})})}();
...
!function(){var n=document.getElementById("toggle-menu"),t=document.querySelector(".header__nav");if(null===n)return;n.addEventListener("click",function(e){return e.preventDefault(),document.body.classList.contains("is-search")&&document.getElementById("toggle-search").click(),t.classList.toggle("header__nav--expand"),document.body.classList.toggle("is-navbar"),this.classList.toggle("toggle--expand")}),window.addEventListener("keydown",function(e){if(27===(e=e||window.event).keyCode&&t.classList.contains("header__nav--expand"))return n.click()},!0)}();
