...
!function(){if("undefined"==typeof knife_push.appid)return!1;OneSignal=window.OneSignal||[];var e=function(){var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="https://cdn.onesignal.com/sdks/OneSignalSDK.js";var n=document.getElementsByTagName("script")[0];n.parentNode.insertBefore(e,n)},n=function(){var e=localStorage.getItem("knife-push");return"undefined"!=typeof Notification&&"default"===Notification.permission&&("string"==typeof e&&Number(e)<Date.now()||(null===e&&localStorage.setItem("knife-push",Date.now()),!1))},t=function(){var e=document.createElement("div");return e.classList.add("push","push--hide"),document.body.appendChild(e),function(){var n=document.createElement("button");n.classList.add("push__close"),n.setAttribute("data-action","Push Notifications — Decline"),e.appendChild(n)}(),function(){var n=document.createElement("div");n.classList.add("push__promo"),"undefined"!=typeof knife_push.promo&&(n.innerHTML=knife_push.promo),e.appendChild(n)}(),function(){var n=document.createElement("button");n.classList.add("push__button"),e.appendChild(n),"undefined"!=typeof knife_push.button&&(n.innerHTML=knife_push.button);var t=document.createElement("span");t.classList.add("icon","icon--notify"),n.appendChild(t)}(),e};document.addEventListener("DOMContentLoaded",function(){if(n()===!1)return!1;var i=t();return OneSignal.push(["init",{appId:knife_push.appid,autoRegister:!1,welcomeNotification:{disable:!0}}]),OneSignal.push(function(){if(i.querySelector(".push__close").addEventListener("click",function(){var e=12096e5;return localStorage.setItem("knife-push",Date.now()+e),i.classList.add("push--hide")}),i.querySelector(".push__button").addEventListener("click",function(){return OneSignal.registerForPushNotifications()}),OneSignal.on("notificationPermissionChange",function(e){return i.classList.add("push--hide")}),OneSignal.isPushNotificationsSupported())return i.classList.remove("push--hide")}),e()},!1)}();
!function(){if(null===document.querySelector(".share"))return!1;var e={facebook:!1,vkontakte:!1},t=function(e){var t=document.querySelector('link[rel="canonical"]');return t=t&&t.href?encodeURIComponent(t.href):encodeURIComponent(window.location.href.replace(window.location.hash,"")),"vkontakte"===e?"https://vk.com/share.php?act=count&index=0&url="+t:"facebook"===e?"https://graph.facebook.com/?callback=FB.Share&id="+t:void 0},n=function(e,t){var n=Math.round(screen.width/2-t.width/2),r=0;screen.height>t.height&&(r=Math.round(screen.height/3-t.height/2));window.open(e,t.id,"left="+n+",top="+r+",width="+t.width+",height="+t.height+",personalbar=0,toolbar=0,scrollbars=1,resizable=1")},r=function(e){var n=document.createElement("script");return n.type="text/javascript",n.src=t(e),n.id="share-"+e,document.getElementsByTagName("head")[0].appendChild(n),!0},a=document.querySelectorAll(".share .share__link");if(null===a)return!1;for(var o=0;o<a.length;o++){var h=a[o].dataset.label;a[o].addEventListener("click",function(e){return e.preventDefault(),n(this.href,{width:600,height:400,id:this.dataset.label})}),h in e&&e[h]===!1&&(e[h]=r(h))}window.VK={Share:{count:function(e,t){if(document.getElementById("share-vkontakte").outerHTML="","undefined"!=typeof t&&t)for(var n=document.querySelectorAll(".share .share__link--vkontakte"),r=0;r<n.length;r++){var a=document.createElement("span");a.className="share__count",a.innerHTML=t,n[r].appendChild(a)}}}},window.FB={Share:function(e){if(document.getElementById("share-facebook").outerHTML="","undefined"!=typeof e.share&&e.share.share_count)for(var t=document.querySelectorAll(".share .share__link--facebook"),n=0;n<t.length;n++){var r=document.createElement("span");r.className="share__count",r.innerHTML=e.share.share_count,t[n].appendChild(r)}}}}();
!function(){var e=document.querySelector(".glide");if(null===e||"undefined"==typeof Glide)return!1;if(0===e.querySelectorAll(".glide__slide").length)return!1;var t=new Glide(".glide",{gap:0,rewind:!1,touchAngle:45,dragThreshold:!1,breakpoints:{767:{dragThreshold:!0}}});return t.on("mount.before",function(){if("undefined"==typeof knife_story_stories||knife_story_stories.length<1)return!1;for(var t,n=0;t=knife_story_stories[n];n++){var i=document.createElement("div");i.classList.add("glide__slide-content"),function(){if("undefined"==typeof t.kicker)return!1;var e=document.createElement("div");e.classList.add("glide__slide-kicker"),e.innerHTML=t.kicker,i.appendChild(e)}(),function(){if("undefined"==typeof t.image||"undefined"==typeof t.ratio)return!1;var e=document.createElement("div");e.classList.add("glide__slide-image"),e.style.setProperty("background-image","url("+t.image+")"),e.style.setProperty("--image-ratio",t.ratio),i.appendChild(e)}(),function(){if("undefined"==typeof t.entry)return!1;var e=document.createElement("div");e.classList.add("glide__slide-entry"),e.innerHTML=t.entry,i.appendChild(e)}();var d=document.createElement("div");d.classList.add("glide__slide-wrap"),d.appendChild(i);var r=document.createElement("div");r.classList.add("glide__slide"),r.appendChild(d),e.querySelector(".glide__slides").appendChild(r)}}),t.on("mount.before",function(){var t=document.createElement("div");t.classList.add("glide__bullets");for(var n=0;n<e.querySelectorAll(".glide__slide").length;n++){var i=document.createElement("span");i.classList.add("glide__bullets-item"),t.appendChild(i)}return e.appendChild(t)}),t.on("mount.before",function(n){var i=document.querySelector('link[rel="prev"]');if(null===i||!i.hasAttribute("href"))return!1;var d=document.createElement("div");return d.classList.add("glide__slide","glide__slide--empty"),t.update({href:i.href}),e.querySelector(".glide__slides").appendChild(d)}),t.on("mount.before",function(){["prev","next"].forEach(function(t,n){var i=document.createElement("div");i.classList.add("glide__control","glide__control--"+t),i.classList.add();var d=document.createElement("span");d.classList.add("icon","icon--"+t),i.appendChild(d),e.appendChild(i)}),e.querySelector(".glide__control--next").addEventListener("click",function(e){e.preventDefault(),t.go(">")}),e.querySelector(".glide__control--prev").addEventListener("click",function(e){e.preventDefault(),t.go("<")})}),t.on("mount.after",function(){if("undefined"==typeof knife_story_options.background)return!1;var t=document.createElement("div");return t.classList.add("glide__backdrop"),t.style.backgroundImage="url("+knife_story_options.background+")",function(){if("undefined"==typeof knife_story_options.blur)return!1;var e=parseInt(knife_story_options.blur);return!(e<=0)&&(t.style.margin="-"+e+"px",void(t.style.filter="blur("+e+"px)"))}(),function(){if("undefined"==typeof knife_story_options.shadow)return!1;var e=parseInt(knife_story_options.shadow)/100;if(e<=0||e>1)return!1;var n=document.createElement("div");n.classList.add("glide__shadow"),n.style.backgroundColor="rgba(0, 0, 0, "+e+")",t.appendChild(n)}(),e.appendChild(t)}),t.on(["mount.after","run"],function(){for(var n,i=e.querySelectorAll(".glide__bullets-item"),d=0;n=i[d];d++)n.classList.remove("glide__bullets-item--active"),t.index===d&&n.classList.add("glide__bullets-item--active")}),t.on("mount.after",function(){var n=e.querySelectorAll(".glide__slide");t.update({count:n.length-1})}),t.on(["mount.after","run"],function(n){var i=e.querySelector(".glide__control--prev");i.classList.remove("glide__control--disabled"),0===t.index&&i.classList.add("glide__control--disabled")}),t.on("run",function(n){var i=e.querySelector(".glide__control--next");i.classList.remove("glide__control--disabled"),t.index===t.settings.count&&i.classList.add("glide__control--disabled")}),t.on("run",function(n){t.index===t.settings.count&&t.settings.href&&e.classList.remove("glide--active")}),t.on("run.after",function(e){t.index===t.settings.count&&t.settings.href&&(document.location.href=t.settings.href)}),window.addEventListener("pageshow",function(e){e.persisted&&window.location.reload(!1)}),window.addEventListener("load",function(){var t=e.getBoundingClientRect();return e.style.height=window.innerHeight-t.top-window.pageYOffset+"px",e.classList.add("glide--active")}),t.on("build.after",function(){var t=0;e.addEventListener("touchstart",function(e){var n=e.changedTouches[0];t=n.pageY},!1),e.addEventListener("touchmove",function(e){var n=e.changedTouches[0];t<n.pageY&&0===window.pageYOffset&&e.preventDefault()},!1)}),t.mount()}();
