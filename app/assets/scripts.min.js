...
"use strict";function _slicedToArray(t,e){return _arrayWithHoles(t)||_iterableToArrayLimit(t,e)||_unsupportedIterableToArray(t,e)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);return"Map"===(n="Object"===n&&t.constructor?t.constructor.name:n)||"Set"===n?Array.from(t):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(t,e):void 0}}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,o=new Array(e);n<e;n++)o[n]=t[n];return o}function _iterableToArrayLimit(t,e){var n=null==t?null:"undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(null!=n){var o,r,a=[],i=!0,s=!1;try{for(n=n.call(t);!(i=(o=n.next()).done)&&(a.push(o.value),!e||a.length!==e);i=!0);}catch(t){s=!0,r=t}finally{try{i||null==n.return||n.return()}finally{if(s)throw r}}return a}}function _arrayWithHoles(t){if(Array.isArray(t))return t}!function(){var l=document.getElementById("comments");if(null!==l&&"undefined"!=typeof knife_id_handler){var d=function(t,e){var n=t.split(".");if(1<n.length){var o=_slicedToArray(n,2),n=o[0],o=o[1];if(void 0!==knife_id_handler[n][o])return knife_id_handler[n][o]}return void 0!==knife_id_handler[t]?knife_id_handler[t]:e||""},s=["vkontakte","google","facebook","yandex"],a=d("post",null);if(null!==a){var m=!1,p=function(t,e){var n=document.createElement(t);if(e.hasOwnProperty("class")&&n.classList.add(e.class),e.hasOwnProperty("classes")&&e.classes.forEach(function(t){n.classList.add(t)}),e.hasOwnProperty("text")&&(n.textContent=e.text),e.hasOwnProperty("html")&&(n.innerHTML=e.html),e.hasOwnProperty("attributes"))for(var o in e.attributes)n.setAttribute(o,e.attributes[o]);return e.hasOwnProperty("parent")&&e.parent.appendChild(n),n},i=function(t){var e=t+window.pageYOffset-24,t=document.querySelector(".header");if(null!==t&&(t=window.getComputedStyle(t),e-=parseInt(t.getPropertyValue("height"))),"scrollBehavior"in document.documentElement.style)return window.scrollTo({top:e,behavior:"smooth"});window.scrollTo(0,e)},u=function(t,e){var n=JSON.parse(localStorage.getItem("knife_id_unsent"))||{};n[a]={text:t,reply:e},localStorage.setItem("knife_id_unsent",JSON.stringify(n))},f=function(t){var e=(JSON.parse(localStorage.getItem("knife_id_unsent"))||{})[a]||{};return e.reply===t&&e.text||""},v=function(t,e){return e[4<t%100&&t%100<20?2:[2,0,1,1,1,2][t%10<5?t%10:5]].replace("%d",t)},c=function(l,m){var u={};E("/id/notifications","GET",{},function(t){if(!((t=t||[]).length<1)){var e=p("button",{classes:["comments__form-bell"],attributes:{type:"button",title:d("form.notify")},parent:l});p("span",{classes:["icon","icon--notify"],parent:e}),p("strong",{text:t.length<100?t.length:"99+",parent:e});var n,o,r,a,i,s=p("div",{classes:["comments__notifications"],parent:l}),c=[];for(n in t.forEach(function(t){var e=t.post_id;u.hasOwnProperty(e)||(u[e]={comments:0}),c.push(t.id),u[e].slug=t.slug,u[e].title=t.title,u[e].comments++}),u)o=s,r=u[n],i=a=void 0,a=v(r.comments,d("notifications")),i=p("em",{text:r.title}),p("a",{classes:["comments__notifications-report"],parent:o,attributes:{href:r.slug+"#comments",target:"_blank"},html:a.replace("%s",i.outerHTML)});e.addEventListener("click",function(t){t.preventDefault(),function(t,e){if(t.length<1)return e();E("/id/notifications","POST",{comments:t},function(t){return e()})}(c,function(){e.classList.add("comments__form-bell--viewed")}),c=[],s.classList.toggle("comments__notifications--visible")}),m.parentNode.insertBefore(s,m.nextSibling)}})},_=function(t,e){var n=new Image;t.appendChild(n);var o=d("comments.noavatar");n.onerror=function(){n.setAttribute("src",o)},n.onload=function(){n.removeAttribute("loading")},n.setAttribute("loading",!0),n.setAttribute("src",e.avatar),n.setAttribute("alt",e.name)},h=function(e,t){var n,o,r=p("a",{class:"comments__item-time",text:(n=t.created,o=new Date(n),n={hour:"numeric",minute:"numeric",month:"numeric",day:"numeric"},o.getFullYear()<(new Date).getFullYear()&&(n.year="numeric"),o.toLocaleString("ru",n)),attributes:{href:"#comment-".concat(t.id)},parent:e});r.addEventListener("click",function(t){t.preventDefault(),history.pushState({},"",r.href),l.classList.remove("comments--folded"),i(e.getBoundingClientRect().top)})},y=function(t,e){var n=p("div",{class:"comments__item-warning",parent:t});return"removed"===e&&(n.textContent=d("comments.removed")),"blocked"===e&&(n.textContent=d("comments.blocked")),t},b=function e(n,o){var t=parseInt(o.plus)-parseInt(o.minus);n.className="comments__item-vote",o.self&&n.classList.add("comments__item-vote--voted"),0<t&&n.classList.add("comments__item-vote--plus"),t<0&&n.classList.add("comments__item-vote--minus");var r=p("button",{classes:["icon","icon--vote"],parent:n});"plus"===o.vote&&(r.classList.remove("icon--vote"),r.classList.add("icon--voted"),n.classList.add("comments__item-vote--voted")),p("span",{text:t,attributes:{title:"+".concat(o.plus," / -").concat(o.minus)},parent:n});var a=p("button",{classes:["icon","icon--vote"],parent:n});"minus"===o.vote&&(a.classList.remove("icon--vote"),a.classList.add("icon--voted"),n.classList.add("comments__item-vote--voted")),r.addEventListener("click",function(t){if(t.preventDefault(),!m)return k();for(r.classList.contains("icon--voted")&&(o.plus=parseInt(o.plus)-1,delete o.vote,E("/id/ratings?comment=".concat(o.id,"&vote=plus"),"DELETE")),r.classList.contains("icon--vote")&&(o.plus=parseInt(o.plus)+1,o.vote="plus",E("/id/ratings?comment=".concat(o.id,"&vote=plus"),"POST"));n.lastChild;)n.removeChild(n.lastChild);e(n,o)}),a.addEventListener("click",function(t){if(t.preventDefault(),!m)return k();for(a.classList.contains("icon--voted")&&(o.minus=parseInt(o.minus)-1,delete o.vote,E("/id/ratings?comment=".concat(o.id,"&vote=minus"),"DELETE")),a.classList.contains("icon--vote")&&(o.minus=parseInt(o.minus)+1,o.vote="minus",E("/id/ratings?comment=".concat(o.id,"&vote=minus"),"POST"));n.lastChild;)n.removeChild(n.lastChild);e(n,o)})},r=function(t,e){if(t.setAttribute("data-id",e.id),"visible"!==e.status)return y(t,e.status);e.name=e.name||d("comments.anonymous"),e.content=(o=(o=(o=(o=e.content).replace(/(\r\n)/g,"\n")).replace(/(\n){2,}/g,"</p><p>")).replace(/(\n)/g,"<br>"),"<p>".concat(o,"</p>")),t.setAttribute("data-name",e.name);var n=p("div",{class:"comments__item-avatar",parent:t});_(n,e);var o=p("div",{class:"comments__item-header",parent:t});h(t,e),p("span",{class:"comments__item-name",text:e.name,parent:o}),p("div",{class:"comments__item-content",html:e.content,parent:t});var r,a,i,n=p("div",{class:"comments__item-footer",parent:t});r=n,a=e,i=t,p("button",{class:"comments__item-button",text:d("comments.reply"),parent:r}).addEventListener("click",function(t){if(t.preventDefault(),!m)return k();l.classList.remove("comments--folded"),l.querySelectorAll(".comments__item-form").forEach(function(t){t.parentNode.removeChild(t)});var e=x();e.classList.add("comments__item-form"),e.setAttribute("data-reply",a.id),i.insertBefore(e,r.nextSibling),p("button",{class:"comments__item-cancel",text:d("form.cancel"),parent:e.querySelector(".comments__form-footer")}).addEventListener("click",function(t){return t.preventDefault(),e.parentNode.removeChild(e)});var n=e.querySelector(".comments__form-text");n.setAttribute("placeholder",d("form.reply")),n.value=f(a.id),n.focus(),n.addEventListener("input",function(){u(n.value,a.id)})});var s,c,o=p("div",{class:"comments__item-vote",parent:n});return b(o,e),d("action")?function(t,e,n){var o=p("button",{class:"comments__item-button",text:d("comments.remove"),parent:t});o.addEventListener("click",function(t){t.preventDefault();t={remove:e.id};C(t,o,function(){for(var t=n.querySelector(".comments__item-children");n.lastChild;)n.removeChild(n.lastChild);y(n,"removed"),null!==t&&n.appendChild(t)})});var r=p("button",{class:"comments__item-button",text:d("comments.block"),parent:t});return r.addEventListener("click",function(t){t.preventDefault();t={block:e.id};C(t,r,function(){for(var t=n.querySelector(".comments__item-children");n.lastChild;)n.removeChild(n.lastChild);y(n,"blocked"),null!==t&&n.appendChild(t)})}),n}(n,e,t):(e.self&&(n=n,s=e,c=t,p("button",{class:"comments__item-button",text:d("comments.remove"),parent:n}).addEventListener("click",function(t){t.preventDefault();t="/id/comments/".concat(s.id);E(t,"DELETE",{},function(){for(var t=c.querySelector(".comments__item-children");c.lastChild;)c.removeChild(c.lastChild);y(c,"removed"),null!==t&&c.appendChild(t)})})),t)},g=function(t){var e=p("div",{class:"comments__item"}),e=r(e,t);if(null===t.parent)return l.appendChild(e);var n=l.querySelector('[data-id="'.concat(t.parent,'"]'));if(null===n)return l.appendChild(e);var o=n.querySelector(".comments__item-children");null===o&&(o=p("div",{class:"comments__item-children",parent:n})),"visible"===t.status&&(e=function(e,t,n){if(!e.hasAttribute("data-name"))return n;var o=p("a",{class:"comments__item-replied",html:'<span class="icon icon--reply"></span>',attributes:{href:"#comment-".concat(t.parent)},parent:n.querySelector(".comments__item-header")});return p("span",{text:e.getAttribute("data-name"),parent:o}),o.addEventListener("click",function(t){t.preventDefault(),history.pushState({},"",o.href),l.classList.remove("comments--folded"),i(e.getBoundingClientRect().top)}),n}(n,t,e));n=n.getAttribute("data-level")||0,n=parseInt(n)+1;return e.setAttribute("data-level",n),2<n&&o.classList.add("comments__item-children--deepest"),o.appendChild(e)},L=function(n){var t="/id/comments?post=".concat(a),o=n.getAttribute("data-reply");o&&(t+="&parent=".concat(o));var e={content:n.querySelector("textarea").value},r=n.querySelector(".comments__form-submit");r.setAttribute("disabled","disabled"),E(t,"POST",e,function(t){var e,t=t.comments||[];0<t.length&&(n.reset(),o&&n.parentNode.removeChild(n),e=g(t[0]),l.classList.remove("comments--folded"),i(e.getBoundingClientRect().top)),r.removeAttribute("disabled"),delete(e=JSON.parse(localStorage.getItem("knife_id_unsent"))||{})[a],localStorage.setItem("knife_id_unsent",JSON.stringify(e))})},x=function(){var e=p("form",{class:"comments__form"}),t=p("textarea",{class:"comments__form-text",attributes:{placeholder:d("form.placeholder")},parent:e}),n=d("form.authorize");m&&(n=d("form.submit"),t.setAttribute("required","required"));var o=p("div",{class:"comments__form-footer",parent:e}),r=p("button",{classes:["comments__form-submit","button"],attributes:{type:"submit"},text:n,parent:o});e.addEventListener("submit",function(t){return t.preventDefault(),m?void L(e):k()});function a(){window.setTimeout(function(){t.style.height="auto",t.style.height="".concat(t.scrollHeight+2,"px")},0)}return t.addEventListener("keydown",function(t){13==t.keyCode&&(t.metaKey||t.ctrlKey)&&r.click(),a()}),t.addEventListener("paste",a),e},S=function(t){if(t=t||d("error"),!l.classList.contains("comments--expand"))return console.error(t);var e=l.querySelector(".comments__form");if(null===e)return console.error(t);var n=l.querySelector(".comments__error");(n=null===n?p("p",{class:"comments__error"}):n).textContent=t,e.parentNode.insertBefore(n,e.nextSibling),i(e.getBoundingClientRect().top)},C=function(t,n,o){var e,r=new FormData;for(e in r.append("action",d("action")),r.append("nonce",d("nonce")),t)r.append(e,t[e]);n.setAttribute("disabled","disabled");var a=new XMLHttpRequest;a.open("POST",d("ajaxurl")),a.send(r),a.onload=function(){var t=l.querySelector(".comments__error");null!==t&&l.removeChild(t),n.removeAttribute("disabled");try{var e=JSON.parse(a.responseText);if(!e.success)return S(e.data);if("function"==typeof o)return o(e.data||{})}catch(t){return S()}}},E=function(t,e,n,o){var r=new XMLHttpRequest;r.open(e,t,!0),r.setRequestHeader("Content-Type","application/json"),r.onload=function(){var t=l.querySelector(".comments__error");null!==t&&l.removeChild(t);try{var e=JSON.parse(r.responseText);if(200!==r.status)return S(e.message||d("error"));if("function"==typeof o)return o(e.result||{})}catch(t){return S()}},void 0===n&&(n={}),r.send(JSON.stringify(n))},k=function(){var t=document.body,e=p("div",{class:"login"}),n=p("div",{class:"login__popup",parent:e});p("h3",{class:"login__popup-heading",text:d("login.heading"),parent:n}),p("p",{class:"login__popup-helper",text:d("login.helper"),parent:n}),s.forEach(function(t){var e=p("a",{classes:["login__popup-button","login__popup-button--".concat(t)],text:d("login.".concat(t)),attributes:{href:"/id/profiles/".concat(t),target:"_blank",rel:"opener"},parent:n});p("span",{classes:["icon","icon--".concat(t)],parent:e})}),p("p",{class:"login__popup-policy",html:d("login.policy"),parent:n});var o=p("button",{class:"login__popup-close",parent:n}),r=window.scrollY;t.classList.add("is-login"),t.style.top=-r+"px";function a(){document.removeEventListener("keydown",i),e.parentNode===t&&t.removeChild(e),t.classList.remove("is-login"),t.style.top="",window.scrollTo(0,r)}o.addEventListener("click",a);var i=function(t){if(27===t.keyCode)return a()};document.addEventListener("keydown",i);o=function t(e){if("reload"===e.data)return a(),window.removeEventListener("message",t),w()};window.addEventListener("message",o),t.appendChild(e)},w=function(){for(;l.lastChild;)l.removeChild(l.lastChild);m=!1,E("/id/comments?post=".concat(a),"GET",{},function(t){var e=t.comments||[];t.identity&&(m=!0),function(t){if(!d("question.message"))return;var e=p("div",{class:"comments__question",parent:t});d("question.avatar")&&p("div",{class:"comments__question-avatar",text:d("question.avatar"),parent:e});t=p("div",{class:"comments__question-caption",parent:e});d("question.author")&&p("p",{text:d("question.author"),class:"comments__question-author",parent:t}),p("p",{text:d("question.message"),class:"comments__question-message",parent:t})}(l);var n=x();l.appendChild(n);var o=n.querySelector(".comments__form-text");o.textContent=f(0),o.addEventListener("input",function(){u(o.value,0)}),function(t,e,n){if(void 0===e)return;var o=p("div",{class:"comments__form-badge",parent:t.querySelector(".comments__form-footer")});_(o,e),p("span",{text:e.name,parent:o}),c(o,t),p("button",{classes:["comments__form-exit","icon","icon--exit"],attributes:{type:"button",title:d("form.exit")},parent:t}).addEventListener("click",function(t){t.preventDefault(),n.classList.remove("comments--expand"),E("/id/logout","POST",{},function(){setTimeout(w,300)})})}(n,t.identity,l),10<e.length&&function(t){l.classList.add("comments--folded");var e=p("div",{class:"comments__expand",parent:l});p("button",{class:"comments__expand-button",text:v(t,d("comments.expand")),attrubutes:{type:"button"},parent:e}).addEventListener("click",function(t){t.preventDefault(),l.classList.remove("comments--folded")})}(e.length),e.forEach(function(t){void 0!==t.id&&g(t)}),l.classList.add("comments--expand");var r,e=document.location.hash.match(/^#comment-(\d+)/)||[];1<e.length&&(null!==(r=l.querySelector('[data-id="'.concat(e[1],'"]')))&&(l.classList.remove("comments--folded"),window.addEventListener("load",function(){i(r.getBoundingClientRect().top)})))})};w()}}}();
