...
!function(){var c=document.getElementById("load-comments");if(null===c||"undefined"==typeof knife_comments_id)return;var s=null;c.addEventListener("click",function(e){if(e.preventDefault(),null!==s)return s.classList.toggle("comments");var t=c.textContent;return c.innerHTML='<span class="icon icon--loop"></span>',function(e){_hcwp=window._hcwp||[],_hcwp.push({widget:"Stream",widget_id:knife_comments_id,callback:e}),(s=document.createElement("div")).classList.add("entry-footer__comments"),s.id="hypercomments_widget";var t=c.nextElementSibling;null!==t&&t.insertBefore(s,t.firstChild);var n=document.createElement("script");n.type="text/javascript",n.async=!0,n.src="https://w.hypercomments.com/widget/hc/"+knife_comments_id+"/ru/widget.js";var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(n,i.nextSibling)}(function(){c.innerHTML=t,s.classList.add("comments")})})}();
