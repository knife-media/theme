...
!function(){var e=document.querySelector(".post");if(null===e)return;function n(e){var t=document.createElement("iframe"),r=function(e){var t=document.createElement("div");t.classList.add("embed__loader"),e.appendChild(t);var r=document.createElement("span");return r.classList.add("embed__loader-bounce"),t.appendChild(r),t}(e);return t.setAttribute("allow","autoplay"),t.setAttribute("frameborder","0"),t.setAttribute("src",e.dataset.embed),t.addEventListener("load",function(){r.parentNode.removeChild(r)}),t}e.addEventListener("click",function(e){var t=e.target||e.srcElement;if(null!==t.parentElement){var r=t.parentElement;if(r.classList.contains("embed")&&r.hasAttribute("data-embed")){for(e.preventDefault();r.firstChild;)r.removeChild(r.firstChild);r.appendChild(n(r))}}})}();
