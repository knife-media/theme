...
"use strict";function _slicedToArray(e,t){return _arrayWithHoles(e)||_iterableToArrayLimit(e,t)||_unsupportedIterableToArray(e,t)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);return"Object"===n&&e.constructor&&(n=e.constructor.name),"Map"===n||"Set"===n?Array.from(e):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n];return r}function _iterableToArrayLimit(e,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e)){var n=[],r=!0,o=!1,a=void 0;try{for(var i,s=e[Symbol.iterator]();!(r=(i=s.next()).done)&&(n.push(i.value),!t||n.length!==t);r=!0);}catch(e){o=!0,a=e}finally{try{r||null==s.return||s.return()}finally{if(o)throw a}}return n}}function _arrayWithHoles(e){if(Array.isArray(e))return e}!function(){var d=document.getElementById("comments");if(null!==d&&void 0!==knife_id_handler){var u=function(e,t){var n=e.split(".");if(1<n.length){var r=_slicedToArray(n,2),o=r[0],a=r[1];if(void 0!==knife_id_handler[o][a])return knife_id_handler[o][a]}return void 0!==knife_id_handler[e]?knife_id_handler[e]:t||""},s=["vkontakte","google","facebook","yandex"],i=u("post",null);if(null!==i){var p=!1,v=function(e,t){var n=document.createElement(e);if(t.hasOwnProperty("class")&&n.classList.add(t.class),t.hasOwnProperty("classes")&&t.classes.forEach(function(e){n.classList.add(e)}),t.hasOwnProperty("text")&&(n.textContent=t.text),t.hasOwnProperty("html")&&(n.innerHTML=t.html),t.hasOwnProperty("attributes"))for(var r in t.attributes)n.setAttribute(r,t.attributes[r]);return t.hasOwnProperty("parent")&&t.parent.appendChild(n),n},c=function(e){var t,n=e+window.pageYOffset-24,r=document.querySelector(".header");if(null!==r&&(t=window.getComputedStyle(r),n-=parseInt(t.getPropertyValue("height"))),"scrollBehavior"in document.documentElement.style)return window.scrollTo({top:n,behavior:"smooth"});window.scrollTo(0,n)},f=function(e,t){var n=JSON.parse(localStorage.getItem("knife_id_unsent"))||{};n[i]={text:e,reply:t},localStorage.setItem("knife_id_unsent",JSON.stringify(n))},_=function(e){var t=(JSON.parse(localStorage.getItem("knife_id_unsent"))||{})[i]||{};return t.reply===e&&t.text||""},h=function(e,t){var n=new Image;e.appendChild(n);var r=u("comments.noavatar");n.onerror=function(){n.setAttribute("src",r)},n.onload=function(){n.removeAttribute("loading")},n.setAttribute("loading",!0),n.setAttribute("src",t.avatar),n.setAttribute("alt",t.name)},y=function(t,e){var n,r,o,a=v("a",{class:"comments__item-time",text:(n=e.created,r=new Date(n),o={hour:"numeric",minute:"numeric",month:"numeric",day:"numeric"},r.getFullYear()<(new Date).getFullYear()&&(o.year="numeric"),r.toLocaleString("ru",o)),attributes:{href:"#comment-".concat(e.id)},parent:t});a.addEventListener("click",function(e){e.preventDefault(),history.pushState({},"",a.href),d.classList.remove("comments--folded"),c(t.getBoundingClientRect().top)})},b=function(e,t){var n=v("div",{class:"comments__item-warning",parent:e});return"removed"===t&&(n.textContent=u("comments.removed")),"blocked"===t&&(n.textContent=u("comments.blocked")),e},a=function(e,t){if(e.setAttribute("data-id",t.id),"visible"!==t.status)return b(e,t.status);t.name=t.name||u("comments.anonymous"),t.content=t.content.replace(/(\n)+/g,"<br>"),e.setAttribute("data-name",t.name);var n=v("div",{class:"comments__item-avatar",parent:e});h(n,t);var r=v("div",{class:"comments__item-header",parent:e});y(e,t),v("span",{class:"comments__item-name",text:t.name,parent:r}),v("span",{class:"comments__item-content",html:t.content,parent:e});var o,a,i,s,c,l,m=v("div",{class:"comments__item-footer",parent:e});return o=m,a=t,i=e,v("button",{class:"comments__item-button",text:u("comments.reply"),parent:o}).addEventListener("click",function(e){if(e.preventDefault(),!p)return x();d.classList.remove("comments--folded"),d.querySelectorAll(".comments__item-form").forEach(function(e){e.parentNode.removeChild(e)});var t=g();t.classList.add("comments__item-form"),t.setAttribute("data-reply",a.id),i.insertBefore(t,o.nextSibling),v("button",{class:"comments__item-cancel",text:u("form.cancel"),parent:t.querySelector(".comments__form-footer")}).addEventListener("click",function(e){return e.preventDefault(),t.parentNode.removeChild(t)});var n=t.querySelector(".comments__form-text");n.setAttribute("placeholder",u("form.reply")),n.value=_(a.id),n.focus(),n.addEventListener("input",function(){f(n.value,a.id)})}),function t(n,r){var e=parseInt(r.plus)-parseInt(r.minus);n.className="comments__item-vote",r.self&&n.classList.add("comments__item-vote--voted"),0<e&&n.classList.add("comments__item-vote--plus"),e<0&&n.classList.add("comments__item-vote--minus");var o=v("button",{classes:["icon","icon--vote"],parent:n});"plus"===r.vote&&(o.classList.remove("icon--vote"),o.classList.add("icon--voted"),n.classList.add("comments__item-vote--voted")),v("span",{text:e,attributes:{title:"+".concat(r.plus," / -").concat(r.minus)},parent:n});var a=v("button",{classes:["icon","icon--vote"],parent:n});"minus"===r.vote&&(a.classList.remove("icon--vote"),a.classList.add("icon--voted"),n.classList.add("comments__item-vote--voted")),o.addEventListener("click",function(e){if(e.preventDefault(),!p)return x();for(o.classList.contains("icon--voted")&&(r.plus=parseInt(r.plus)-1,delete r.vote,S("/id/ratings?comment=".concat(r.id,"&vote=plus"),"DELETE")),o.classList.contains("icon--vote")&&(r.plus=parseInt(r.plus)+1,r.vote="plus",S("/id/ratings?comment=".concat(r.id,"&vote=plus"),"POST"));n.lastChild;)n.removeChild(n.lastChild);t(n,r)}),a.addEventListener("click",function(e){if(e.preventDefault(),!p)return x();for(a.classList.contains("icon--voted")&&(r.minus=parseInt(r.minus)-1,delete r.vote,S("/id/ratings?comment=".concat(r.id,"&vote=minus"),"DELETE")),a.classList.contains("icon--vote")&&(r.minus=parseInt(r.minus)+1,r.vote="minus",S("/id/ratings?comment=".concat(r.id,"&vote=minus"),"POST"));n.lastChild;)n.removeChild(n.lastChild);t(n,r)})}(v("div",{class:"comments__item-vote",parent:m}),t),u("action")?function(e,n,r){var o=v("button",{class:"comments__item-button",text:u("comments.remove"),parent:e});o.addEventListener("click",function(e){e.preventDefault();var t={remove:n.id};C(t,o,function(){for(var e=r.querySelector(".comments__item-children");r.lastChild;)r.removeChild(r.lastChild);b(r,"removed"),null!==e&&r.appendChild(e)})});var a=v("button",{class:"comments__item-button",text:u("comments.block"),parent:e});return a.addEventListener("click",function(e){e.preventDefault();var t={block:n.id};C(t,a,function(){for(var e=r.querySelector(".comments__item-children");r.lastChild;)r.removeChild(r.lastChild);b(r,"blocked"),null!==e&&r.appendChild(e)})}),r}(m,t,e):(t.self&&(s=m,c=t,l=e,v("button",{class:"comments__item-button",text:u("comments.remove"),parent:s}).addEventListener("click",function(e){e.preventDefault();var t="/id/comments/".concat(c.id);S(t,"DELETE",{},function(){for(var e=l.querySelector(".comments__item-children");l.lastChild;)l.removeChild(l.lastChild);b(l,"removed"),null!==e&&l.appendChild(e)})})),e)},l=function(e){var t=v("div",{class:"comments__item"}),t=a(t,e);if(null===e.parent)return d.appendChild(t);var n=d.querySelector('[data-id="'.concat(e.parent,'"]'));if(null===n)return d.appendChild(t);var r=n.querySelector(".comments__item-children");null===r&&(r=v("div",{class:"comments__item-children",parent:n})),"visible"===e.status&&(t=function(t,e,n){if(!t.hasAttribute("data-name"))return n;var r=v("a",{class:"comments__item-replied",html:'<span class="icon icon--reply"></span>',attributes:{href:"#comment-".concat(e.parent)},parent:n.querySelector(".comments__item-header")});return v("span",{text:t.getAttribute("data-name"),parent:r}),r.addEventListener("click",function(e){e.preventDefault(),history.pushState({},"",r.href),d.classList.remove("comments--folded"),c(t.getBoundingClientRect().top)}),n}(n,e,t));var o=n.getAttribute("data-level")||0,o=parseInt(o)+1;return t.setAttribute("data-level",o),2<o&&r.classList.add("comments__item-children--deepest"),r.appendChild(t)},m=function(o){var e="/id/comments?post=".concat(i),a=o.getAttribute("data-reply");a&&(e+="&parent=".concat(a));var t={content:o.querySelector("textarea").value};S(e,"POST",t,function(e){var t,n,r=e.comments||[];return 0<r.length&&(o.reset(),a&&o.parentNode.removeChild(o),t=l(r[0]),d.classList.remove("comments--folded"),c(t.getBoundingClientRect().top)),delete(n=JSON.parse(localStorage.getItem("knife_id_unsent"))||{})[i],void localStorage.setItem("knife_id_unsent",JSON.stringify(n))})},g=function(){var t=v("form",{class:"comments__form"}),e=v("textarea",{class:"comments__form-text",attributes:{placeholder:u("form.placeholder")},parent:t}),n=u("form.authorize");p&&(n=u("form.submit"),e.setAttribute("required","required"));var r=v("div",{class:"comments__form-footer",parent:t}),o=v("button",{classes:["comments__form-submit","button"],attributes:{type:"submit"},text:n,parent:r});t.addEventListener("submit",function(e){return e.preventDefault(),p?void m(t):x()});function a(){window.setTimeout(function(){e.style.height="auto",e.style.height="".concat(e.scrollHeight+2,"px")},0)}return e.addEventListener("keydown",function(e){13==e.keyCode&&(e.metaKey||e.ctrlKey)&&o.click(),a()}),e.addEventListener("paste",a),t},L=function(e){if(e=e||u("error"),!d.classList.contains("comments--expand"))return console.error(e);var t=d.querySelector(".comments__form");if(null===t)return console.error(e);var n=d.querySelector(".comments__error");null===n&&(n=v("p",{class:"comments__error"})),n.textContent=e,t.parentNode.insertBefore(n,t.nextSibling),c(t.getBoundingClientRect().top)},C=function(e,n,r){var t=new FormData;for(var o in t.append("action",u("action")),t.append("nonce",u("nonce")),e)t.append(o,e[o]);n.setAttribute("disabled","disabled");var a=new XMLHttpRequest;a.open("POST",u("ajaxurl")),a.send(t),a.onload=function(){var e=d.querySelector(".comments__error");null!==e&&d.removeChild(e),n.removeAttribute("disabled");try{var t=JSON.parse(a.responseText);if(!t.success)return L(t.data);if("function"==typeof r)return r(t.data||{})}catch(e){return L()}}},S=function(e,t,n,r){var o=new XMLHttpRequest;o.open(t,e,!0),o.setRequestHeader("Content-Type","application/json"),o.onload=function(){var e=d.querySelector(".comments__error");null!==e&&d.removeChild(e);try{var t=JSON.parse(o.responseText);if(200!==o.status)return L(t.message||u("error"));if("function"==typeof r)return r(t.result||{})}catch(e){return L()}},void 0===n&&(n={}),o.send(JSON.stringify(n))},x=function(){var e=document.body,t=v("div",{class:"login"}),n=v("div",{class:"login__popup",parent:t});v("h3",{class:"login__popup-heading",text:u("login.heading"),parent:n}),v("p",{class:"login__popup-helper",text:u("login.helper"),parent:n}),s.forEach(function(e){var t=v("a",{classes:["login__popup-button","login__popup-button--".concat(e)],text:u("login.".concat(e)),attributes:{href:"/id/profiles/".concat(e),target:"_blank",rel:"opener"},parent:n});v("span",{classes:["icon","icon--".concat(e)],parent:t})}),v("p",{class:"login__popup-policy",html:u("login.policy"),parent:n});var r=v("button",{class:"login__popup-close",parent:n}),o=window.scrollY;e.classList.add("is-login"),e.style.top=-o+"px";function a(){e.removeChild(t),document.removeEventListener("keydown",i),e.classList.remove("is-login"),e.style.top="",window.scrollTo(0,o)}r.addEventListener("click",a);var i=function(e){if(27===e.keyCode)return a()};document.addEventListener("keydown",i);window.addEventListener("message",function e(t){if("reload"===t.data)return a(),window.removeEventListener("message",e),k()}),e.appendChild(t)},k=function(){for(;d.lastChild;)d.removeChild(d.lastChild);p=!1,S("/id/comments?post=".concat(i),"GET",{},function(e){var t=e.comments||[];e.identity&&(p=!0);var n=g();d.appendChild(n);var r=n.querySelector(".comments__form-text");r.textContent=_(0),r.addEventListener("input",function(){f(r.value,0)}),function(e,t){if(void 0===t)return;var n=v("div",{class:"comments__form-badge",parent:e.querySelector(".comments__form-footer")});h(n,t),v("span",{text:t.name,parent:n}),v("button",{classes:["comments__form-exit","icon","icon--exit"],attributes:{type:"button",title:u("form.exit")},parent:e}).addEventListener("click",function(e){e.preventDefault(),d.classList.remove("comments--expand"),S("/id/logout","POST",{},function(){setTimeout(k,300)})})}(n,e.identity),10<t.length&&function(){d.classList.add("comments--folded");var e=v("div",{class:"comments__expand",parent:d});v("button",{class:"comments__expand-button",text:u("comments.expand"),attrubutes:{type:"button"},parent:e}).addEventListener("click",function(e){e.preventDefault(),d.classList.remove("comments--folded")})}(),t.forEach(function(e){void 0!==e.id&&l(e)}),d.classList.add("comments--expand");var o,a=document.location.hash.match(/^#comment-(\d+)/)||[];1<a.length&&(null!==(o=d.querySelector('[data-id="'.concat(a[1],'"]')))&&(d.classList.remove("comments--folded"),c(o.getBoundingClientRect().top)))})};k()}}}();
