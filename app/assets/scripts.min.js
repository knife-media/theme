...
"use strict";!function(){var u,d,p,o,v,c=document.getElementById("comments");null!==c&&"undefined"!=typeof knife_id_handler&&(u=function(e,t){return knife_id_handler.hasOwnProperty(e)?knife_id_handler[e]:t||""},d=function(e){var t,n=e+window.pageYOffset-24,a=document.querySelector(".header");if(null!==a&&(t=window.getComputedStyle(a),n-=parseInt(t.getPropertyValue("height"))),"scrollBehavior"in document.documentElement.style)return window.scrollTo({top:n,behavior:"smooth"});window.scrollTo(to,0)},p=function(e,t,n){var a,i,o,c=document.createElement("a");c.classList.add("comments__item-time"),c.textContent=(a=t.created,i=new Date(a),o={hour:"numeric",minute:"numeric",month:"numeric",day:"numeric"},i.getFullYear()<(new Date).getFullYear()&&(o.year="numeric"),i.toLocaleString("ru",o)),c.setAttribute("href","#comment-".concat(t.id)),c.addEventListener("click",function(){d(n.getBoundingClientRect().top)}),e.appendChild(c)},o=function(e,t){e.setAttribute("data-id",t.id),function(e,t){var n=document.createElement("div");n.classList.add("comments__item-avatar"),e.appendChild(n);var a=new Image;a.onerror=function(){a.src=u("avatar")},a.src=t.avatar||u("avatar"),n.appendChild(a)}(e,t);var n=document.createElement("div");n.classList.add("comments__item-header"),e.appendChild(n);var a=document.createElement("span");a.classList.add("comments__item-name"),a.textContent=t.name,n.appendChild(a),p(n,t,e);var i=document.createElement("div");i.classList.add("comments__item-content"),i.innerHTML=t.content,e.appendChild(i);var o,c,d,r,s,l,m=document.createElement("div");return m.classList.add("comments__item-footer"),e.appendChild(m),o=m,(c=document.createElement("button")).classList.add("comments__item-button"),c.textContent=u("reply"),c.addEventListener("click",function(e){e.preventDefault();var t=document.createElement("textarea");o.parentNode.insertBefore(t,o.nextSibling)}),o.appendChild(c),function(e,t){var n=document.createElement("div");n.classList.add("comments__item-vote");var a=parseInt(t.plus)+parseInt(t.minus);0<a&&n.classList.add("comments__item-vote--plus"),a<0&&n.classList.add("comments__item-vote--minus");var i=document.createElement("button");i.classList.add("icon","icon--vote"),n.appendChild(i),"plus"===t.vote&&(i.classList.remove("icon--vote"),i.classList.add("icon--voted")),i.addEventListener("click",function(e){e.preventDefault(),console.log(a),a+=1,v("/id/ratings?comment=".concat(t.id,"&vote=plus"),"POST",function(e){console.log(e)})});var o=document.createElement("span");o.textContent=a,n.appendChild(o);var c=document.createElement("button");c.classList.add("icon","icon--vote"),n.appendChild(c),"minus"===t.vote&&(c.classList.remove("icon--vote"),c.classList.add("icon--voted")),c.addEventListener("click",function(e){e.preventDefault(),alert("minus")}),e.appendChild(n)}(m,t),(u("action")||t.self)&&(d=m,(r=document.createElement("button")).classList.add("comments__item-button"),r.textContent=u("remove"),r.addEventListener("click",function(e){e.preventDefault()}),d.appendChild(r)),u("action")&&(s=m,(l=document.createElement("button")).classList.add("comments__item-button"),l.textContent=u("block"),l.addEventListener("click",function(e){e.preventDefault()}),s.appendChild(l)),e},(v=function(e,t,n){var a=new XMLHttpRequest;a.open(t,e,!0),a.setRequestHeader("Content-Type","application/json"),a.setRequestHeader("Authorization","Bearer eyJhbGciOiJIUzI1NiJ9.MTE5OTk.QyEBvqipT1VU7Vnfl14qu8-qAbxrNVi61zCEUGyJ4Js"),a.onload=function(){if(200===a.status)return n(JSON.parse(a.responseText));console.error("Error while ".concat(e," loading"))},a.send()})("/id/comments?post=91039","GET",function(e){var t,n,a;(e.fields||[]).forEach(function(e){!function(e){var t=document.createElement("div");if(t.classList.add("comments__item"),t=o(t,e),null===e.parent)return c.appendChild(t);var n=c.querySelector('[data-id="'.concat(e.parent,'"]'));if(null===n)return c.appendChild(t);var a=n.querySelector(".comments__item-children");null===a&&((a=document.createElement("div")).classList.add("comments__item-children"),n.appendChild(a));var i=n.getAttribute("data-level")||0,i=parseInt(i)+1;t.setAttribute("data-level",i),3<i&&a.classList.add("comments__item-children--deepest"),a.appendChild(t)}(e)}),t=document.location.hash,n=t.replace("#comment-",""),null!==(a=c.querySelector('[data-id="'.concat(n,'"]')))&&d(a.getBoundingClientRect().top)}))}();
