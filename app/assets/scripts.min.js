...
!function(){var e=document.querySelector(".glide");if(null===e||"undefined"==typeof Glide)return!1;if(0===e.querySelectorAll(".glide__slide").length)return!1;window.addEventListener("pageshow",function(e){e.persisted&&window.location.reload(!1)}),window.addEventListener("load",function(){var t=e.getBoundingClientRect();return e.style.height=window.innerHeight-t.top-window.pageYOffset+"px",e.classList.add("glide--active")});var t=new Glide(".glide",{gap:0,rewind:!1,touchAngle:30,dragThreshold:!1,breakpoints:{767:{dragThreshold:!0}}});return t.on("mount.before",function(){var t=document.createElement("div");return t.classList.add("glide__loader","icon","icon--loop"),e.appendChild(t)}),t.on("mount.before",function(){if("undefined"==typeof knife_story_options.background)return!1;var t=document.createElement("div");return t.classList.add("glide__backdrop"),t.style.backgroundImage="url("+knife_story_options.background+")",function(){if("undefined"==typeof knife_story_options.blur)return!1;var e=parseInt(knife_story_options.blur);return!(e<=0)&&(t.style.margin="-"+e+"px",void(t.style.filter="blur("+e+"px)"))}(),function(){if("undefined"==typeof knife_story_options.shadow)return!1;var e=parseInt(knife_story_options.shadow)/100;if(e<=0||e>1)return!1;var n=document.createElement("div");n.classList.add("glide__shadow"),n.style.backgroundColor="rgba(0, 0, 0, "+e+")",t.appendChild(n)}(),e.appendChild(t)}),t.on("mount.before",function(){var t=document.createElement("div");t.classList.add("glide__bullets");for(var n=0;n<e.querySelectorAll(".glide__slide").length;n++){var i=document.createElement("span");i.classList.add("glide__bullets-item"),t.appendChild(i)}return e.appendChild(t)}),t.on(["mount.after","run"],function(){for(var n,i=e.querySelectorAll(".glide__bullets-item"),o=0;n=i[o];o++)n.classList.remove("glide__bullets-item--active"),t.index===o&&n.classList.add("glide__bullets-item--active")}),t.on("mount.before",function(n){var i=document.querySelector('link[rel="next"]');if(null===i||!i.hasAttribute("href"))return!1;var o=document.createElement("div");return o.classList.add("glide__slide","glide__slide--empty"),t.update({href:i.href}),e.querySelector(".glide__slides").appendChild(o)}),t.on("mount.before",function(){["prev","next"].forEach(function(t,n){var i=document.createElement("div");i.classList.add("glide__control","glide__control--"+t),i.classList.add();var o=document.createElement("span");o.classList.add("icon","icon--"+t),i.appendChild(o),e.appendChild(i)}),e.querySelector(".glide__control--next").addEventListener("click",function(e){e.preventDefault(),t.go(">")}),e.querySelector(".glide__control--prev").addEventListener("click",function(e){e.preventDefault(),t.go("<")})}),t.on("mount.after",function(){var n=e.querySelectorAll(".glide__slide");t.update({count:n.length-1})}),t.on(["mount.after","run"],function(n){var i=e.querySelector(".glide__control--prev");i.classList.remove("glide__control--disabled"),0===t.index&&i.classList.add("glide__control--disabled")}),t.on("run",function(n){var i=e.querySelector(".glide__control--next");i.classList.remove("glide__control--disabled"),t.index===t.settings.count&&i.classList.add("glide__control--disabled")}),t.on("run",function(n){t.index===t.settings.count&&t.settings.href&&e.classList.remove("glide--active")}),t.on("run.after",function(e){t.index===t.settings.count&&t.settings.href&&(document.location.href=t.settings.href)}),t.mount()}();
