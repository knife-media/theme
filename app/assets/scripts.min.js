!function(){var e=document.querySelectorAll(".widget-adfox");if(!(e.length<1)){for(var t=0;t<e.length;t++){var a,o,n=e[t].querySelector("div");null!==n&&0!==n.dataset.length&&(a=Date.now().toString(10)+Math.random().toString(10).substr(2,5),(o=document.createElement("div")).id="adfox_"+a,e[t].replaceChild(o,n),o.addEventListener("click",c),o.addEventListener("click",i),r(n.dataset,a,e[t]))}var d=document.createElement("script");d.type="text/javascript",d.async=!0,d.crossorigin="anonymous",d.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(d)}function s(e){var t=document.cookie.match("(^|;) ?"+e+"=([^;]*)(;|$)");return t?t[2]:""}function m(e,t){var a=e.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(a.length<=2)return t;var o=a[2].split("&");t.ownerId=a[1],t.params={};for(var n=0;n<o.length;n++){var d=o[n].split("=");1!=d.length&&"pr"!==d[0]&&(t.params[d[0]]=decodeURIComponent(d[1].replace(/\+/g," ")))}return t.params=function(e){if("undefined"==typeof knife_meta_parameters)return e;for(var t=["template","postid","special","category","tags","adult","promo"],a=0,o=1;a<t.length;a++,o++){var n=t[a];e["puid"+o]=knife_meta_parameters[n]||""}return e["puid"+o]=s("adfox-close"),e}(t.params),t}function p(e,t){return e.onStub=function(){t.classList.remove("widget-adfox--loaded")},e.onError=function(){t.classList.remove("widget-adfox--loaded")},e.onLoad=function(){t.classList.add("widget-adfox--loaded")},e}function r(e,t,a){if(e.common)return o=e.common,n=a,(d={}).containerId="adfox_"+t,d=m(o,d=p(d,n)),window.adfoxAsyncParams=window.adfoxAsyncParams||[],void window.adfoxAsyncParams.push(d);var o,n,d,r,i,s,c,l,f;e.mobile&&(r=e.mobile,i=a,(s={}).containerId="adfox_"+t,s=m(r,s=p(s,i)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([s,["tablet","phone"],{tabletWidth:1023,isAutoReloads:!0}])),e.desktop&&(c=e.desktop,l=a,(f={}).containerId="adfox_"+t,f=m(c,f=p(f,l)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([f,["desktop"],{tabletWidth:1023,isAutoReloads:!0}]))}function i(e){var t=e.target||e.srcElement;if(t.hasAttribute("data-close")){e.preventDefault();var a,o,n,d,r=[],i=s("adfox-close");for(0<i.length&&(r=i.split(":")),r.indexOf(t.dataset.close)<0&&r.push(t.dataset.close),a="adfox-close",o=r.join(":"),n=12,(d=new Date).setTime(d.getTime()+36e5*n),document.cookie=a+"="+o+";path=/;expires="+d.toGMTString();this.firstChild;)this.removeChild(this.lastChild)}}function c(e){var t=e.target||e.srcElement;t.hasAttribute("data-event")&&(document.createElement("img").src=t.dataset.event)}}();
