...
!function(){var e=document.querySelector(".entry-content");if(null===e)return;var r=document.querySelector(".entry-widgets");if(null===r||null===r.firstElementChild)return;var n=Math.floor(e.children.length/2);if(8<e.children.length)for(var t=["p","ul","ol","blockquote"],l=n;l<e.children.length;l++){var i=e.children[l];if(console.log(i),!(t.indexOf(i.tagName.toLowerCase())<0)&&void 0!==e.children[l-1]){var d=e.children[l-1];if(!(t.indexOf(d.tagName.toLowerCase())<0)){var o=document.createElement("figure");o.classList.add("figure","figure--widget"),o.appendChild(r.firstElementChild),e.insertBefore(o,i);break}}}0<r.children.length?r.classList.add("entry-widgets--expand"):r.parentNode.removeChild(r)}();
