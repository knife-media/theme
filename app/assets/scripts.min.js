!function(){if("undefined"==typeof knife_backdrop)return;if(void 0===knife_backdrop.image)return void 0!==knife_backdrop.color&&(document.body.style.backgroundColor="#"+knife_backdrop.color);var e=document.createElement("div");e.classList.add("backdrop"),e.style.backgroundImage="url("+knife_backdrop.image+")",void 0!==knife_backdrop.size&&(e.style.backgroundSize=knife_backdrop.size);var d=new Image;d.addEventListener("load",function(){document.body.appendChild(e)}),d.src=knife_backdrop.image}();
