"use strict";!function(){var e=document.querySelectorAll(".widget-adfox");if(!(e.length<1)){for(var t=0;t<e.length;t++){var a,o,n=e[t].querySelector("div");null!==n&&0!==n.dataset.length&&(a=Date.now().toString(10)+Math.random().toString(10).substr(2,5),(o=document.createElement("div")).id="adfox_"+a,e[t].replaceChild(o,n),o.addEventListener("click",i),o.addEventListener("click",s),d(n.dataset,a,e[t]))}var r=document.createElement("script");r.type="text/javascript",r.async=!0,r.crossorigin="anonymous",r.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(r)}function m(e,t){var a=e.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(a.length<=2)return t;var o=a[2].split("&");t.ownerId=a[1],t.params={};for(var n=0;n<o.length;n++){var r=o[n].split("=");1!=r.length&&"pr"!==r[0]&&(t.params[r[0]]=decodeURIComponent(r[1].replace(/\+/g," ")))}return t.params=function(e){if("undefined"==typeof knife_meta_parameters)return e;for(var t=["template","postid","special","category","tags","adult","promo"],a=0,o=1;a<t.length;a++,o++){var n=t[a];e["puid"+o]=knife_meta_parameters[n]||""}return e}(t.params),t}function u(e,a){return e.onStub=function(){a.classList.remove("widget-adfox--loaded")},e.onError=function(){a.classList.remove("widget-adfox--loaded")},e.onLoad=function(e){var t=e.bundleParams;if(a.classList.remove("widget-adfox--loaded"),t.bannerId&&function(e){var t=localStorage.getItem("adfox-close");if(null===t)return!1;var a=JSON.parse(t),o=(new Date).getTime(),n=0;for(key in a)e===key&&(n=a[key]),o>a[key]&&delete a[key];return localStorage.setItem("adfox-close",JSON.stringify(a)),o<n}(t.bannerId))return e.destroy();a.classList.add("widget-adfox--loaded")},e}function d(e,t,a){if(e.common)return o=e.common,n=a,(r={}).containerId="adfox_"+t,r=m(o,r=u(r,n)),window.adfoxAsyncParams=window.adfoxAsyncParams||[],window.adfoxAsyncParams.push(r),0;var o,n,r,d,s,i,c,l,f;e.mobile&&(d=e.mobile,s=a,(i={}).containerId="adfox_"+t,i=m(d,i=u(i,s)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([i,["tablet","phone"],{tabletWidth:1023,isAutoReloads:!0}])),e.desktop&&(c=e.desktop,l=a,(f={}).containerId="adfox_"+t,f=m(c,f=u(f,l)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([f,["desktop"],{tabletWidth:1023,isAutoReloads:!0}]))}function s(e){var t=e.target||e.srcElement;if(t.hasAttribute("data-close")){e.preventDefault();var a={},o=localStorage.getItem("adfox-close");for(null!==o&&(a=JSON.parse(o)),a[t.dataset.close]=(new Date).getTime()+288e5,localStorage.setItem("adfox-close",JSON.stringify(a));this.firstChild;)this.removeChild(this.lastChild)}}function i(e){var t=e.target||e.srcElement;t.hasAttribute("data-event")&&(document.createElement("img").src=t.dataset.event)}}();
...
"use strict";!function(){var i,e,_=document.getElementById("generator");null!==_&&"undefined"!=typeof knife_generator_options&&(void 0!==knife_generator_options.page_background&&(_.style.backgroundColor=knife_generator_options.page_background),void 0!==knife_generator_options.page_color&&(_.style.color=knife_generator_options.page_color),"undefined"==typeof knife_generator_items||knife_generator_items.length<1||(i=null,function(){var e=document.createElement("div");e.classList.add("entry-generator__loader"),_.insertBefore(e,_.firstChild);var t=document.createElement("span");t.classList.add("entry-generator__loader-bounce"),e.appendChild(t)}(),void 0!==knife_generator_options.button_text&&((e=document.createElement("div")).classList.add("entry-generator__button"),_.appendChild(e),(i=document.createElement("button")).classList.add("button"),i.setAttribute("type","button"),i.textContent=knife_generator_options.button_text,e.appendChild(i),void 0!==knife_generator_options.button_background&&(i.style.backgroundColor=knife_generator_options.button_background),void 0!==knife_generator_options.button_color&&(i.style.color=knife_generator_options.button_color)),i.addEventListener("click",function(e){e.preventDefault();var t=Math.floor(Math.random()*knife_generator_items.length),n=knife_generator_items[t];knife_generator_options.hasOwnProperty("button_repeat")&&(i.textContent=knife_generator_options.button_repeat),_.querySelector(".entry-generator__share")&&function(e){if(void 0!==knife_generator_options.share_links&&!(void 0===knife_generator_options.permalink||knife_generator_options.hasOwnProperty("noshare")&&knife_generator_options.noshare)){for(var t,n=_.querySelector(".entry-generator__title").textContent,r=[knife_generator_options.permalink.replace(/\/?$/,"/")+e+"/",n],o=_.querySelectorAll(".share > .share__link"),a=0;t=o[a];a++){var i,s=t.getAttribute("data-label");void 0!==knife_generator_options.share_links[s]&&(i=knife_generator_options.share_links[s],t.href=i.link.replace(/%([\d])\$s/g,function(e,t){return encodeURIComponent(r[t-1])}))}"function"==typeof window.shareButtons&&window.shareButtons()}}(t+1);var r=_.querySelector(".entry-generator__content");if(null===r&&((r=document.createElement("div")).classList.add("entry-generator__content"),_.insertBefore(r,_.lastChild)),r.innerHTML=n.description||"",knife_generator_options.hasOwnProperty("notext")&&knife_generator_options.notext&&r.parentNode.removeChild(r),_.classList.add("entry-generator--loader"),knife_generator_options.hasOwnProperty("blank")&&knife_generator_options.blank){var o=_.querySelector(".entry-generator__title");return null===o&&((o=document.createElement("div")).classList.add("entry-generator__title"),_.insertBefore(o,_.firstChild)),o.innerHTML=n.heading||"",setTimeout(function(){_.classList.remove("entry-generator--loader")},600),_.classList.add("entry-generator--blank")}var a=_.querySelector(".entry-generator__poster");if(null!==a&&a.parentNode.removeChild(a),void 0!==n.poster)return(a=new Image).classList.add("entry-generator__poster"),_.insertBefore(a,_.firstChild),a.addEventListener("load",function(){setTimeout(function(){_.classList.remove("entry-generator--loader")},600)}),a.setAttribute("alt",n.heading||""),a.setAttribute("src",n.poster),_.classList.add("entry-generator--poster")})))}();
"use strict";!function(){var e,t,c,n;"undefined"==typeof knife_search_id||null!==(e=document.querySelector(".search .gcse-search"))&&(t=e.getAttribute("data-placeholder"),window.__gcse={callback:function(){document.querySelector("input.gsc-input").placeholder=t}},(c=document.createElement("script")).type="text/javascript",c.async=!0,c.src="https://cse.google.com/cse.js?cx="+knife_search_id,(n=document.getElementsByTagName("script")[0]).parentNode.insertBefore(c,n))}();
...
"use strict";!function(){var p,i,c,f,s,a,_,h,e,L=document.getElementById("comments");null!==L&&("undefined"==typeof knife_id_handler||null!==(i=(p=function(e,t){return knife_id_handler.hasOwnProperty(e)?knife_id_handler[e]:t||""})("post",null))&&(c=function(e){var t,n=e+window.pageYOffset-24,o=document.querySelector(".header");if(null!==o&&(t=window.getComputedStyle(o),n-=parseInt(t.getPropertyValue("height"))),"scrollBehavior"in document.documentElement.style)return window.scrollTo({top:n,behavior:"smooth"});window.scrollTo(to,0)},f=function(e,t,n){var o,i,a,s=document.createElement("a");s.classList.add("comments__item-time"),s.textContent=(o=t.created,i=new Date(o),a={hour:"numeric",minute:"numeric",month:"numeric",day:"numeric"},i.getFullYear()<(new Date).getFullYear()&&(a.year="numeric"),i.toLocaleString("ru",a)),s.setAttribute("href","#comment-".concat(t.id)),s.addEventListener("click",function(){c(n.getBoundingClientRect().top)}),e.appendChild(s)},s=function(e,t){e.setAttribute("data-id",t.id),function(e,t){var n=document.createElement("div");n.classList.add("comments__item-avatar"),e.appendChild(n);var o=new Image;o.onerror=function(){o.src=p("avatar")},o.src=t.avatar||p("avatar"),n.appendChild(o)}(e,t);var n=document.createElement("div");n.classList.add("comments__item-header"),e.appendChild(n),t.name=t.name||p("anonymous");var o=document.createElement("span");o.classList.add("comments__item-name"),o.textContent=t.name,n.appendChild(o),f(n,t,e);var i=document.createElement("div");i.classList.add("comments__item-content"),i.innerHTML=t.content,e.appendChild(i);var a,s,c,r,d=document.createElement("div");d.classList.add("comments__item-footer"),e.appendChild(d),a=d,s=t,c=e,(r=document.createElement("button")).classList.add("comments__item-button"),r.textContent=p("reply"),r.addEventListener("click",function(e){e.preventDefault();var t=c.querySelector(".comments__item-form");if(t)return t.remove();L.querySelectorAll(".comments__item-form").forEach(function(e){e.remove()}),(t=_()).classList.add("comments__item-form"),t.setAttribute("data-reply",s.id),c.insertBefore(t,a.nextSibling);var n=t.querySelector("textarea"),o=s.name.split(" ");n.value="".concat(o[0],", "),n.focus()}),a.appendChild(r);var m,l,u,v=document.createElement("div");return v.classList.add("comments__item-vote"),d.appendChild(v),function o(i,a){var e=parseInt(a.plus)-parseInt(a.minus);i.className="comments__item-vote",a.self&&i.classList.add("comments__item-vote--voted"),0<e&&i.classList.add("comments__item-vote--plus"),e<0&&i.classList.add("comments__item-vote--minus");var s=document.createElement("button");s.classList.add("icon","icon--vote"),i.appendChild(s),"plus"===a.vote&&(s.classList.remove("icon--vote"),s.classList.add("icon--voted"),i.classList.add("comments__item-vote--voted"));var t=document.createElement("span");t.textContent=e,t.setAttribute("title","+".concat(a.plus," / -").concat(a.minus)),i.appendChild(t);var c=document.createElement("button");c.classList.add("icon","icon--vote"),i.appendChild(c),"minus"===a.vote&&(c.classList.remove("icon--vote"),c.classList.add("icon--voted"),i.classList.add("comments__item-vote--voted")),s.addEventListener("click",function(e){var t,n;for(e.preventDefault(),s.classList.contains("icon--voted")&&(a.plus=parseInt(a.plus)-1,delete a.vote,t="/id/ratings?comment=".concat(a.id,"&vote=plus"),h(t,"DELETE",{},function(e){e.message&&console.error(e.message)})),s.classList.contains("icon--vote")&&(a.plus=parseInt(a.plus)+1,a.vote="plus",n="/id/ratings?comment=".concat(a.id,"&vote=plus"),h(n,"POST",{},function(e){e.message&&console.error(e.message)}));i.firstChild;)i.removeChild(i.lastChild);o(i,a)}),c.addEventListener("click",function(e){var t,n;for(e.preventDefault(),c.classList.contains("icon--voted")&&(a.minus=parseInt(a.minus)-1,delete a.vote,t="/id/ratings?comment=".concat(a.id,"&vote=minus"),h(t,"DELETE",function(e){e.message&&console.error(e.message)})),c.classList.contains("icon--vote")&&(a.minus=parseInt(a.minus)+1,a.vote="minus",n="/id/ratings?comment=".concat(a.id,"&vote=minus"),h(n,"POST",function(e){e.message&&console.error(e.message)}));i.firstChild;)i.removeChild(i.lastChild);o(i,a)})}(v,t),p("action")?function(e){var t=document.createElement("button");t.classList.add("comments__item-button"),t.textContent=p("remove"),e.appendChild(t),t.addEventListener("click",function(e){e.preventDefault()});var n=document.createElement("button");n.classList.add("comments__item-button"),n.textContent=p("block"),e.appendChild(n),n.addEventListener("click",function(e){e.preventDefault()})}(d):t.self&&(m=d,l=e,(u=document.createElement("button")).classList.add("comments__item-button"),u.textContent=p("remove"),u.addEventListener("click",function(e){e.preventDefault(),confirm("Уверены, что хотите удалить комментарий?")&&l.remove()}),m.appendChild(u)),e},a=function(e,t){var n=document.createElement("div");if(n.classList.add("comments__item"),n=s(n,e),null===e.parent)return L.appendChild(n),void 0!==t&&t&&c(n.getBoundingClientRect().top),!1;var o=L.querySelector('[data-id="'.concat(e.parent,'"]'));if(null===o)return L.appendChild(n),void 0!==t&&t&&c(n.getBoundingClientRect().top),!1;o.querySelector(".comments__item-name");var i=o.querySelector(".comments__item-children");null===i&&((i=document.createElement("div")).classList.add("comments__item-children"),o.appendChild(i));var a=o.getAttribute("data-level")||0,a=parseInt(a)+1;n.setAttribute("data-level",a),2<a&&i.classList.add("comments__item-children--deepest"),i.appendChild(n),void 0!==t&&t&&c(n.getBoundingClientRect().top)},_=function(){var t=document.createElement("form");t.classList.add("comments__form");var e=document.createElement("textarea");e.classList.add("comments__form-text"),e.setAttribute("placeholder",p("placeholder")),e.setAttribute("required","required"),t.append(e);var n=document.createElement("button");n.classList.add("comments__form-submit","button"),n.setAttribute("type","submit"),n.textContent=p("submit"),t.appendChild(n),t.addEventListener("submit",function(e){e.preventDefault(),function(t){var e="/id/comments?post=".concat(i),n=t.getAttribute("data-reply");n&&(e+="&parent=".concat(n));var o=t.querySelector("textarea");h(e,"POST",{content:o.value},function(e){e.message&&console.error(e.message),0<e.fields.length&&(t.reset(),n&&t.remove(),a(e.fields[0],!0))})}(t)});function o(){window.setTimeout(function(){e.style.height="auto",e.style.height="".concat(e.scrollHeight+2,"px")},0)}return e.addEventListener("keydown",function(e){13==e.keyCode&&(e.metaKey||e.ctrlKey)&&n.click(),o()}),e.addEventListener("paste",o),t},h=function(e,t,n,o){var i=new XMLHttpRequest;i.open(t,e,!0),i.setRequestHeader("Content-Type","application/json"),i.setRequestHeader("Authorization","Bearer eyJhbGciOiJIUzI1NiJ9.MTE5OTk.QyEBvqipT1VU7Vnfl14qu8-qAbxrNVi61zCEUGyJ4Js"),i.onload=function(){if(200===i.status)return o(JSON.parse(i.responseText));console.error("Error while ".concat(e," loading"))},i.send(JSON.stringify(n))},e=_(),L.appendChild(e),h("/id/comments?post=".concat(i),"GET",{},function(e){var t,n,o;(e.fields||[]).forEach(function(e){a(e)}),t=document.location.hash,n=t.replace("#comment-",""),null!==(o=L.querySelector('[data-id="'.concat(n,'"]')))&&c(o.getBoundingClientRect().top)})))}();
"use strict";!function(){function i(e,t){return knife_mistype_reporter.hasOwnProperty(e)?knife_mistype_reporter[e]:t||""}function c(){var e=document.querySelector(".mistype");e.parentNode&&e.parentNode.removeChild(e)}function s(e){var t;27===e.keyCode&&(document.removeEventListener("keydown",s),(t=document.querySelector(".mistype")).parentNode&&t.parentNode.removeChild(t))}function n(t){var n=document.querySelector(".mistype");null!==n&&n.parentNode.removeChild(n),(n=document.createElement("div")).classList.add("mistype"),document.body.appendChild(n);var e=document.createElement("div");e.classList.add("mistype__popup"),n.appendChild(e);var d=document.createElement("h3");d.classList.add("mistype__popup-heading"),d.textContent=i("heading"),e.appendChild(d);var o=document.createElement("p");o.classList.add("mistype__popup-marked"),o.textContent=t,e.appendChild(o);var a=document.createElement("textarea");a.classList.add("mistype__popup-comment"),a.setAttribute("placeholder",i("textarea")),a.setAttribute("maxlength",300),e.appendChild(a);var p=document.createElement("button");p.classList.add("mistype__popup-submit","button"),p.textContent=i("button","Send"),e.appendChild(p),p.addEventListener("click",function(e){e.preventDefault(),function(e,t){var n=new FormData;n.append("action",i("action")),n.append("nonce",i("nonce")),n.append("comment",t),n.append("marked",e),n.append("location",document.location.href);var d=new XMLHttpRequest;d.open("POST",i("ajaxurl")),d.send(n)}(t,a.value),n.parentNode.removeChild(n)});var r=document.createElement("button");r.classList.add("mistype__popup-close"),r.addEventListener("click",c),e.appendChild(r),document.addEventListener("keydown",s,!0)}"undefined"!=typeof knife_mistype_reporter&&document.addEventListener("keydown",function(e){var t;!e.ctrlKey||13!=e.keyCode||0<(t=window.getSelection().toString()).length&&n(t.substring(0,300))})}();
"use strict";!function(){var c,a=document.querySelector(".post");null!==a&&(c=document.body,a.addEventListener("click",function(e){var t,n,r=e.target||e.srcElement;r.hasAttribute("data-body")&&(t=function(e){var t=e.target||e.srcElement;t!==n&&!t.classList.contains("reference__content-close")||(n.parentNode.removeChild(n),r.removeAttribute("data-active"),c.classList.remove("is-reference"))},null!==(n=document.getElementById("reference"))&&n.parentNode.removeChild(n),function(e,t){var n=t.getBoundingClientRect();a.classList.contains("post--standard")&&e.classList.add("reference--push");var r=n.top+window.pageYOffset||document.documentElement.scrollTop;e.style.top=r+"px"}(n=function(e){var t=document.createElement("div");t.classList.add("reference"),t.setAttribute("id","reference");var n=document.createElement("div");n.classList.add("reference__content"),n.innerHTML=e,t.appendChild(n);var r=document.createElement("button");return r.classList.add("reference__content-close"),n.appendChild(r),c.appendChild(t),t}(r.getAttribute("data-body")),r),r.setAttribute("data-active",!0),c.classList.add("is-reference"),n.addEventListener("click",t),n.addEventListener("touchend",t))}))}();
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}!function(){var _,s,d,l,p,c=document.getElementById("quiz");function a(e){if("scrollBehavior"in document.documentElement.style)return window.scrollTo({top:e,behavior:"smooth"});window.scrollTo(e,0)}function u(a,u,c){knife_quiz_options.hasOwnProperty("format")||(knife_quiz_options.format="binary"),u.addEventListener("click",function(e){var t=e.target||e.srcElement;if(t.hasAttribute("data-answer")&&!u.classList.contains("entry-quiz__vote--complete")){var n,i=a[t.dataset.answer];switch(u.classList.add("entry-quiz__vote--complete"),knife_quiz_options.format){case"dynamic":i.hasOwnProperty("dynamic")&&(p+=i.dynamic.toString()),t.classList.add(c+"--selected");break;case"category":i.hasOwnProperty("category")&&(n=0,l.hasOwnProperty(i.category)&&(n=l[i.category]),l[i.category]=n+1,d=Object.keys(l).reduce(function(e,t){return l[e]>l[t]?e:t})),t.classList.add(c+"--selected");break;case"points":i.hasOwnProperty("points")&&i.points&&(d+=parseInt(i.points)),t.classList.add(c+"--selected");break;case"binary":if(i.hasOwnProperty("binary")&&i.binary){d+=1,t.classList.add(c+"--correct");break}for(var o=0;o<a.length;o++){var r=t.parentNode.children[o];a[o].hasOwnProperty("binary")&&a[o].binary&&r.classList.add(c+"--missed")}t.classList.add(c+"--wrong")}if(knife_quiz_options.hasOwnProperty("message")&&knife_quiz_options.message){var s=document.createElement("div");if(s.classList.add("entry-quiz__vote-message"),i.message)return s.innerHTML=i.message,u.appendChild(s)}return _.click()}})}function f(e,t){var n=document.createElement("div");return n.classList.add("entry-quiz__vote"),c.insertBefore(n,t),knife_quiz_options.hasOwnProperty("shuffle")&&knife_quiz_options.shuffle&&e.sort(function(){return.5-Math.random()}),(knife_quiz_options.hasOwnProperty("attachment")&&knife_quiz_options.attachment?function(e,t){var n=document.createElement("div");n.classList.add("entry-quiz__vote-grid"),t.appendChild(n);for(var i=0;i<e.length;i++){var o,r=document.createElement("figure");void 0!==e[i].attachment&&((o=document.createElement("img")).setAttribute("src",e[i].attachment),r.appendChild(o),r.classList.add("entry-quiz__vote-attachment"),r.setAttribute("data-answer",i),n.appendChild(r))}u(e,t,"entry-quiz__vote-attachment"),t.classList.add("entry-quiz__vote--attachment")}:function(e,t){for(var n=0;n<e.length;n++){var i=document.createElement("div");void 0!==e[n].choice&&(i.classList.add("entry-quiz__vote-choice"),i.setAttribute("data-answer",n),i.innerHTML=e[n].choice,t.appendChild(i))}u(e,t,"entry-quiz__vote-choice"),t.classList.add("entry-quiz__vote--choice")})(e,n),0}function y(e){var t;a(c.getBoundingClientRect().top+window.pageYOffset-76),e.hasOwnProperty("poster")&&(t=document.createElement("img"),0<p.length&&(e.poster=e.poster.replace("*",p)),t.classList.add("entry-quiz__poster"),t.setAttribute("src",e.poster),c.insertBefore(t,c.firstChild));var n=c.querySelector(".entry-quiz__share");document.body.contains(n)&&function(e,t){if(void 0!==knife_quiz_options.share_links&&!(void 0===knife_quiz_options.permalink||knife_quiz_options.hasOwnProperty("noshare")&&knife_quiz_options.noshare)){var n=knife_quiz_options.permalink.replace(/\/?$/,"/")+e.index+"/";0<t.length&&(n=n+t+"/");for(var i,o=[n,c.querySelector(".entry-quiz__title").textContent||""],r=c.querySelectorAll(".share > .share__link"),s=0;i=r[s];s++){var a,u=i.getAttribute("data-label");void 0!==knife_quiz_options.share_links[u]&&(a=knife_quiz_options.share_links[u],i.href=a.link.replace(/%([\d])\$s/g,function(e,t){return encodeURIComponent(o[t-1])}))}"function"==typeof window.shareButtons&&window.shareButtons()}}(e,p);var i=c.querySelector(".entry-quiz__vote");document.body.contains(i)&&i.parentNode.removeChild(i);var o=c.querySelector(".entry-quiz__content");return e.hasOwnProperty("details")?o.innerHTML=e.details:o.parentNode.removeChild(o)}null!==c&&"undefined"!=typeof knife_quiz_options&&(_=null,d=s=0,l={},p="",knife_quiz_options.hasOwnProperty("center")&&knife_quiz_options.center&&c.classList.add("entry-quiz--center"),knife_quiz_options.hasOwnProperty("button_start")&&((_=document.createElement("button")).classList.add("entry-quiz__button","button"),_.setAttribute("type","button"),_.textContent=knife_quiz_options.button_start),c.appendChild(_),"object"!==("undefined"==typeof knife_quiz_items?"undefined":_typeof(knife_quiz_items))&&(knife_quiz_items=[]),knife_quiz_options.hasOwnProperty("random")&&knife_quiz_options.random&&knife_quiz_items.sort(function(){return.5-Math.random()}),"object"!==("undefined"==typeof knife_quiz_results?"undefined":_typeof(knife_quiz_results))&&(knife_quiz_results={}),_.addEventListener("click",function(){var e=knife_quiz_items.length;if(0<e&&s<e){var t=knife_quiz_items[s];return s+=1,!1===c.classList.contains("entry-quiz--item")&&(c.classList.add("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_next")&&(_.textContent=knife_quiz_options.button_next)),s===e&&knife_quiz_options.hasOwnProperty("button_last")&&(_.textContent=knife_quiz_options.button_last),function(e,t,n){a(c.getBoundingClientRect().top+window.pageYOffset-76);var i=c.querySelector(".entry-quiz__content");e.hasOwnProperty("question")&&(i.innerHTML=e.question),c.querySelector(".entry-quiz__info").textContent=t+" / "+n;var o=c.querySelector(".entry-quiz__vote");document.body.contains(o)&&o.parentNode.removeChild(o),"object"===_typeof(e.answers)&&0<e.answers.length&&f(e.answers,i.nextSibling)}(t,s,e)}if(!1===c.classList.contains("entry-quiz--results")){for(var n=[],i=0;i<knife_quiz_results.length;i++){var o=knife_quiz_results[i];o.index=i,o.hasOwnProperty("advance")&&o.advance!==d||n.push(o)}if(0<n.length){var r=n[Math.floor(Math.random()*n.length)];return c.classList.remove("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_repeat")&&(_.textContent=knife_quiz_options.button_repeat),knife_quiz_options.hasOwnProperty("norepeat")&&knife_quiz_options.norepeat&&_.parentNode.removeChild(_),c.classList.add("entry-quiz--results"),y(r)}}return document.location.reload()}))}();
"use strict";!function(){function o(e){var t,n,o=document.createElement("script");return o.type="text/javascript",o.src=(t=e,n=(n=document.querySelector('link[rel="canonical"]'))&&n.href?encodeURIComponent(n.href):encodeURIComponent(window.location.href.replace(window.location.hash,"")),"vkontakte"===t?"https://vk.com/share.php?act=count&index=0&url="+n:"facebook"===t?"https://graph.facebook.com/?fields=og_object{engagement}&callback=FB.Share&id="+n:void 0),o.id="share-"+e,document.getElementsByTagName("head")[0].appendChild(o),!0}var a={facebook:!1,vkontakte:!1};window.shareButtons=function(){var e=document.querySelectorAll(".share .share__link");if(null===e)return!1;for(var t=0;t<e.length;t++){var n=e[t].dataset.label;e[t].addEventListener("click",function(e){return e.preventDefault(),t=this.href,n={width:600,height:400,id:this.dataset.label},o=Math.round(screen.width/2-n.width/2),a=0,screen.height>n.height&&(a=Math.round(screen.height/3-n.height/2)),void window.open(t,n.id,"left="+o+",top="+a+",width="+n.width+",height="+n.height+",personalbar=0,toolbar=0,scrollbars=1,resizable=1");var t,n,o,a}),n in a&&!1===a[n]&&(a[n]=o(n))}},window.VK={Share:{count:function(e,t){if(document.getElementById("share-vkontakte").outerHTML="",void 0!==t&&t)for(var n=document.querySelectorAll(".share .share__link--vkontakte"),o=0;o<n.length;o++){var a=document.createElement("span");a.className="share__count",a.innerHTML=t,n[o].appendChild(a)}}}},window.FB={Share:function(e){if(document.getElementById("share-facebook").outerHTML="",void 0!==e.og_object&&void 0!==e.og_object.engagement){var t=e.og_object.engagement;if(void 0!==t.count&&t.count)for(var n=document.querySelectorAll(".share .share__link--facebook"),o=0;o<n.length;o++){var a=document.createElement("span");a.className="share__count",a.innerHTML=t.count,n[o].appendChild(a)}}}},window.shareButtons()}();
