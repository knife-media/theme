!function(){var a=document.querySelectorAll(".widget-adfox");if(!(a.length<1)){for(var t=0;t<a.length;t++){var e,o,n=a[t].querySelector("div");null!==n&&0!==n.dataset.length&&(e=Date.now().toString(10)+Math.random().toString(10).substr(2,5),(o=document.createElement("div")).id="adfox_"+e,a[t].replaceChild(o,n),r(n.dataset,e,a[t]))}var d=document.createElement("script");d.type="text/javascript",d.async=!0,d.crossorigin="anonymous",d.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(d)}function f(a,t){var e=a.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(e.length<=2)return t;var o=e[2].split("&");t.ownerId=e[1],t.params={};for(var n=0;n<o.length;n++){var d=o[n].split("=");1!=d.length&&"pr"!==d[0]&&(t.params[d[0]]=decodeURIComponent(d[1].replace(/\+/g," ")))}return t.params=function(a){if("undefined"==typeof knife_meta_parameters)return a;for(var t=["template","postid","special","category","tags","adult","promo"],e=0,o=1;e<t.length;e++,o++){var n=t[e];a["puid"+o]=knife_meta_parameters[n]||""}return a}(t.params),t}function m(a,t){return a.onStub=function(){t.classList.remove("widget-adfox--loaded")},a.onError=function(){t.classList.remove("widget-adfox--loaded")},a.onLoad=function(){t.classList.add("widget-adfox--loaded")},a}function r(a,t,e){if(a.common)return o=a.common,n=e,(d={}).containerId="adfox_"+t,d=f(o,d=m(d,n)),window.adfoxAsyncParams=window.adfoxAsyncParams||[],void window.adfoxAsyncParams.push(d);var o,n,d,r,i,s,c,l,p;a.mobile&&(r=a.mobile,i=e,(s={}).containerId="adfox_"+t,s=f(r,s=m(s,i)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([s,["tablet","phone"],{tabletWidth:1023,isAutoReloads:!0}])),a.desktop&&(c=a.desktop,l=e,(p={}).containerId="adfox_"+t,p=f(c,p=m(p,l)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([p,["desktop"],{tabletWidth:1023,isAutoReloads:!0}]))}}();
