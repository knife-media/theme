...
document.addEventListener("keydown",function(e){if(event.ctrlKey&&13==event.keyCode){var t=window.getSelection().toString();0<t.length&&function(e){var t=document.createElement("div");t.classList.add("typo"),document.body.appendChild(t);var n=document.createElement("button");n.classList.add("typo__button"),n.textContent="Отправить",t.appendChild(n),console.log(e)}(t)}});
