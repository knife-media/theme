"use strict";!function(){var e=document.querySelectorAll(".widget-adfox");if(!(e.length<1)){for(var t=0;t<e.length;t++){var a,o,r=e[t].querySelector("div");null!==r&&0!==r.dataset.length&&(a=Date.now().toString(10)+Math.random().toString(10).substr(2,5),(o=document.createElement("div")).id="adfox_"+a,e[t].replaceChild(o,r),o.addEventListener("click",i),o.addEventListener("click",s),d(r.dataset,a,e[t]))}var n=document.createElement("script");n.type="text/javascript",n.async=!0,n.crossorigin="anonymous",n.src="https://yastatic.net/pcode/adfox/loader.js",document.head.appendChild(n)}function m(e,t){var a=e.match(/\/(\d+?)\/.+?\?(.+)$/)||[];if(a.length<=2)return t;var o=a[2].split("&");t.ownerId=a[1],t.params={};for(var r=0;r<o.length;r++){var n=o[r].split("=");1!=n.length&&"pr"!==n[0]&&(t.params[n[0]]=decodeURIComponent(n[1].replace(/\+/g," ")))}return t.params=function(e){if("undefined"==typeof knife_meta_parameters)return e;for(var t=["template","postid","special","category","tags","adult","promo","format"],a=0,o=1;a<t.length;a++,o++){var r=t[a];e["puid"+o]=knife_meta_parameters[r]||""}return e}(t.params),t}function u(e,a){return e.onStub=function(){a.classList.remove("widget-adfox--loaded"),console.log("stub")},e.onError=function(e){a.classList.remove("widget-adfox--loaded"),console.error(e)},e.onLoad=function(e){var t=e.bundleParams;if(a.classList.remove("widget-adfox--loaded"),t.bannerId&&function(e){var t=localStorage.getItem("adfox-close");if(null===t)return!1;var a=JSON.parse(t),o=(new Date).getTime(),r=0;for(key in a)e===key&&(r=a[key]),o>a[key]&&delete a[key];return localStorage.setItem("adfox-close",JSON.stringify(a)),o<r}(t.bannerId))return e.destroy();a.classList.add("widget-adfox--loaded")},e}function d(e,t,a){if(e.common)return o=e.common,r=a,(n={}).containerId="adfox_"+t,n=m(o,n=u(n,r)),window.adfoxAsyncParams=window.adfoxAsyncParams||[],window.adfoxAsyncParams.push(n),0;var o,r,n,d,s,i,l,c,f;e.mobile&&(d=e.mobile,s=a,(i={}).containerId="adfox_"+t,i=m(d,i=u(i,s)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([i,["tablet","phone"],{tabletWidth:1023,isAutoReloads:!0}])),e.desktop&&(l=e.desktop,c=a,(f={}).containerId="adfox_"+t,f=m(l,f=u(f,c)),window.adfoxAsyncParamsAdaptive=window.adfoxAsyncParamsAdaptive||[],window.adfoxAsyncParamsAdaptive.push([f,["desktop"],{tabletWidth:1023,isAutoReloads:!0}]))}function s(e){var t=e.target||e.srcElement;if(t.hasAttribute("data-close")){e.preventDefault();var a={},o=localStorage.getItem("adfox-close");for(null!==o&&(a=JSON.parse(o)),a[t.dataset.close]=(new Date).getTime()+288e5,localStorage.setItem("adfox-close",JSON.stringify(a));this.firstChild;)this.removeChild(this.lastChild)}}function i(e){var t=e.target||e.srcElement;t.hasAttribute("data-event")&&(document.createElement("img").src=t.dataset.event)}}();
