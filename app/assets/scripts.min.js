...
!function(){var _=document.getElementById("generator");if(null===_||"undefined"==typeof knife_generator_options)return;if("undefined"==typeof knife_generator_items||knife_generator_items.length<1)return;var t=knife_generator_items,n=null;!function(){var e=document.createElement("div");e.classList.add("entry-generator__loader"),_.insertBefore(e,_.firstChild);var n=document.createElement("span");n.classList.add("entry-generator__loader-bounce"),e.appendChild(n)}(),void 0!==knife_generator_options.page_background&&(_.style.backgroundColor=knife_generator_options.page_background),void 0!==knife_generator_options.page_color&&(_.style.color=knife_generator_options.page_color),function(){if(void 0===knife_generator_options.button_text)return;var e=document.createElement("div");e.classList.add("entry-generator__button"),_.appendChild(e),(n=document.createElement("button")).classList.add("button"),n.setAttribute("type","button"),n.textContent=knife_generator_options.button_text,e.appendChild(n),void 0!==knife_generator_options.button_background&&(n.style.backgroundColor=knife_generator_options.button_background),void 0!==knife_generator_options.button_color&&(n.style.color=knife_generator_options.button_color)}(),n.addEventListener("click",function(e){e.preventDefault();var n=Math.floor(Math.random()*t.length);!function(e,n){if(void 0===knife_generator_options.share_links)return;if(void 0===knife_generator_options.permalink)return;for(var t=_.querySelectorAll(".share > .share__link"),o=[knife_generator_options.permalink.replace(/\/?$/,"/")+n+"/",e],r=0;button=t[r];r++){var i=button.getAttribute("data-label");if(void 0!==knife_generator_options.share_links[i]){var a=knife_generator_options.share_links[i];button.href=a.link.replace(/%([\d])\$s/g,function(e,n){return encodeURIComponent(o[n-1])})}}"function"===window.shareButtons&&window.shareButtons()}(t[n].caption,n)})}();
