...
!function(){var s=document.getElementById("toggle-menu"),a=document.querySelector(".header");if(null===s)return;var i=0;s.addEventListener("click",function(e){e.preventDefault();var t=document.body;t.classList.contains("is-search")&&document.getElementById("toggle-search").click(),s.classList.toggle("toggle--expand"),a.querySelector(".navbar").classList.toggle("navbar--expand");var n=a.parentElement.firstChild;if(t.classList.contains("is-navbar")){for(t.classList.remove("is-navbar"),t.style.top="";n&&n!==a;)1==n.nodeType&&(n.style.display=""),n=n.nextSibling;return window.scrollTo(0,i)}for(;n&&n!==a;)1==n.nodeType&&(n.style.display="none"),n=n.nextSibling;i=window.scrollY,t.classList.add("is-navbar"),t.style.top=-i+"px"}),document.body.addEventListener("touchend",function(e){var t=e.target||e.srcElement;if(this.classList.contains("is-navbar")&&this===t)return e.stopPropagation(),s.click()})}();
...
!function(){var c=document.getElementById("quiz");if(null===c||"undefined"==typeof knife_quiz_options)return;var n=null,i=0,_=0,d={};function s(s,a,u){var c=null;knife_quiz_options.hasOwnProperty("message")&&knife_quiz_options.message&&(c=document.createElement("div")).classList.add("entry-quiz__vote-message"),knife_quiz_options.hasOwnProperty("format")||(knife_quiz_options.format="binary"),a.addEventListener("click",function(e){var t=e.target||e.srcElement;if(t.hasAttribute("data-answer")&&!a.classList.contains("entry-quiz__vote--complete")){var n=s[t.dataset.answer];switch(a.classList.add("entry-quiz__vote--complete"),c&&n.hasOwnProperty("message")&&n.message&&(c.innerHTML=n.message,a.appendChild(c)),knife_quiz_options.format){case"category":if(n.hasOwnProperty("category")&&n.category){var i=0;d.hasOwnProperty(n.category)&&(i=d[n.category]),d[n.category]=i+1,_=Object.keys(d).reduce(function(e,t){return d[e]>d[t]?e:t})}return t.classList.add(u+"--selected");case"points":return n.hasOwnProperty("points")&&n.points&&(_+=parseInt(n.points)),t.classList.add(u+"--selected");case"binary":if(n.hasOwnProperty("binary")&&n.binary)return _+=1,t.classList.add(u+"--correct");for(var r=0;r<s.length;r++){var o=t.parentNode.children[r];s[r].hasOwnProperty("binary")&&s[r].binary&&o.classList.add(u+"--missed")}return t.classList.add(u+"--wrong")}}})}function a(e,t){var n=document.createElement("div");return n.classList.add("entry-quiz__vote"),c.insertBefore(n,t),knife_quiz_options.hasOwnProperty("shuffle")&&knife_quiz_options.shuffle&&e.sort(function(){return.5-Math.random()}),knife_quiz_options.hasOwnProperty("attachment")&&knife_quiz_options.attachment?function(e,t){var n=document.createElement("div");n.classList.add("entry-quiz__vote-grid"),t.appendChild(n);for(var i=0;i<e.length;i++){var r=document.createElement("figure");if(void 0!==e[i].attachment){var o=document.createElement("img");o.setAttribute("src",e[i].attachment),r.appendChild(o),r.classList.add("entry-quiz__vote-attachment"),r.setAttribute("data-answer",i),n.appendChild(r)}}s(e,t,"entry-quiz__vote-attachment"),t.classList.add("entry-quiz__vote--attachment")}(e,n):function(e,t){for(var n=0;n<e.length;n++){var i=document.createElement("div");void 0!==e[n].choice&&(i.classList.add("entry-quiz__vote-choice"),i.setAttribute("data-answer",n),i.innerHTML=e[n].choice,t.appendChild(i))}s(e,t,"entry-quiz__vote-choice"),t.classList.add("entry-quiz__vote--choice")}(e,n)}function r(e,t){if(c.parentNode.scrollIntoView({block:"start",behavior:"smooth"}),e.hasOwnProperty("poster")){var n=document.createElement("img");n.classList.add("entry-quiz__poster"),n.setAttribute("src",e.poster),c.insertBefore(n,c.firstChild)}var i=c.querySelector(".entry-quiz__share");document.body.contains(i)&&function(e,t){if(void 0===knife_quiz_options.share_links)return;if(void 0===knife_quiz_options.permalink)return;if(knife_quiz_options.hasOwnProperty("noshare")&&knife_quiz_options.noshare)return;for(var n,i=c.querySelector(".entry-quiz__title").textContent,r=[knife_quiz_options.permalink.replace(/\/?$/,"/")+t+"/",e.heading||i],o=c.querySelectorAll(".share > .share__link"),s=0;n=o[s];s++){var a=n.getAttribute("data-label");if(void 0!==knife_quiz_options.share_links[a]){var u=knife_quiz_options.share_links[a];n.href=u.link.replace(/%([\d])\$s/g,function(e,t){return encodeURIComponent(r[t-1])})}}"function"===window.shareButtons&&window.shareButtons()}(e,t);var r=c.querySelector(".entry-quiz__vote");document.body.contains(r)&&r.parentNode.removeChild(r);var o=c.querySelector(".entry-quiz__content");return e.hasOwnProperty("details")?o.innerHTML=e.details:o.parentNode.removeChild(o)}knife_quiz_options.hasOwnProperty("center")&&knife_quiz_options.center&&c.classList.add("entry-quiz--center"),knife_quiz_options.hasOwnProperty("button_start")&&((n=document.createElement("button")).classList.add("entry-quiz__button","button"),n.setAttribute("type","button"),n.textContent=knife_quiz_options.button_start),c.appendChild(n),"object"!=typeof knife_quiz_items&&(knife_quiz_items=[]),knife_quiz_options.hasOwnProperty("random")&&knife_quiz_options.random&&knife_quiz_items.sort(function(){return.5-Math.random()}),"object"!=typeof knife_quiz_results&&(knife_quiz_results={}),n.addEventListener("click",function(){var e=knife_quiz_items.length;if(0<e&&i<e){var t=knife_quiz_items[i];return i+=1,!1===c.classList.contains("entry-quiz--item")&&(c.classList.add("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_next")&&(n.textContent=knife_quiz_options.button_next)),i===e&&knife_quiz_options.hasOwnProperty("button_last")&&(n.textContent=knife_quiz_options.button_last),function(e,t,n){var i=c.getBoundingClientRect().top+window.pageYOffset||document.documentElement.scrollTop;window.scroll({top:i-76,behavior:"smooth"});var r=c.querySelector(".entry-quiz__content");e.hasOwnProperty("question")&&(r.innerHTML=e.question),c.querySelector(".entry-quiz__info").textContent=t+" / "+n;var o=c.querySelector(".entry-quiz__vote");document.body.contains(o)&&o.parentNode.removeChild(o),"object"==typeof e.answers&&0<e.answers.length&&a(e.answers,r.nextSibling)}(t,i,e)}return!1===c.classList.contains("entry-quiz--results")&&"object"==typeof knife_quiz_results[_]?(c.classList.remove("entry-quiz--item"),knife_quiz_options.hasOwnProperty("button_repeat")&&(n.textContent=knife_quiz_options.button_repeat),knife_quiz_options.hasOwnProperty("norepeat")&&knife_quiz_options.norepeat&&n.parentNode.removeChild(n),c.classList.add("entry-quiz--results"),r(knife_quiz_results[_],_)):document.location.reload()})}();
