...
!function(){var e=document.querySelector(".glide");if(null===e||"undefined"==typeof Glide)return!1;var t=e.querySelectorAll(".glide__slide").length;if(0===t)return!1;var n=new Glide(".glide",{gap:0,rewind:!1,dragThreshold:!1});return n.on("mount.before",function(){if("undefined"==typeof knife_story_options.background)return!1;var t=document.createElement("div");if(t.classList.add("glide__backdrop"),t.style.backgroundImage="url("+knife_story_options.background+")","undefined"!=typeof knife_story_options.blur&&parseInt(knife_story_options.blur)>0&&(t.style.filter="blur("+knife_story_options.blur+"px)"),e.appendChild(t),"undefined"==typeof knife_story_options.shadow)return!1;var n=parseInt(knife_story_options.shadow)/100;if(n<=0||n>1)return!1;var r=document.createElement("div");r.classList.add("glide__shadow"),r.style.backgroundColor="rgba(0, 0, 0, "+n+")",t.appendChild(r)}),n.on("mount.before",function(){var n=document.createElement("div");n.classList.add("glide__bullets");for(var r=0;r<t;r++){var o=document.createElement("span");o.classList.add("glide__bullets-item"),n.appendChild(o)}return e.appendChild(n)}),n.on(["mount.after","run"],function(){for(var t,r=e.querySelectorAll(".glide__bullets-item"),o=0;t=r[o];o++)t.classList.remove("glide__bullets-item--active"),n.index===o&&t.classList.add("glide__bullets-item--active")}),n.on("mount.before",function(){["prev","next"].forEach(function(t,n){var r=document.createElement("div");r.classList.add("glide__control","glide__control--"+t),r.classList.add();var o=document.createElement("span");o.classList.add("icon","icon--"+t),r.appendChild(o),e.appendChild(r)}),e.querySelector(".glide__control--next").addEventListener("click",function(e){e.preventDefault(),n.go(">")}),e.querySelector(".glide__control--prev").addEventListener("click",function(e){e.preventDefault(),n.go("<")})}),n.mount()}();
