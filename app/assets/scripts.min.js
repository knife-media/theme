...
!function(){var e=document.querySelector(".glide");if(null===e||"undefined"==typeof Glide)return!1;if(0===e.querySelectorAll(".glide__slide").length)return!1;window.onpageshow=function(e){e.persisted&&window.location.reload(!1)};var t=new Glide(".glide",{gap:0,rewind:!1,dragThreshold:!1});return t.on("mount.before",function(){if("undefined"==typeof knife_story_options.background)return!1;var t=function(e){if("undefined"==typeof knife_story_options.shadow)return!1;var t=parseInt(knife_story_options.shadow)/100;if(t<=0||t>1)return!1;var n=document.createElement("div");n.classList.add("glide__shadow"),n.style.backgroundColor="rgba(0, 0, 0, "+t+")",e.appendChild(n)},n=function(e){if("undefined"==typeof knife_story_options.blur)return!1;var t=parseInt(knife_story_options.blur);return!(t<=0)&&void(e.style.filter="blur("+t+"px)")},r=new Image;return r.onload=function(){var r=document.createElement("div");return r.classList.add("glide__backdrop"),r.style.backgroundImage="url("+this.src+")",t(r),n(r),e.appendChild(r)},r.src=knife_story_options.background}),t.on("mount.before",function(){var t=document.createElement("div");t.classList.add("glide__bullets");for(var n=0;n<e.querySelectorAll(".glide__slide").length;n++){var r=document.createElement("span");r.classList.add("glide__bullets-item"),t.appendChild(r)}return e.appendChild(t)}),t.on(["mount.after","run"],function(){for(var n,r=e.querySelectorAll(".glide__bullets-item"),o=0;n=r[o];o++)n.classList.remove("glide__bullets-item--active"),t.index===o&&n.classList.add("glide__bullets-item--active")}),t.on("mount.before",function(n){var r=document.querySelector('link[rel="next"]');if(null===r||!r.hasAttribute("href"))return!1;var o=document.createElement("div");return o.classList.add("glide__slide","glide__slide--empty"),t.update({href:r.href}),e.querySelector(".glide__slides").appendChild(o)}),t.on("mount.before",function(){["prev","next"].forEach(function(t,n){var r=document.createElement("div");r.classList.add("glide__control","glide__control--"+t),r.classList.add();var o=document.createElement("span");o.classList.add("icon","icon--"+t),r.appendChild(o),e.appendChild(r)}),e.querySelector(".glide__control--next").addEventListener("click",function(e){e.preventDefault(),t.go(">")}),e.querySelector(".glide__control--prev").addEventListener("click",function(e){e.preventDefault(),t.go("<")})}),t.on("mount.after",function(){var n=e.querySelectorAll(".glide__slide");t.update({count:n.length-1})}),t.on(["mount.after","run"],function(n){var r=e.querySelector(".glide__control--prev");r.classList.remove("glide__control--disabled"),0===t.index&&r.classList.add("glide__control--disabled")}),t.on("run",function(n){var r=e.querySelector(".glide__control--next");r.classList.remove("glide__control--disabled"),t.index===t.settings.count&&r.classList.add("glide__control--disabled")}),t.on("run",function(n){if(t.index===t.settings.count&&t.settings.href)return e.style.opacity=0}),t.on("run.after",function(e){if(t.index===t.settings.count&&t.settings.href)return document.location.href=t.settings.href}),e.addEventListener("touchmove",function(e){e.preventDefault(),console.log(e)},{passive:!1}),t.mount()}();
