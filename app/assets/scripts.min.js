...
!function(){var e=document.querySelector(".entry-content");if("undefined"==typeof knife_similar_posts)return;if(null===e||e.children.length<10)return;var t=function(e){for(var t,n=0;n<e.length;n++){t=Math.floor(Math.random()*n);var r=e[n];e[n]=e[t],e[t]=r}return e}(knife_similar_posts);function n(e,t){if(void 0===t.link||void 0===t.title)return!1;var n=document.createElement("figure");n.classList.add("figure","figure--similar"),function(){if(void 0===t.head)return;var e=document.createElement("h4");e.innerHTML=t.head,n.appendChild(e)}();var r=document.createElement("p");n.appendChild(r);var i=document.createElement("a");i.href=t.link,i.innerHTML=t.title,r.appendChild(i),function(){if(void 0===t.action)return;i.setAttribute("data-action",t.action)}(),function(){if(void 0===t.label)return;i.setAttribute("data-label",t.label)}(),e.parentNode.insertBefore(n,e.nextSibling)}if(null===e.querySelector(".figure--similar"))for(var r=Math.floor(e.children.length/3),i=0;i<2;i++)if(void 0!==t[i]){for(var a=["p","blockquote"],l=r;l<e.children.length-5;l++){var o=e.children[l];if(!(a.indexOf(o.tagName.toLowerCase())<0)&&void 0!==e.children[l-1]){var d=e.children[l-1];if(!(a.indexOf(d.tagName.toLowerCase())<0)){n(d,t[i]);break}}}r=Math.floor(e.children.length/3)+l}}();
