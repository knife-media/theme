...
!function(){var e=document.querySelector(".glide");if(null===e||"undefined"==typeof Glide)return!1;if(0===e.querySelectorAll(".glide__slide").length)return!1;window.onpageshow=function(e){e.persisted&&window.location.reload(!1)},e.style.height=window.innerHeight-52+"px",console.log(window.innerHeight);var n=new Glide(".glide",{gap:0,rewind:!1,dragThreshold:!1,touchAngle:30});return n.on("mount.before",function(){if("undefined"==typeof knife_story_options.background)return!1;var n=function(e){if("undefined"==typeof knife_story_options.shadow)return!1;var n=parseInt(knife_story_options.shadow)/100;if(n<=0||n>1)return!1;var t=document.createElement("div");t.classList.add("glide__shadow"),t.style.backgroundColor="rgba(0, 0, 0, "+n+")",e.appendChild(t)},t=function(e){if("undefined"==typeof knife_story_options.blur)return!1;var n=parseInt(knife_story_options.blur);return!(n<=0)&&(e.style.margin="-"+n+"px",void(e.style.filter="blur("+n+"px)"))},r=new Image;return r.onload=function(){var r=document.createElement("div");return r.classList.add("glide__backdrop"),r.style.backgroundImage="url("+this.src+")",n(r),t(r),e.appendChild(r)},r.src=knife_story_options.background}),n.on("mount.before",function(){var n=document.createElement("div");n.classList.add("glide__bullets");for(var t=0;t<e.querySelectorAll(".glide__slide").length;t++){var r=document.createElement("span");r.classList.add("glide__bullets-item"),n.appendChild(r)}return e.appendChild(n)}),n.on(["mount.after","run"],function(){for(var t,r=e.querySelectorAll(".glide__bullets-item"),i=0;t=r[i];i++)t.classList.remove("glide__bullets-item--active"),n.index===i&&t.classList.add("glide__bullets-item--active")}),n.on("mount.before",function(t){var r=document.querySelector('link[rel="next"]');if(null===r||!r.hasAttribute("href"))return!1;var i=document.createElement("div");return i.classList.add("glide__slide","glide__slide--empty"),n.update({href:r.href}),e.querySelector(".glide__slides").appendChild(i)}),n.on("mount.before",function(){["prev","next"].forEach(function(n,t){var r=document.createElement("div");r.classList.add("glide__control","glide__control--"+n),r.classList.add();var i=document.createElement("span");i.classList.add("icon","icon--"+n),r.appendChild(i),e.appendChild(r)}),e.querySelector(".glide__control--next").addEventListener("click",function(e){e.preventDefault(),n.go(">")}),e.querySelector(".glide__control--prev").addEventListener("click",function(e){e.preventDefault(),n.go("<")})}),n.on("mount.after",function(){var t=e.querySelectorAll(".glide__slide");n.update({count:t.length-1})}),n.on(["mount.after","run"],function(t){var r=e.querySelector(".glide__control--prev");r.classList.remove("glide__control--disabled"),0===n.index&&r.classList.add("glide__control--disabled")}),n.on("run",function(t){var r=e.querySelector(".glide__control--next");r.classList.remove("glide__control--disabled"),n.index===n.settings.count&&r.classList.add("glide__control--disabled")}),n.on("run",function(t){if(n.index===n.settings.count&&n.settings.href)return e.style.opacity=0}),n.on("run.after",function(e){if(n.index===n.settings.count&&n.settings.href)return document.location.href=n.settings.href}),n.mount()}();
