...
!function(){if("undefined"==typeof knife_relap_options)return;var e=knife_relap_options;if(1<e.token.length){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://relap.io/api/v6/head.js?token="+e.token,document.head.appendChild(t)}if(1<e.block.length){var n=document.createElement("div");n.classList.add("entry-footer__relap"),n.innerHTML='<script id="'+e.block+'"><\/script>',document.querySelector(".entry-footer").appendChild(n)}}();
